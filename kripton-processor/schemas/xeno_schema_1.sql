...
--
-- Date: Fri Oct 25 19:41:14 CEST 2019
--
------------------------------------------------------------------------------------
...
CREATE TABLE phone_number (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, action_type TEXT, contact_id TEXT, contact_name TEXT, country_code TEXT, number TEXT);
