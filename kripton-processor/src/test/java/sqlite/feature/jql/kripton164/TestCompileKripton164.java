...
public class TestCompileKripton164 extends AbstractBindSQLiteProcessorTest {
	...
	public void test_error() throws Throwable {
		...
		buildDataSourceProcessorTest(CollegeStudent.class, ErrCollegeStudent.class, ErrCollegeStudentDao.class,CollegeStudentDao.class, ErrCollegeStudentsDataSource.class);
	}
