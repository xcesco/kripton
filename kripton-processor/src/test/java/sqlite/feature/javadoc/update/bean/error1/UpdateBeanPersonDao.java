 ...
 * the License.
 ******************************************************************************/
package sqlite.feature.javadoc.update.bean.error1;
...
public interface UpdateBeanPersonDao {
	 ...
	 * @return the int
	 */
	@BindSqlUpdate(excludedFields={"id","personName","personSurname","student"}, where="id=${bean.id} and personName=${bean.personName} and personSurname=${bean.personSurname} and student=${bean.student}")
