...
/**
 * The Class TestCompileMany2ManyErr1.
 */
@RunWith(JUnit4.class)
public class TestCompileMany2ManyErr1 extends AbstractBindSQLiteProcessorTest {
	...
	public void testForeignKeyNotFound() throws Throwable {
		...
		buildDataSourceProcessorTest(PersonCirtyErr1DataSource.class, 
				PersonErr1Dao.class, Person.class, 
				CityErr1Dao.class, City.class, 
				PersonCityErr1Dao.class,PersonCityErr1.class, 
