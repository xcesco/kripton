...
public interface DaoPerson {
	...
	@BindContentProviderEntry(path="${id}/name")
	@BindSqlUpdate(where ="id=${id}")
	void updateOnlyName(String name, String id);
	
	@BindContentProviderEntry(path="${bean.id}")
	@BindSqlDelete(where ="id=${bean.id}")
	void delete(Person bean);
	
	
	@BindContentProviderEntry(path="${name}/name")
	@BindSqlDelete(where ="name=${name}")
