...
public class TestCompileRelationError4 extends AbstractBindSQLiteProcessorTest {
	...
	public void testCompileError() throws Throwable {
		this.expectedException(InvalidDefinition.class,
				"In class 'sqlite.feature.relations.error4.Album', property 'songs' has invalid definition: @BindRelation#foreignKey referers an invalid foreign key or no existing field 'sqlite.feature.relations.error4.Artist#songs'");
