 ...
 */
public class BigIntegerBindTransform extends AbstractNumberBindTransform {

	/**
	 * Instantiates a new big integer bind transform.
	 */
	public BigIntegerBindTransform() {
		NUMBER_UTIL_CLAZZ = BigIntegerUtils.class;
