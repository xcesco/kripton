...
/**
 * This class is the shared preference binder defined for NamedAppPreferences
 *
 * @see NamedAppPreferences
 */
public class BindNamedAppPreferences extends AbstractSharedPreference {
  /**
   * shared preferences typeName for NamedAppPreferences
   */
  public static final String SHARED_PREFERENCE_NAME = "namedAppPreferences";

  /**
   * instance of shared preferences
   */
  private static BindNamedAppPreferences instance;

  /**
   * working instance of bean
   */
  private final NamedAppPreferences defaultBean;

  /**
   * constructor
   */
  private BindNamedAppPreferences() {
    createPrefs();
    defaultBean=new NamedAppPreferences();
  }
  ...
  private void createPrefs() {
    try {
      ...
      prefs=EncryptedSharedPreferences.create(KriptonLibrary.getContext(), SHARED_PREFERENCE_NAME, masterKeyAlias, EncryptedSharedPreferences.PrefKeyEncryptionScheme.AES256_SIV, EncryptedSharedPreferences.PrefValueEncryptionScheme.AES256_GCM);
    } catch(Throwable e) {
      e.printStackTrace();
    }
  }
   ...
   */
  public BindNamedAppPreferences refresh() {
    createPrefs();
    return this;
  }
   ...
   */
  public void reset() {
    NamedAppPreferences bean=new NamedAppPreferences();
    write(bean);
  }
   ...
   * @return read bean
   */
  public NamedAppPreferences read() {
    NamedAppPreferences bean=new NamedAppPreferences();
   ...
   */
  public void write(NamedAppPreferences bean) {
   ...
   */
  public static synchronized BindNamedAppPreferences getInstance() {
    if (instance==null) {
      instance=new BindNamedAppPreferences();
