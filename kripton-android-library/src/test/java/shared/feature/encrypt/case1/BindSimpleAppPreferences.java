...
/**
 * This class is the shared preference binder defined for SimpleAppPreferences
 *
 * @see SimpleAppPreferences
 */
public class BindSimpleAppPreferences extends AbstractSharedPreference {
  /**
   * instance of shared preferences
   */
  private static BindSimpleAppPreferences instance;

  /**
   * working instance of bean
   */
  private final SimpleAppPreferences defaultBean;

  /**
   * constructor
   */
  private BindSimpleAppPreferences() {
    createPrefs();
    defaultBean=new SimpleAppPreferences();
  }
   ...
   */
  public BindSimpleAppPreferences refresh() {
    createPrefs();
    return this;
  }
   ...
   */
  public void reset() {
    SimpleAppPreferences bean=new SimpleAppPreferences();
    write(bean);
  }
   ...
   * @return read bean
   */
  public SimpleAppPreferences read() {
    SimpleAppPreferences bean=new SimpleAppPreferences();
   ...
   */
  public void write(SimpleAppPreferences bean) {
   ...
   */
  public static synchronized BindSimpleAppPreferences getInstance() {
    if (instance==null) {
      instance=new BindSimpleAppPreferences();
