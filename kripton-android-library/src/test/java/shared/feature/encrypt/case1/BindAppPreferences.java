...
public class BindAppPreferences extends AbstractSharedPreference {
  ...
  private void createPrefs() {
    try {
      String sharedName=KriptonLibrary.getContext().getPackageName() + "_preferences";
      ...
      prefs=EncryptedSharedPreferences.create(KriptonLibrary.getContext(), sharedName, masterKeyAlias, EncryptedSharedPreferences.PrefKeyEncryptionScheme.AES256_SIV, EncryptedSharedPreferences.PrefValueEncryptionScheme.AES256_GCM);
    } catch(Throwable e) {
      e.printStackTrace();
    }
  }
