...
public class UserIdentityBindMap extends AbstractMapper<UserIdentity> {
   ...
   */
  @Override
  public void serializeOnXml(UserIdentity object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public UserIdentity parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    UserIdentity instance = new UserIdentity();
