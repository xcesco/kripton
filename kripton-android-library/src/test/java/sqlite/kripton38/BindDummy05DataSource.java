...
public class BindDummy05DataSource extends AbstractDataSource implements BindDummy05DaoFactory, Dummy05DataSource {
  ...
  /**
   * Instantiates a new bind dummy 05 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton38.BindDummy05DaoFactory#getDaoBean05()
   */
  @Override
   ...
   *
   * @return the bind dummy 05 data source
   */
