...
public class BindDummy05DataSource extends AbstractDataSource implements BindDummy05DaoFactory, Dummy05DataSource {
  ...
  public static BindDummy05DataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindDummy05DataSource is forced to be (re)builded");
      instance.forceClose();
      instance=null;
    }
    BindDummy05DataSource result=instance;
    ...
    Logger.info("Datasource BindDummy05DataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindDummy05DaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindDummy05DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindDummy05DaoFactory daoFactory);
  }
