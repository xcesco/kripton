...
public class Bean03Table implements SQLiteTable {
  ...
  /** <p> DDL to create table bean03 </p>  <pre>CREATE TABLE bean03 (id INTEGER PRIMARY KEY AUTOINCREMENT, text TEXT);</pre>. */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE bean03 (id INTEGER PRIMARY KEY AUTOINCREMENT, text TEXT);";

  /** <p> DDL to drop table bean03 </p>  <pre>DROP TABLE IF EXISTS bean03;</pre>. */
