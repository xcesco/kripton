...
public class BindInsertBeanPersonDataSource extends AbstractDataSource implements BindInsertBeanPersonDaoFactory, InsertBeanPersonDataSource {
      ...
      synchronized(mutex) {
        ...
        if (result==null) {
          DataSourceOptions options=DataSourceOptions.builder()
          	...
          	.neverClose(false)
          	.build();
          instance=result=new BindInsertBeanPersonDataSource(options);
          try {
  ...
  public static BindInsertBeanPersonDataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindInsertBeanPersonDataSource is forced to be (re)builded");
      instance=null;
    }
    BindInsertBeanPersonDataSource result=instance;
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindInsertBeanPersonDataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindInsertBeanPersonDataSource is already builded");
    }
    Logger.info("Datasource BindInsertBeanPersonDataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindInsertBeanPersonDaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindInsertBeanPersonDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindInsertBeanPersonDaoFactory daoFactory);
  }
