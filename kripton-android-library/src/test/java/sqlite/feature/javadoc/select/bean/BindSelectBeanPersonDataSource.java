...
/**
 * <p>
 * Implementation of the SelectBeanPersonDataSource datasource.
...
public class BindSelectBeanPersonDataSource extends AbstractDataSource implements BindSelectBeanPersonDaoFactory, SelectBeanPersonDataSource {
   ...
   */
  public static BindSelectBeanPersonDataSource getInstance() {
  ...
  public static BindSelectBeanPersonDataSource open() {
    BindSelectBeanPersonDataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  public static BindSelectBeanPersonDataSource build(DataSourceOptions options) {
    ...
    Logger.info("Datasource BindSelectBeanPersonDataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindSelectBeanPersonDaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindSelectBeanPersonDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindSelectBeanPersonDaoFactory daoFactory);
  }
  ...
  class DataSourceSingleThread implements BindSelectBeanPersonDaoFactory {
    ...
    public SelectBeanPersonDaoImpl getSelectBeanPersonDao() {
      if (_selectBeanPersonDao==null) {
        _selectBeanPersonDao=new SelectBeanPersonDaoImpl(this);
      }
