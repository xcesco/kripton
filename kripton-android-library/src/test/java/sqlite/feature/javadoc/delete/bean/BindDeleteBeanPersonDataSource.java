...
public class BindDeleteBeanPersonDataSource extends AbstractDataSource implements BindDeleteBeanPersonDaoFactory, DeleteBeanPersonDataSource {
  ...
  static volatile BindDeleteBeanPersonDataSource instance;

  /** <p>Mutex to manage multithread access to instance</p>. */
  private static final Object mutex = new Object();

  /** Unique identifier for Dao DeleteBeanPersonDao. */
  public static final int DELETE_BEAN_PERSON_DAO_UID = 0;
  ...
  /**
   * Instantiates a new bind delete bean person data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.javadoc.delete.bean.BindDeleteBeanPersonDaoFactory#getDeleteBeanPersonDao()
   */
  @Override
   ...
   *
   * @return the bind delete bean person data source
   */
      ...
      synchronized(mutex) {
        ...
        if (result==null) {
          DataSourceOptions options=DataSourceOptions.builder()
          	...
          	.log(true)
          	.build();
          instance=result=new BindDeleteBeanPersonDataSource(options);
          try {
    ...
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindDeleteBeanPersonDataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindDeleteBeanPersonDataSource is already builded");
  ...
  class DataSourceSingleThread implements BindDeleteBeanPersonDaoFactory {
    ...
    /** The delete bean person dao. */
    protected DeleteBeanPersonDaoImpl _deleteBeanPersonDao;

    /**
     * Instantiates a new data source single thread.
     */
    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindDeleteBeanPersonDataSource.this);
    }

    /**
     * retrieve dao DeleteBeanPersonDao.
     *
     * @return the delete bean person dao
     */
    public DeleteBeanPersonDaoImpl getDeleteBeanPersonDao() {
