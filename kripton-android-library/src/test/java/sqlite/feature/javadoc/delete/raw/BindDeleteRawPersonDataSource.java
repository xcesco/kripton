...
public class BindDeleteRawPersonDataSource extends AbstractDataSource implements BindDeleteRawPersonDaoFactory, DeleteRawPersonDataSource {
   ...
   */
  public static BindDeleteRawPersonDataSource getInstance() {
  ...
  public static BindDeleteRawPersonDataSource open() {
    BindDeleteRawPersonDataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  public static BindDeleteRawPersonDataSource build(DataSourceOptions options) {
    ...
    Logger.info("Datasource BindDeleteRawPersonDataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindDeleteRawPersonDaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindDeleteRawPersonDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindDeleteRawPersonDaoFactory daoFactory);
  }
