...
public class BindUpdateBeanPersonDataSource extends AbstractDataSource implements BindUpdateBeanPersonDaoFactory, UpdateBeanPersonDataSource {
  ...
  static volatile BindUpdateBeanPersonDataSource instance;

  /** <p>Mutex to manage multithread access to instance</p>. */
  private static final Object mutex = new Object();

  /** Unique identifier for Dao UpdateBeanPersonDao. */
  public static final int UPDATE_BEAN_PERSON_DAO_UID = 0;
  ...
  /**
   * Instantiates a new bind update bean person data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.javadoc.update.bean.BindUpdateBeanPersonDaoFactory#getUpdateBeanPersonDao()
   */
  @Override
   ...
   *
   * @return the bind update bean person data source
   */
      ...
      synchronized(mutex) {
        ...
        if (result==null) {
          DataSourceOptions options=DataSourceOptions.builder()
          	...
          	.log(true)
          	.build();
          instance=result=new BindUpdateBeanPersonDataSource(options);
          try {
  ...
  public void clearCompiledStatements() {
    UpdateBeanPersonDaoImpl.clearCompiledStatements();
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindUpdateBeanPersonDaoFactory> {
  ...
  class DataSourceSingleThread implements BindUpdateBeanPersonDaoFactory {
    ...
    /** The update bean person dao. */
    protected UpdateBeanPersonDaoImpl _updateBeanPersonDao;

    /**
     * Instantiates a new data source single thread.
     */
    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindUpdateBeanPersonDataSource.this);
    }

    /**
     * retrieve dao UpdateBeanPersonDao.
     *
     * @return the update bean person dao
     */
    public UpdateBeanPersonDaoImpl getUpdateBeanPersonDao() {
      if (_updateBeanPersonDao==null) {
        _updateBeanPersonDao=new UpdateBeanPersonDaoImpl(_context);
      }
      return _updateBeanPersonDao;
    }
