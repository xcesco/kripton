...
public class BindPersonUpdateDataSource extends AbstractDataSource implements BindPersonUpdateDaoFactory, PersonUpdateDataSource {
  ...
  static volatile BindPersonUpdateDataSource instance;

  /** <p>Mutex to manage multithread access to instance</p>. */
  private static final Object mutex = new Object();

  /** Unique identifier for Dao PersonUpdateDAO. */
  public static final int PERSON_UPDATE_D_A_O_UID = 0;
  ...
  /**
   * Instantiates a new bind person update data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.dynamic.update.BindPersonUpdateDaoFactory#getPersonUpdateDAO()
   */
  @Override
   ...
   *
   * @return the bind person update data source
   */
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindPersonUpdateDaoFactory> {
  ...
  class DataSourceSingleThread implements BindPersonUpdateDaoFactory {
    ...
    /** The person update DAO. */
    protected PersonUpdateDAOImpl _personUpdateDAO;

    /**
     * Instantiates a new data source single thread.
     */
    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindPersonUpdateDataSource.this);
    }

    /**
     * retrieve dao PersonUpdateDAO.
     *
     * @return the person update DAO
     */
    public PersonUpdateDAOImpl getPersonUpdateDAO() {
