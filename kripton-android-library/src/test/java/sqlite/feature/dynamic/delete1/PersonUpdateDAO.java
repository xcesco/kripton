...
/*	
	...
	*/
	...
	@BindSqlDelete(jql="DELETE FROM person WHERE id = ${id} #{DYNAMIC_WHERE}")
	void deleteRaw(long id, @BindSqlDynamicWhere String where);
	
	@BindSqlDelete(jql="DELETE FROM person WHERE id = ${bean.id} #{DYNAMIC_WHERE}")
