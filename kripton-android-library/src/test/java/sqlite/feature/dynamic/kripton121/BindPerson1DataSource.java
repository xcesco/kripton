...
public class BindPerson1DataSource extends AbstractDataSource implements BindPerson1DaoFactory, Person1DataSource {
  ...
  /** <p>dao instance</p>. */
  protected Person1DAOImpl person1DAO = new Person1DAOImpl(context);

  /** Used only in transactions (that can be executed one for time. */
  protected DataSourceSingleThread _daoFactorySingleThread = new DataSourceSingleThread();

  /**
   * Instantiates a new bind person 1 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.dynamic.kripton121.BindPerson1DaoFactory#getPerson1DAO()
   */
  @Override
   ...
   *
   * @return the bind person 1 data source
   */
  ...
  class DataSourceSingleThread implements BindPerson1DaoFactory {
     ...
     *
     * @return the person 1 DAO
     */
    public Person1DAOImpl getPerson1DAO() {
      if (_person1DAO==null) {
        _person1DAO=new Person1DAOImpl(_context);
      }
      return _person1DAO;
    }
