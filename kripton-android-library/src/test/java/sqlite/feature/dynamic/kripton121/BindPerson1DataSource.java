...
public class BindPerson1DataSource extends AbstractDataSource implements BindPerson1DaoFactory, Person1DataSource {
   ...
   */
  public static final int PERSON1_D_A_O_UID = 0;
  ...
  public void clearCompiledStatements() {
    Person1DAOImpl.clearCompiledStatements();
  }
  ...
  public static BindPerson1DataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindPerson1DataSource is forced to be (re)builded");
      instance=null;
    }
    BindPerson1DataSource result=instance;
    if (result==null) {
    ...
    Logger.info("Datasource BindPerson1DataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindPerson1DaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindPerson1DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindPerson1DaoFactory daoFactory);
  }

  class DataSourceSingleThread implements BindPerson1DaoFactory {
    private SQLContextInSessionImpl _context;

    protected Person1DAOImpl _person1DAO;
    ...
    public Person1DAOImpl getPerson1DAO() {
      if (_person1DAO==null) {
        _person1DAO=new Person1DAOImpl(this);
      }
      return _person1DAO;
    }
