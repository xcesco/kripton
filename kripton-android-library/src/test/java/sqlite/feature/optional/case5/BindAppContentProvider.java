 ...
 * <tr><td><pre>content://com.abubusoft.kripton.example/artists/title2/:id</pre></td><td>{@link DaoArtistImpl#selectTitle2ById0ForContentProvider}</td></tr>
 * </table>
 *
 *
 *
...
public class BindAppContentProvider extends ContentProvider {
   ...
   */
  private static final Uri URI_PATH_ARTIST_1 = Uri.parse(URI+"/artists/title2/#");

  static final String PATH_ARTIST_1 = "artists/title2/#";
   ...
   *
   * <p>Method associated to this URI is {@link DaoArtistImpl#selectTitle2ById0ForContentProvider}</p>
   */
  public static final Uri URI_ARTIST_SELECT_TITLE2_BY_ID = URI_PATH_ARTIST_1;
  ...
  public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
    ...
    switch (sURIMatcher.match(uri)) {
      case PATH_ARTIST_1_INDEX: {
        ...
        returnCursor=dataSource.getDaoArtist().selectTitle2ById0ForContentProvider(uri, projection, selection, selectionArgs, sortOrder);
        break;
      }
      default: {
