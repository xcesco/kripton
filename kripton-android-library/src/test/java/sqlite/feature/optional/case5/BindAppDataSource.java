...
import sqlite.feature.optional.model.ArticleTable;
import sqlite.feature.optional.model.ArtistTable;
...
public class BindAppDataSource extends AbstractDataSource implements BindAppDaoFactory, AppDataSource {
  ...
  /**
   * Unique identifier for Dao DaoArtist
   */
  public static final int DAO_ARTIST_UID = 1;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new ArtistTable(), new ArticleTable()};
   ...
   * <p>dao instance</p>
   */
  protected DaoArtistImpl daoArtist = new DaoArtistImpl(this);
  ...
  @Override
  public DaoArtistImpl getDaoArtist() {
    return daoArtist;
  }
  ...
  public void clearCompiledStatements() {
    ...
    DaoArtistImpl.clearCompiledStatements();
  }
  ...
  class DataSourceSingleThread implements BindAppDaoFactory {
    ...
    protected DaoArtistImpl _daoArtist;
    ...
    public DaoArtistImpl getDaoArtist() {
      if (_daoArtist==null) {
        _daoArtist=new DaoArtistImpl(this);
      }
      return _daoArtist;
    }
