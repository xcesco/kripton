...
/**
 * <p>
 * DAO implementation for entity <code>BeanWithAccessors</code>, based on interface <code>DaoBeanWithAccessors</code>
 * </p>
 *
 *  @see BeanWithAccessors
 *  @see DaoBeanWithAccessors
 *  @see BeanWithAccessorsTable
 */
public class DaoBeanWithAccessorsImpl extends Dao implements DaoBeanWithAccessors {
   ...
   */
  private static final String SELECT_SQL3 = "SELECT id, duration, istant, local_date, local_date_time, local_time, month_day, offset_date_time, offset_time, period, year, year_month, zone_id, zone_offset, zoned_date_time FROM bean_with_accessors WHERE year=?";

  private static SupportSQLiteStatement deletePreparedStatement2;

  public DaoBeanWithAccessorsImpl(BindAppDaoFactory daoFactory) {
    super(daoFactory.getContext());
  }

  /**
   * <h2>SQL insert</h2>
   * <pre>INSERT INTO bean_with_accessors (duration, istant, local_date, local_date_time, local_time, month_day, offset_date_time, offset_time, period, year, year_month, zone_id, zone_offset, zoned_date_time) VALUES (:duration, :istant, :localDate, :localDateTime, :localTime, :monthDay, :offsetDateTime, :offsetTime, :period, :year, :yearMonth, :zoneId, :zoneOffset, :zonedDateTime)</pre>
   *
   ...
   */
  @Override
  public int insert(BeanWithAccessors value) {
    // Specialized Insert - InsertType - BEGIN
    if (insertPreparedStatement0==null) {
      // generate static SQL for statement
      String _sql="INSERT INTO bean_with_accessors (duration, istant, local_date, local_date_time, local_time, month_day, offset_date_time, offset_time, period, year, year_month, zone_id, zone_offset, zoned_date_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    if (_context.isLogEnabled()) {
      ...
      Logger.info("INSERT INTO bean_with_accessors (%s) VALUES (%s)", _columnNameBuffer.toString(), _columnValueBuffer.toString());
   ...
   */
  @Override
  public int update(BeanWithAccessors value) {
    if (updatePreparedStatement1==null) {
      // generate static SQL for statement
      String _sql="UPDATE bean_with_accessors SET duration=?, istant=?, local_date=?, local_date_time=?, local_time=?, month_day=?, offset_date_time=?, offset_time=?, period=?, year=?, year_month=?, zone_id=?, zone_offset=?, zoned_date_time=? WHERE year=?";
   ...
   * <h2>Select SQL:</h2>
   *
   * <pre>SELECT id, duration, istant, local_date, local_date_time, local_time, month_day, offset_date_time, offset_time, period, year, year_month, zone_id, zone_offset, zoned_date_time FROM bean_with_accessors WHERE year=:value.year</pre>
   *
   * <h2>Mapped class:</h2>
   * {@link BeanWithAccessors}
   *
   ...
   */
  @Override
  public List<BeanWithAccessors> select(BeanWithAccessors value) {
    ...
    try (Cursor _cursor = getDatabase().query(_sql, _sqlArgs)) {
      ...
      ArrayList<BeanWithAccessors> resultList=new ArrayList<BeanWithAccessors>(_cursor.getCount());
      BeanWithAccessors resultBean=null;
      ...
      if (_cursor.moveToFirst()) {
        ...
        do
         {
          resultBean=new BeanWithAccessors();

          resultBean.setId(_cursor.getLong(index0));
          if (!_cursor.isNull(index1)) { resultBean.setDuration(DurationUtils.read(_cursor.getString(index1))); }
          if (!_cursor.isNull(index2)) { resultBean.setIstant(InstantUtils.read(_cursor.getString(index2))); }
          if (!_cursor.isNull(index3)) { resultBean.setLocalDate(LocalDateUtils.read(_cursor.getString(index3))); }
          if (!_cursor.isNull(index4)) { resultBean.setLocalDateTime(LocalDateTimeUtils.read(_cursor.getString(index4))); }
          if (!_cursor.isNull(index5)) { resultBean.setLocalTime(LocalTimeUtils.read(_cursor.getString(index5))); }
          if (!_cursor.isNull(index6)) { resultBean.setMonthDay(MonthDayUtils.read(_cursor.getString(index6))); }
          if (!_cursor.isNull(index7)) { resultBean.setOffsetDateTime(OffsetDateTimeUtils.read(_cursor.getString(index7))); }
          if (!_cursor.isNull(index8)) { resultBean.setOffsetTime(OffsetTimeUtils.read(_cursor.getString(index8))); }
          if (!_cursor.isNull(index9)) { resultBean.setPeriod(PeriodUtils.read(_cursor.getString(index9))); }
          if (!_cursor.isNull(index10)) { resultBean.setYear(YearUtils.read(_cursor.getString(index10))); }
          if (!_cursor.isNull(index11)) { resultBean.setYearMonth(YearMonthUtils.read(_cursor.getString(index11))); }
          if (!_cursor.isNull(index12)) { resultBean.setZoneId(ZoneIdUtils.read(_cursor.getString(index12))); }
          if (!_cursor.isNull(index13)) { resultBean.setZoneOffset(ZoneOffsetUtils.read(_cursor.getString(index13))); }
          if (!_cursor.isNull(index14)) { resultBean.setZonedDateTime(ZonedDateTimeUtils.read(_cursor.getString(index14))); }
  ...
  /**
   * <h2>SQL delete:</h2>
   * <pre>DELETE FROM bean_with_accessors WHERE year=:value.year</pre>
   *
   * <h2>Parameters used in where conditions:</h2>
   * <dl>
   * 	<dt>:value.year</dt><dd>is mapped to method's parameter <strong>value.year</strong></dd>
   ...
   */
  @Override
  public int delete(BeanWithAccessors value) {
    if (deletePreparedStatement2==null) {
      // generate static SQL for statement
      String _sql="DELETE FROM bean_with_accessors WHERE year=?";
    ...
    if (_context.isLogEnabled()) {
      ...
      // display log
      Logger.info("DELETE FROM bean_with_accessors WHERE year=?");
