...
public class BindAppDataSource extends AbstractDataSource implements BindAppDaoFactory, AppDataSource {
  ...
  /**
   * Unique identifier for Dao DaoBean
   */
  public static final int DAO_BEAN_UID = 0;

  /**
   * Unique identifier for Dao DaoImmutableBean
   */
  public static final int DAO_IMMUTABLE_BEAN_UID = 1;

  /**
   * Unique identifier for Dao DaoBeanWithAccessors
   */
  public static final int DAO_BEAN_WITH_ACCESSORS_UID = 2;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new BeanTable(), new BeanWithAccessorsTable(), new BeanImmutableTable()};

  /**
   * <p>dao instance</p>
   */
  protected DaoBeanImpl daoBean = new DaoBeanImpl(this);

  /**
   * <p>dao instance</p>
   */
  protected DaoImmutableBeanImpl daoImmutableBean = new DaoImmutableBeanImpl(this);

  /**
   * <p>dao instance</p>
   */
  protected DaoBeanWithAccessorsImpl daoBeanWithAccessors = new DaoBeanWithAccessorsImpl(this);
  ...
  @Override
  public DaoBeanImpl getDaoBean() {
    return daoBean;
  }

  @Override
  public DaoImmutableBeanImpl getDaoImmutableBean() {
    return daoImmutableBean;
  }

  @Override
  public DaoBeanWithAccessorsImpl getDaoBeanWithAccessors() {
    return daoBeanWithAccessors;
  }
  ...
  protected void onCreate(SupportSQLiteDatabase database) {
    ...
    // log section create BEGIN
    if (this.logEnabled) {
      Logger.info("DDL: %s",BeanWithAccessorsTable.CREATE_TABLE_SQL);
    }
    // log section create END
    database.execSQL(BeanWithAccessorsTable.CREATE_TABLE_SQL);
    // log section create BEGIN
    if (this.logEnabled) {
      Logger.info("DDL: %s",BeanImmutableTable.CREATE_TABLE_SQL);
    }
    // log section create END
    database.execSQL(BeanImmutableTable.CREATE_TABLE_SQL);
  ...
  public void clearCompiledStatements() {
    DaoBeanImpl.clearCompiledStatements();
    DaoImmutableBeanImpl.clearCompiledStatements();
    DaoBeanWithAccessorsImpl.clearCompiledStatements();
  }
  ...
  class DataSourceSingleThread implements BindAppDaoFactory {
    ...
    protected DaoBeanImpl _daoBean;

    protected DaoImmutableBeanImpl _daoImmutableBean;

    protected DaoBeanWithAccessorsImpl _daoBeanWithAccessors;
     ...
     */
    public DaoImmutableBeanImpl getDaoImmutableBean() {
      if (_daoImmutableBean==null) {
        _daoImmutableBean=new DaoImmutableBeanImpl(this);
      }
      return _daoImmutableBean;
    }
     ...
     */
    public DaoBeanWithAccessorsImpl getDaoBeanWithAccessors() {
      if (_daoBeanWithAccessors==null) {
        _daoBeanWithAccessors=new DaoBeanWithAccessorsImpl(this);
      }
      return _daoBeanWithAccessors;
    }
