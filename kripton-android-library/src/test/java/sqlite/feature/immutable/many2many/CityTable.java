...
public class CityTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE cities (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name TEXT);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE cities (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name TEXT);";
