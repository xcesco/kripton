...
public class PersonTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE person (pk TEXT PRIMARY KEY NOT NULL, birth_city TEXT, birth_day TEXT, name TEXT, surname TEXT); CREATE INDEX idx_person_name ON person(name);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE person (pk TEXT PRIMARY KEY NOT NULL, birth_city TEXT, birth_day TEXT, name TEXT, surname TEXT); CREATE INDEX idx_person_name ON person(name);";
   ...
   * Columns array
   */
  private static final String[] COLUMNS = {COLUMN_PK, COLUMN_BIRTH_CITY, COLUMN_BIRTH_DAY, COLUMN_NAME, COLUMN_SURNAME};
