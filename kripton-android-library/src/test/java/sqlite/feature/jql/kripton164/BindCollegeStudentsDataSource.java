...
/**
 * <p>
 * Implementation of the CollegeStudentsDataSource datasource.
...
public class BindCollegeStudentsDataSource extends AbstractDataSource implements BindCollegeStudentsDaoFactory, CollegeStudentsDataSource {
   ...
   */
  public static BindCollegeStudentsDataSource getInstance() {
  ...
  public static BindCollegeStudentsDataSource open() {
    BindCollegeStudentsDataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  public static BindCollegeStudentsDataSource build(DataSourceOptions options) {
    ...
    Logger.info("Datasource BindCollegeStudentsDataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindCollegeStudentsDaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindCollegeStudentsDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindCollegeStudentsDaoFactory daoFactory);
  }
  ...
  class DataSourceSingleThread implements BindCollegeStudentsDaoFactory {
    ...
    public CollegeStudentDaoImpl getCollegeStudentDao() {
      if (_collegeStudentDao==null) {
        _collegeStudentDao=new CollegeStudentDaoImpl(this);
      }
