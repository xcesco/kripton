...
/**
 * <p>
 * Represents implementation of datasource CollegeStudentsDataSource.
 * This class expose database interface through Dao attribute.
 * </p>
 *
 * @see CollegeStudentsDataSource
 * @see BindCollegeStudentsDaoFactory
 * @see CollegeStudentDao
 * @see CollegeStudentDaoImpl
 * @see CollegeStudent
 */
public class BindCollegeStudentsDataSource extends AbstractDataSource implements BindCollegeStudentsDaoFactory, CollegeStudentsDataSource {
  
  /** <p>datasource singleton</p>. */
  static volatile BindCollegeStudentsDataSource instance;

  /** <p>Mutex to manage multithread access to instance</p>. */
  private static final Object mutex = new Object();

  /** Unique identifier for Dao CollegeStudentDao. */
  public static final int COLLEGE_STUDENT_DAO_UID = 0;

  /** List of tables compose datasource. */
  static final SQLiteTable[] TABLES = {new CollegeStudentTable()};
  ...
  /**
   * Instantiates a new bind college students data source.
   *
   * @param options the options
   */
  protected BindCollegeStudentsDataSource(DataSourceOptions options) {
    super("students.db", 1, options);
  }

  /* (non-Javadoc)
   * @see sqlite.feature.jql.kripton163.BindCollegeStudentsDaoFactory#getCollegeStudentDao()
   */
  @Override
  public CollegeStudentDaoImpl getCollegeStudentDao() {
    return collegeStudentDao;
  }
   ...
   *
   * @return the bind college students data source
   */
  public static BindCollegeStudentsDataSource instance() {
   ...
   */
  public static BindCollegeStudentsDataSource open() {
    BindCollegeStudentsDataSource instance=instance();
    instance.openWritableDatabase();
    return instance;
  }
   ...
   * @return opened dataSource instance.
   */
  public static BindCollegeStudentsDataSource openReadOnly() {
    BindCollegeStudentsDataSource instance=instance();
  ...
  public void onCreate(SQLiteDatabase database) {
    ...
    // log section BEGIN
    if (this.logEnabled) {
      Logger.info("DDL: %s",CollegeStudentTable.CREATE_TABLE_SQL);
    }
    // log section END
    database.execSQL(CollegeStudentTable.CREATE_TABLE_SQL);
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindCollegeStudentsDaoFactory> {
     ...
     */
    TransactionResult onExecute(BindCollegeStudentsDaoFactory daoFactory);
  }
  ...
  class DataSourceSingleThread implements BindCollegeStudentsDaoFactory {
    ...
    /** The college student dao. */
    protected CollegeStudentDaoImpl _collegeStudentDao;

    /**
     * Instantiates a new data source single thread.
     */
    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindCollegeStudentsDataSource.this);
    }

    /**
     * retrieve dao CollegeStudentDao.
     *
     * @return the college student dao
     */
    public CollegeStudentDaoImpl getCollegeStudentDao() {
