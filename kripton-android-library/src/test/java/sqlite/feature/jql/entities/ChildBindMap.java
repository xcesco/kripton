...
public class ChildBindMap extends AbstractMapper<Child> {
   ...
   */
  @Override
  public void serializeOnXml(Child object, XMLSerializer xmlSerializer, EventType currentEventType)
      throws Exception {
   ...
   */
  @Override
  public Child parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Child instance = new Child();
