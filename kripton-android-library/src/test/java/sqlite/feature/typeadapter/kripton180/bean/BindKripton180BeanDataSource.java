...
public class BindKripton180BeanDataSource extends AbstractDataSource implements BindKripton180BeanDaoFactory, Kripton180BeanDataSource {
  ...
  /**
   * Instantiates a new bind kripton 180 bean data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.typeadapter.kripton180.bean.BindKripton180BeanDaoFactory#getEmployeeBeanDao()
   */
  @Override
   ...
   *
   * @return the bind kripton 180 bean data source
   */
