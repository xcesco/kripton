...
public class BindKripton180RawDataSource extends AbstractDataSource implements BindKripton180RawDaoFactory, Kripton180RawDataSource {
  ...
  /**
   * Instantiates a new bind kripton 180 raw data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.typeadapter.kripton180.raw.BindKripton180RawDaoFactory#getEmployeeRawDao()
   */
  @Override
   ...
   *
   * @return the bind kripton 180 raw data source
   */
