...
/**
 * <p>
 * Implementation of the Kripton180RawDataSource datasource.
...
public class BindKripton180RawDataSource extends AbstractDataSource implements BindKripton180RawDaoFactory, Kripton180RawDataSource {
   ...
   */
  static volatile BindKripton180RawDataSource instance;
  ...
  /**
   * Unique identifier for Dao EmployeeRawDao
   */
  public static final int EMPLOYEE_RAW_DAO_UID = 0;
      ...
      synchronized(mutex) {
        ...
        if (result==null) {
          DataSourceOptions options=DataSourceOptions.builder()
          	...
          	.neverClose(false)
          	.build();
          instance=result=new BindKripton180RawDataSource(options);
          try {
  ...
  public void clearCompiledStatements() {
    EmployeeRawDaoImpl.clearCompiledStatements();
  }
    ...
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindKripton180RawDataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindKripton180RawDataSource is already builded");
    }
    Logger.info("Datasource BindKripton180RawDataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindKripton180RawDaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindKripton180RawDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindKripton180RawDaoFactory daoFactory);
  }

  class DataSourceSingleThread implements BindKripton180RawDaoFactory {
    private SQLContextInSessionImpl _context;

    protected EmployeeRawDaoImpl _employeeRawDao;

    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindKripton180RawDataSource.this);
    }
