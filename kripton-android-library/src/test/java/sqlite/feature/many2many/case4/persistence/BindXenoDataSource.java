...
public class BindXenoDataSource extends AbstractDataSource implements BindXenoDaoFactory, XenoDataSource {
  ...
  static final SQLiteTable[] TABLES = {new CountryTable(), new PersonTable(), new PhoneNumberTable(), new PrefixConfigTable(), new PersonPhoneNumberTable()};
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.many2many.case4.persistence.BindXenoDaoFactory#getPhoneDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.many2many.case4.persistence.BindXenoDaoFactory#getPrefixConfigDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.many2many.case4.persistence.BindXenoDaoFactory#getCountryDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.many2many.case4.persistence.BindXenoDaoFactory#getPerson2PhoneDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.many2many.case4.persistence.BindXenoDaoFactory#getPersonDao()
   */
  @Override
