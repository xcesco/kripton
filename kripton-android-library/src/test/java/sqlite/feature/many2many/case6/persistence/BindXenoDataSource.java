...
public class BindXenoDataSource extends AbstractDataSource implements BindXenoDaoFactory, XenoDataSource {
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.many2many.case6.persistence.BindXenoDaoFactory#getPhoneDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.many2many.case6.persistence.BindXenoDaoFactory#getPrefixConfigDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.many2many.case6.persistence.BindXenoDaoFactory#getCountryDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.many2many.case6.persistence.BindXenoDaoFactory#getPerson2PhoneDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.many2many.case6.persistence.BindXenoDaoFactory#getPersonDao()
   */
  @Override
