...
public class CountryBindMap extends AbstractMapper<Country> {
   ...
   */
  @Override
  public void serializeOnXml(Country object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Country parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Country instance = new Country();
                  ...
                  // property translatedName (mapped on "translatedName")
                   {
                    ...
                    xmlParser.nextTag();
                    collection.put(key, value);
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("translatedName")) {
                      xmlParser.nextTag();
                      key=Translation.valueOf(StringEscapeUtils.unescapeXml(xmlParser.getElementText()));
                      xmlParser.nextTag();
                      if (xmlParser.isEmptyElement()) {
