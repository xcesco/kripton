...
public class ChannelBindMap extends AbstractMapper<Channel> {
  ...
  public int serializeOnJackson(Channel object, JsonGenerator jacksonSerializer) throws Exception {
    ...
    if (object.lastBuildDate!=null)  {
      fieldCount++;
      // using type adapter sqlite.feature.relations.case4.model.DateAdapter
  ...
  public void serializeOnXml(Channel object, XMLSerializer xmlSerializer,
    ...
    if (object.image!=null)  {
      ...
      imageBindMap.serializeOnXml(object.image, xmlSerializer, EventType.START_TAG);
      xmlSerializer.writeEndElement();
    }
    ...
    // field lastBuildDate (mapped with "lastBuildDate")
    // field trasformation java.lang.String sqlite.feature.relations.case4.model.DateAdapter 
    if (object.lastBuildDate!=null) {
      // using type adapter sqlite.feature.relations.case4.model.DateAdapter
    ...
    if (object.articles!=null)  {
      ...
      for (int i=0; i<n; i++) {
        ...
        if (item==null) {
          ...
          articleBindMap.serializeOnXml(item, xmlSerializer, EventType.START_TAG);
          xmlSerializer.writeEndElement();
        }
      }
