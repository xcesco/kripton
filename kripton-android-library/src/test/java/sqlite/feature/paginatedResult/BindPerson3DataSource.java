...
public class BindPerson3DataSource extends AbstractDataSource implements BindPerson3DaoFactory, Person3DataSource {
  ...
  /**
   * Instantiates a new bind person 3 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.paginatedResult.BindPerson3DaoFactory#getDao3Person()
   */
  @Override
   ...
   *
   * @return the bind person 3 data source
   */
