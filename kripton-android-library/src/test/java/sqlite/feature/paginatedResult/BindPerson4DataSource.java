...
/**
 * <p>
 * Represents implementation of datasource Person4DataSource.
 * This class expose database interface through Dao attribute.
 * </p>
 *
 * @see Person4DataSource
 * @see BindPerson4DaoFactory
 * @see Dao4Person
 * @see Dao4PersonImpl
 * @see Person
 */
public class BindPerson4DataSource extends AbstractDataSource implements BindPerson4DaoFactory, Person4DataSource {
  
  /** <p>datasource singleton</p>. */
  static volatile BindPerson4DataSource instance;

  /** <p>Mutex to manage multithread access to instance</p>. */
  private static final Object mutex = new Object();

  /** Unique identifier for Dao Dao4Person. */
  public static final int DAO4_PERSON_UID = 0;

  /** List of tables compose datasource. */
  static final SQLiteTable[] TABLES = {new PersonTable()};

  /** <p>dao instance</p>. */
  protected Dao4PersonImpl dao4Person = new Dao4PersonImpl(context);

  /** Used only in transactions (that can be executed one for time. */
  protected DataSourceSingleThread _daoFactorySingleThread = new DataSourceSingleThread();

  /**
   * Instantiates a new bind person 4 data source.
   *
   * @param options the options
   */
  protected BindPerson4DataSource(DataSourceOptions options) {
    super("person4.db", 1, options);
  }

  /* (non-Javadoc)
   * @see sqlite.feature.paginatedResult.BindPerson4DaoFactory#getDao4Person()
   */
  @Override
  public Dao4PersonImpl getDao4Person() {
    return dao4Person;
  }
   ...
   *
   * @return the bind person 4 data source
   */
  ...
  public void clearCompiledStatements() {
    Dao4PersonImpl.clearCompiledStatements();
  }
   ...
   * @return the bind person 4 data source
   */
  public static BindPerson4DataSource build(DataSourceOptions options) {
    BindPerson4DataSource result=instance;
    if (result==null) {
      synchronized(mutex) {
        result=instance;
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindPerson4DataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindPerson4DataSource is already builded");
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindPerson4DaoFactory> {
  ...
  class DataSourceSingleThread implements BindPerson4DaoFactory {
    ...
    /** The dao 4 person. */
    protected Dao4PersonImpl _dao4Person;
    ...
    public Dao4PersonImpl getDao4Person() {
      if (_dao4Person==null) {
        _dao4Person=new Dao4PersonImpl(_context);
      }
      return _dao4Person;
    }
