...
public class SeminarTable implements SQLiteTable {
  ...
  /** <p> DDL to create table seminar </p>  <pre>CREATE TABLE seminar (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, location TEXT);</pre>. */
  ...
  /** <p> DDL to drop table seminar </p>  <pre>DROP TABLE IF EXISTS seminar;</pre>. */
