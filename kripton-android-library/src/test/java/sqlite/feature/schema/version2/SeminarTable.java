...
public class SeminarTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE seminar (id INTEGER PRIMARY KEY AUTOINCREMENT, location TEXT, name TEXT);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE seminar (id INTEGER PRIMARY KEY AUTOINCREMENT, location TEXT, name TEXT);";
