...
/**
 * The Class TestPaginatedResult3Runtime.
 *
 * @author xcesco
 */
@Config(manifest = Config.NONE)
@RunWith(RobolectricTestRunner.class)
public class TestPaginatedResult3Runtime extends BaseAndroidTest {
	...
	@Test
	public void testRun() {
		try (BindPerson3DataSource dataSource = BindPerson3DataSource.open(); Dao3PersonImpl dao = dataSource.getDao3Person()) {
			dao.deleteAll();
			...
			PaginatedResult<Person> result = dao.select(0);
