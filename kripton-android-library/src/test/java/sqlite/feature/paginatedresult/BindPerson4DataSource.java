...
/**
 * <p>
 * Implementation of the Person4DataSource datasource.
...
public class BindPerson4DataSource extends AbstractDataSource implements BindPerson4DaoFactory, Person4DataSource {
   ...
   * <p>dao instance</p>
   */
  protected Dao4PersonImpl dao4Person = new Dao4PersonImpl(this);
  ...
  public static BindPerson4DataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindPerson4DataSource is forced to be (re)builded");
      instance.forceClose();
      instance=null;
    }
    BindPerson4DataSource result=instance;
    ...
    Logger.info("Datasource BindPerson4DataSource is created");
    return result;
  }
  ...
  class DataSourceSingleThread implements BindPerson4DaoFactory {
    ...
    public Dao4PersonImpl getDao4Person() {
      if (_dao4Person==null) {
        _dao4Person=new Dao4PersonImpl(this);
      }
      return _dao4Person;
    }
