...
public interface BookDao {
	...
	@BindSqlSelect(jql = "SELECT * FROM Book " + "INNER JOIN Loan ON Loan.bookId = Book.id " + "INNER JOIN User on User.id = Loan.userId " + "WHERE User.name LIKE :userName")
	...
	@BindSqlSelect(jql = "SELECT * FROM Book " + "INNER JOIN Loan ON Loan.bookId LIKE Book.id " + "WHERE Loan.userId LIKE :userId ")
	LiveData<List<Book>> findBooksBorrowedByUser(String userId);

	@BindSqlSelect(jql = "SELECT * FROM Book " + "INNER JOIN Loan ON Loan.bookId LIKE Book.id " + "WHERE Loan.userId LIKE :userId " + "AND Loan.endTime > :after ")
	...
	@BindSqlSelect(jql = "SELECT * FROM Book " + "INNER JOIN Loan ON Loan.bookId LIKE Book.id " + "WHERE Loan.userId = :userId ")
