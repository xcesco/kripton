...
public class BookTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE book (id TEXT PRIMARY KEY NOT NULL, isbn TEXT, title TEXT);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE book (id TEXT PRIMARY KEY NOT NULL, isbn TEXT, title TEXT);";
  ...
  /**
   * Entity's property <code>isbn</code> is associated to table column <code>isbn</code>. This costant represents column name.
   *
   *  @see Book#isbn
   */
   ...
   * Columns array
   */
  private static final String[] COLUMNS = {COLUMN_ID, COLUMN_ISBN, COLUMN_TITLE};
