...
public class Person2PhoneDaoImpl extends Dao implements GeneratedPerson2PhoneDao {
   ...
   */
  private static final String SELECT_BY_ID_SQL24 = "SELECT id, person_id, phone_number_id FROM person_phone_number WHERE id=?";

  /**
   * SQL definition for method selectByPersonId
   */
  private static final String SELECT_BY_PERSON_ID_SQL26 = "SELECT id, person_id, phone_number_id FROM person_phone_number WHERE person_id=?";

  /**
   * SQL definition for method selectByPhoneNumberId
   */
  private static final String SELECT_BY_PHONE_NUMBER_ID_SQL28 = "SELECT id, person_id, phone_number_id FROM person_phone_number WHERE phone_number_id=?";
