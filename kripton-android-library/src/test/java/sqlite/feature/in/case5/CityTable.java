...
public class CityTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE city (id INTEGER PRIMARY KEY AUTOINCREMENT, date TEXT, name TEXT);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE city (id INTEGER PRIMARY KEY AUTOINCREMENT, date TEXT, name TEXT);";
