...
public class PersonTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE person (id INTEGER PRIMARY KEY AUTOINCREMENT, birth_city_id INTEGER, birth_day TEXT, name TEXT, surname TEXT, FOREIGN KEY(birth_city_id) REFERENCES city(id)); CREATE INDEX idx_person_name ON person(name);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE person (id INTEGER PRIMARY KEY AUTOINCREMENT, birth_city_id INTEGER, birth_day TEXT, name TEXT, surname TEXT, FOREIGN KEY(birth_city_id) REFERENCES city(id)); CREATE INDEX idx_person_name ON person(name);";
   ...
   * Columns array
   */
  private static final String[] COLUMNS = {COLUMN_ID, COLUMN_BIRTH_CITY_ID, COLUMN_BIRTH_DAY, COLUMN_NAME, COLUMN_SURNAME};
