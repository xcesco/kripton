...
public class BindAppWithConfigDataSource extends AbstractDataSource implements BindAppWithConfigDaoFactory, AppWithConfigDataSource {
  ...
  static volatile BindAppWithConfigDataSource instance;
  ...
  /**
   * Instantiates a new bind app with config data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.datasourceoptions.kripton234.BindAppWithConfigDaoFactory#getDaoPerson()
   */
  @Override
   ...
   *
   * @return the bind app with config data source
   */
