 ...
 */
@BindDataSourceOptions(logEnabled = true, populator = PersonPopulator.class, openHelperFactory = KriptonSQLiteHelperFactory.class, databaseLifecycleHandler=PersonLifecycleHandler.class, updateTasks = {
