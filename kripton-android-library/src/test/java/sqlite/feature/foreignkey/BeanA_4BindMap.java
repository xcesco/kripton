...
/**
 * This class is binder map for BeanA_4
 *
 * @see BeanA_4
 */
...
public class BeanA_4BindMap extends AbstractMapper<BeanA_4> {
  ...
  @Override
  public int serializeOnJacksonAsString(BeanA_4 object, JsonGenerator jacksonSerializer) throws
      Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(BeanA_4 object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public BeanA_4 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    BeanA_4 instance = new BeanA_4();
