...
public class BeanA_1BindMap extends AbstractMapper<BeanA_1> {
   ...
   */
  @Override
  public void serializeOnXml(BeanA_1 object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public BeanA_1 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    BeanA_1 instance = new BeanA_1();
