...
public class BindDummy2DataSource extends AbstractDataSource implements BindDummy2DaoFactory, Dummy2DataSource {
  ...
  public static BindDummy2DataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindDummy2DataSource is forced to be (re)builded");
      instance=null;
    }
    BindDummy2DataSource result=instance;
    if (result==null) {
    ...
    Logger.info("Datasource BindDummy2DataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindDummy2DaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindDummy2DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindDummy2DaoFactory daoFactory);
  }
