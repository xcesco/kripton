...
/**
 * <p>
 * Implementation of the Dummy01DataSource datasource.
...
public class BindDummy01DataSource extends AbstractDataSource implements BindDummy01DaoFactory, Dummy01DataSource {
   ...
   */
  public static final int DAO_CHANNEL_UID = 0;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new ChannelTable()};
  ...
  public static BindDummy01DataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindDummy01DataSource is forced to be (re)builded");
      instance=null;
    }
    BindDummy01DataSource result=instance;
    if (result==null) {
    ...
    Logger.info("Datasource BindDummy01DataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindDummy01DaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindDummy01DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindDummy01DaoFactory daoFactory);
  }
