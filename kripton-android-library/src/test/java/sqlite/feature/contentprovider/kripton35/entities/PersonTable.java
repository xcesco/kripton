...
public class PersonTable implements SQLiteTable {
  ...
  /** <p> DDL to create table person </p>  <pre>CREATE TABLE person (id INTEGER PRIMARY KEY AUTOINCREMENT, alias_parent_id INTEGER, city INTEGER, birth_city TEXT, birth_day TEXT, value INTEGER, name TEXT, surname TEXT, FOREIGN KEY(alias_parent_id) REFERENCES person(id), FOREIGN KEY(city) REFERENCES city(id));</pre>. */
