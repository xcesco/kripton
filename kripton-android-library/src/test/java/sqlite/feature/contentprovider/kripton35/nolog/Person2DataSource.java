...
@BindContentProvider(authority="sqlite.feature.contentprovider.kripton35.nolog")
@BindDataSource(daoSet={Person2DAO.class, City2DAO.class}, fileName = "person", version = 1, log=false)
