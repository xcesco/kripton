...
public class CityTable implements SQLiteTable {
  ...
  /** <p> DDL to create table city </p>  <pre>CREATE TABLE city (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT);</pre>. */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE city (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT);";

  /** <p> DDL to drop table city </p>  <pre>DROP TABLE IF EXISTS city;</pre>. */
