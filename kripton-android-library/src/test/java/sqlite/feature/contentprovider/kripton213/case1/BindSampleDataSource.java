...
public class BindSampleDataSource extends AbstractDataSource implements BindSampleDaoFactory, SampleDataSource {
  ...
  /**
   * Instantiates a new bind sample data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.feature.contentprovider.kripton213.case1.BindSampleDaoFactory#getCheeseDao()
   */
  @Override
   ...
   *
   * @return the bind sample data source
   */
