...
public class PersonTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE person (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, alias_parent_id INTEGER, birth_city TEXT, birth_day TEXT, name TEXT, surname TEXT, value INTEGER, FOREIGN KEY(alias_parent_id) REFERENCES person(id));</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE person (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, alias_parent_id INTEGER, birth_city TEXT, birth_day TEXT, name TEXT, surname TEXT, value INTEGER, FOREIGN KEY(alias_parent_id) REFERENCES person(id));";
   ...
   * Columns array
   */
  private static final String[] COLUMNS = {COLUMN_ID, COLUMN_PARENT_ID, COLUMN_BIRTH_CITY, COLUMN_BIRTH_DAY, COLUMN_NAME, COLUMN_SURNAME, COLUMN_VALUE};
