...
public class ArtistBindMap extends AbstractMapper<Artist> {
   ...
   */
  @Override
  public void serializeOnXml(Artist object, XMLSerializer xmlSerializer, int currentEventType)
      throws Exception {
   ...
   */
  @Override
  public Artist parseOnXml(XMLParser xmlParser, int currentEventType) throws Exception {
    Artist instance = new Artist();
