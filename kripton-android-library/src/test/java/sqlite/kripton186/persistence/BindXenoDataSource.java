...
public class BindXenoDataSource extends AbstractDataSource implements BindXenoDaoFactory, XenoDataSource {
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton186.persistence.BindXenoDaoFactory#getPhoneDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton186.persistence.BindXenoDaoFactory#getPrefixConfigDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton186.persistence.BindXenoDaoFactory#getCountryDao()
   */
  @Override
