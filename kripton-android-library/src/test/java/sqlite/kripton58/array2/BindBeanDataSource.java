...
public class BindBeanDataSource extends AbstractDataSource implements BindBeanDaoFactory, BeanDataSource {
  ...
  static final SQLiteTable[] TABLES = {new BeanBeanTable()};

  /** <p>dao instance</p>. */
  protected BeanDaoImpl beanDao = new BeanDaoImpl(context);

  /** Used only in transactions (that can be executed one for time. */
  protected DataSourceSingleThread _daoFactorySingleThread = new DataSourceSingleThread();

  /**
   * Instantiates a new bind bean data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton58.array2.BindBeanDaoFactory#getBeanDao()
   */
  @Override
   ...
   *
   * @return the bind bean data source
   */
  ...
  class DataSourceSingleThread implements BindBeanDaoFactory {
    ...
    public BeanDaoImpl getBeanDao() {
      if (_beanDao==null) {
        _beanDao=new BeanDaoImpl(_context);
      }
      return _beanDao;
    }
