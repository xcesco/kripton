...
public class BindCharDataSource extends AbstractDataSource implements BindCharDaoFactory, CharDataSource {
  ...
  static volatile BindCharDataSource instance;

  /** <p>Mutex to manage multithread access to instance</p>. */
  private static final Object mutex = new Object();

  /** Unique identifier for Dao CharDao. */
  public static final int CHAR_DAO_UID = 0;

  /** List of tables compose datasource. */
  static final SQLiteTable[] TABLES = {new CharBeanTable()};
  ...
  /**
   * Instantiates a new bind char data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton58.array2.BindCharDaoFactory#getCharDao()
   */
  @Override
   ...
   *
   * @return the bind char data source
   */
  ...
  public void clearCompiledStatements() {
    CharDaoImpl.clearCompiledStatements();
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindCharDaoFactory> {
     ...
     */
    TransactionResult onExecute(BindCharDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @return the t
     */
    T onExecute(BindCharDaoFactory daoFactory);
  }

  /**
   * The Class DataSourceSingleThread.
   */
  class DataSourceSingleThread implements BindCharDaoFactory {
    
    /** The context. */
    private SQLContextInSessionImpl _context;

    /** The char dao. */
    protected CharDaoImpl _charDao;

    /**
     * Instantiates a new data source single thread.
     */
    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindCharDataSource.this);
    }
