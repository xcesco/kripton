...
public class LongBeanBindMap extends AbstractMapper<LongBean> {
   ...
   */
  @Override
  public void serializeOnXml(LongBean object, XMLSerializer xmlSerializer, int currentEventType)
      throws Exception {
            ...
            switch(currentTag) {
                ...
                case "value":
                  // property value (mapped on "value")
                   {
                    ArrayList<Long> collection=CollectionUtils.merge(new ArrayList<>(), instance.getValue());
                    Long item;
                    // add first element
                    item=null;
                ...
                case "value2":
                  // property value2 (mapped on "value2")
                   {
                    ArrayList<Long> collection=CollectionUtils.merge(new ArrayList<>(), instance.getValue2());
                    Long item;
                    // add first element
                    item=null;
                    if (xmlParser.isEmptyElement()) {
