...
/**
 * <p>
 * Implementation of the StringDataSource datasource.
...
public class BindStringDataSource extends AbstractDataSource implements BindStringDaoFactory, StringDataSource {
   ...
   */
  static volatile BindStringDataSource instance;
   ...
   */
  public static BindStringDataSource getInstance() {
  ...
  public static BindStringDataSource open() {
    BindStringDataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindStringDaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindStringDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindStringDaoFactory daoFactory);
  }
  ...
  class DataSourceSingleThread implements BindStringDaoFactory {
    ...
    public StringDaoImpl getStringDao() {
      if (_stringDao==null) {
        _stringDao=new StringDaoImpl(this);
      }
      return _stringDao;
    }
