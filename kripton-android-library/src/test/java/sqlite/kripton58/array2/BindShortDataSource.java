...
public class BindShortDataSource extends AbstractDataSource implements BindShortDaoFactory, ShortDataSource {
  ...
  /**
   * Instantiates a new bind short data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton58.array2.BindShortDaoFactory#getShortDao()
   */
  @Override
   ...
   *
   * @return the bind short data source
   */
