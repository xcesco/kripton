 ...
 *  @see CharBean
 */
public class CharBeanTable implements SQLiteTable {
  
  /** Costant represents typeName of table char_bean. */
  public static final String TABLE_NAME = "char_bean";

  /** <p> DDL to create table char_bean </p>  <pre>CREATE TABLE char_bean (id INTEGER PRIMARY KEY AUTOINCREMENT, value BLOB, value2 BLOB);</pre>. */
  ...
  /** <p> DDL to drop table char_bean </p>  <pre>DROP TABLE IF EXISTS char_bean;</pre>. */
   ...
   * @return the byte[]
   */
  public static byte[] serializeValue(char[] value) {
    if (value==null) {
      return null;
    }
