...
public class BindFloatDataSource extends AbstractDataSource implements BindFloatDaoFactory, FloatDataSource {
  ...
  static volatile BindFloatDataSource instance;

  /** <p>Mutex to manage multithread access to instance</p>. */
  private static final Object mutex = new Object();

  /** Unique identifier for Dao FloatDao. */
  public static final int FLOAT_DAO_UID = 0;

  /** List of tables compose datasource. */
  static final SQLiteTable[] TABLES = {new FloatBeanTable()};
  ...
  /**
   * Instantiates a new bind float data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton58.array2.BindFloatDaoFactory#getFloatDao()
   */
  @Override
   ...
   *
   * @return the bind float data source
   */
  ...
  public void clearCompiledStatements() {
    FloatDaoImpl.clearCompiledStatements();
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindFloatDaoFactory> {
     ...
     */
    TransactionResult onExecute(BindFloatDaoFactory daoFactory);
  }
  ...
  class DataSourceSingleThread implements BindFloatDaoFactory {
    ...
    /** The float dao. */
    protected FloatDaoImpl _floatDao;

    /**
     * Instantiates a new data source single thread.
     */
    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindFloatDataSource.this);
    }

    /**
     * retrieve dao FloatDao.
     *
     * @return the float dao
     */
    public FloatDaoImpl getFloatDao() {
      if (_floatDao==null) {
