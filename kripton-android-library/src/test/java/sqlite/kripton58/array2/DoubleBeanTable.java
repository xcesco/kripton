 ...
 *  @see DoubleBean
 */
public class DoubleBeanTable implements SQLiteTable {
  
  /** Costant represents typeName of table double_bean. */
  public static final String TABLE_NAME = "double_bean";

  /** <p> DDL to create table double_bean </p>  <pre>CREATE TABLE double_bean (id INTEGER PRIMARY KEY AUTOINCREMENT, value BLOB, value2 BLOB);</pre>. */
  ...
  /** <p> DDL to drop table double_bean </p>  <pre>DROP TABLE IF EXISTS double_bean;</pre>. */
