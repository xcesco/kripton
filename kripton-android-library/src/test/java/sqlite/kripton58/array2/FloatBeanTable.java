 ...
 *  @see FloatBean
 */
public class FloatBeanTable implements SQLiteTable {
  
  /** Costant represents typeName of table float_bean. */
  public static final String TABLE_NAME = "float_bean";

  /** <p> DDL to create table float_bean </p>  <pre>CREATE TABLE float_bean (id INTEGER PRIMARY KEY AUTOINCREMENT, value BLOB, value2 BLOB);</pre>. */
  ...
  /** <p> DDL to drop table float_bean </p>  <pre>DROP TABLE IF EXISTS float_bean;</pre>. */
