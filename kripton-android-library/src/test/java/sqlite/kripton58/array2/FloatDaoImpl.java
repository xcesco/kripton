...
public class FloatDaoImpl extends Dao implements FloatDao {
   ...
   */
  private static final String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM float_bean";

  /**
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM float_bean WHERE value=? and value2=?";

  /**
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL6 = "SELECT id, value, value2 FROM float_bean WHERE value=? and value2=?";

  /**
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL8 = "SELECT id, value, value2 FROM float_bean WHERE value=? and value2=?";

  /**
   * SQL definition for method selectList
   */
  private static final String SELECT_LIST_SQL10 = "SELECT id, value, value2 FROM float_bean WHERE value=? and value2=?";
  ...
  public FloatDaoImpl(BindFloatDaoFactory daoFactory) {
  ...
  public FloatBean selectOne() {
    ...
    try (Cursor _cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      if (_cursor.moveToFirst()) {
        ...
        if (!_cursor.isNull(index1)) { resultBean.setValue(FloatBeanTable.parseValue(_cursor.getBlob(index1))); }
        if (!_cursor.isNull(index2)) { resultBean.setValue2(FloatBeanTable.parseValue2(_cursor.getBlob(index2))); }
  ...
  public List<FloatBean> selectList(float[] value, Float[] value2) {
    ...
    try (Cursor _cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      ArrayList<FloatBean> resultList=new ArrayList<FloatBean>(_cursor.getCount());
      FloatBean resultBean=null;
  ...
  public long updateOne(long id, float[] value, Float[] value2) {
    ...
    if (_context.isLogEnabled()) {
      ...
      // display log
      Logger.info("UPDATE float_bean SET id=:id WHERE value=? and value2=?");
  ...
  public long insert(FloatBean bean) {
    ...
    _contentValues.put("value", FloatBeanTable.serializeValue(bean.getValue()));
    _contentValues.put("value2", FloatBeanTable.serializeValue2(bean.getValue2()));
