...
/**
 * <p>
 * Implementation of the IntDataSource datasource.
...
public class BindIntDataSource extends AbstractDataSource implements BindIntDaoFactory, IntDataSource {
   ...
   */
  static volatile BindIntDataSource instance;
   ...
   */
  public static BindIntDataSource getInstance() {
  ...
  public static BindIntDataSource open() {
    BindIntDataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  public static BindIntDataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindIntDataSource is forced to be (re)builded");
      instance=null;
    }
    BindIntDataSource result=instance;
    if (result==null) {
    ...
    Logger.info("Datasource BindIntDataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindIntDaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindIntDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindIntDaoFactory daoFactory);
  }
