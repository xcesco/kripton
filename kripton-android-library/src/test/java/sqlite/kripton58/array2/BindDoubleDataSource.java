...
/**
 * <p>
 * Implementation of the DoubleDataSource datasource.
...
public class BindDoubleDataSource extends AbstractDataSource implements BindDoubleDaoFactory, DoubleDataSource {
   ...
   */
  static volatile BindDoubleDataSource instance;
  ...
  /**
   * Unique identifier for Dao DoubleDao
   */
  public static final int DOUBLE_DAO_UID = 0;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new DoubleBeanTable()};
  ...
  public static BindDoubleDataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindDoubleDataSource is forced to be (re)builded");
      instance=null;
    }
    BindDoubleDataSource result=instance;
    if (result==null) {
    ...
    Logger.info("Datasource BindDoubleDataSource is created");
    return result;
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindDoubleDaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindDoubleDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindDoubleDaoFactory daoFactory);
  }

  class DataSourceSingleThread implements BindDoubleDaoFactory {
    private SQLContextInSessionImpl _context;

    protected DoubleDaoImpl _doubleDao;

    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindDoubleDataSource.this);
    }
