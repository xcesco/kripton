...
public class BindDoubleDataSource extends AbstractDataSource implements BindDoubleDaoFactory, DoubleDataSource {
  ...
  /**
   * Instantiates a new bind double data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton58.array2.BindDoubleDaoFactory#getDoubleDao()
   */
  @Override
   ...
   *
   * @return the bind double data source
   */
