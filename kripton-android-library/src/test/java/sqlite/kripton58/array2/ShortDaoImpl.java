...
public class ShortDaoImpl extends Dao implements ShortDao {
   ...
   */
  private static final String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM short_bean";
   ...
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL6 = "SELECT id, value, value2 FROM short_bean WHERE value=? and value2=?";

  /**
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL8 = "SELECT id, value, value2 FROM short_bean WHERE value=? and value2=?";

  /**
   * SQL definition for method selectList
   */
  private static final String SELECT_LIST_SQL10 = "SELECT id, value, value2 FROM short_bean WHERE value=? and value2=?";
  ...
  public ShortDaoImpl(BindShortDaoFactory daoFactory) {
