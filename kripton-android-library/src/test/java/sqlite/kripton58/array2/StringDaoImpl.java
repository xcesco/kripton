...
public class StringDaoImpl extends Dao implements StringDao {
   ...
   */
  private static final String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM string_bean";
   ...
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL6 = "SELECT id, value, value2 FROM string_bean WHERE value=? and value2=?";

  /**
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL8 = "SELECT id, value, value2 FROM string_bean WHERE value=? and value2=?";

  /**
   * SQL definition for method selectList
   */
  private static final String SELECT_LIST_SQL10 = "SELECT id, value, value2 FROM string_bean WHERE value=? and value2=?";
  ...
  public StringBean selectOne() {
    ...
    try (Cursor _cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      if (_cursor.moveToFirst()) {
        ...
        if (!_cursor.isNull(index1)) { resultBean.setValue(StringBeanTable.parseValue(_cursor.getBlob(index1))); }
        if (!_cursor.isNull(index2)) { resultBean.setValue2(StringBeanTable.parseValue2(_cursor.getBlob(index2))); }
  ...
  public long insert(long id, String[] value, String[] value2) {
    ...
    if (insertPreparedStatement1==null) {
      // generate static SQL for statement
      String _sql="INSERT INTO string_bean (id, value, value2) VALUES (?, ?, ?)";
    ...
    if (_context.isLogEnabled()) {
      ...
      Logger.info("INSERT INTO string_bean (%s) VALUES (%s)", _columnNameBuffer.toString(), _columnValueBuffer.toString());
  ...
  public long insert(StringBean bean) {
    ...
    _contentValues.put("value", StringBeanTable.serializeValue(bean.getValue()));
    _contentValues.put("value2", StringBeanTable.serializeValue2(bean.getValue2()));
  ...
  /**
   * <h2>SQL delete</h2>
   * <pre>DELETE FROM string_bean WHERE value=:value and value2=:value2</pre>
   *
   * <h2>Where parameters:</h2>
   * <dl>
   * 	<dt>:value</dt><dd>is mapped to method's parameter <strong>value</strong></dd>
