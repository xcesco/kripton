            ...
            switch(currentTag) {
                ...
                case "value":
                  // property value (mapped on "value")
                   {
                    ArrayList<Float> collection=CollectionUtils.merge(new ArrayList<>(), instance.getValue());
                    Float item;
                    // add first element
                    item=null;
                ...
                case "value2":
                  // property value2 (mapped on "value2")
                   {
                    ArrayList<Float> collection=CollectionUtils.merge(new ArrayList<>(), instance.getValue2());
                    Float item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
