...
public class IntegerBeanBindMap extends AbstractMapper<IntegerBean> {
  @Override
  public int serializeOnJackson(IntegerBean object, JsonGenerator jacksonSerializer) throws
      Exception {
  ...
  @Override
  public int serializeOnJacksonAsString(IntegerBean object, JsonGenerator jacksonSerializer) throws
      Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(IntegerBean object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public IntegerBean parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    IntegerBean instance = new IntegerBean();
            ...
            switch(currentTag) {
                ...
                case "value2":
                  // property value2 (mapped on "value2")
                   {
                    LinkedList<Integer> collection=CollectionUtils.merge(new LinkedList<>(), instance.value2);
                    Integer item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
