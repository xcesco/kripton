...
public class ShortDaoImpl extends Dao implements ShortDao {
  ...
  private static final String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM short_bean WHERE value=?";

  /** The Constant SELECT_ONE_SQL3. */
  private static final String SELECT_ONE_SQL3 = "SELECT id, value, value2 FROM short_bean WHERE value=?";

  /** The Constant SELECT_ONE_SQL4. */
  private static final String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM short_bean WHERE value=?";

  /** The Constant SELECT_LIST_SQL5. */
  private static final String SELECT_LIST_SQL5 = "SELECT id, value, value2 FROM short_bean WHERE value=?";
  ...
  public long updateOne(List<Short> value, long id, List<Short> paramValue) {
    if (updateOnePreparedStatement0==null) {
      ...
      String _sql="UPDATE short_bean SET value=? WHERE id=? and value=?";
  ...
  public long insert(long id, List<Short> value) {
    if (insertPreparedStatement1==null) {
      // generate static SQL for statement
      String _sql="INSERT INTO short_bean (id, value) VALUES (?, ?)";
  ...
  public long delete(List<Short> paramValue) {
    if (deletePreparedStatement3==null) {
      // generate static SQL for statement
      String _sql="DELETE FROM short_bean WHERE value=?";
