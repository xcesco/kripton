...
public class FloatDaoImpl extends Dao implements FloatDao {
  ...
  private static final String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM float_bean WHERE value=?";

  /** The Constant SELECT_ONE_SQL3. */
  private static final String SELECT_ONE_SQL3 = "SELECT id, value, value2 FROM float_bean WHERE value=?";
  ...
  private static final String SELECT_LIST_SQL5 = "SELECT id, value, value2 FROM float_bean WHERE value=?";
  ...
  /**
   * Instantiates a new float dao impl.
   *
   * @param context the context
   */
  public FloatDaoImpl(SQLContext context) {
    super(context);
  }
   ...
   *
   * @param value 	is binded to <code>${value}</code>
   * @param listener 	is the FloatBean listener
   */
  @Override
