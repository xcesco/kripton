...
public class FloatDaoImpl extends Dao implements FloatDao {
   ...
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM float_bean WHERE value=?";

  /**
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL6 = "SELECT id, value, value2 FROM float_bean WHERE value=?";

  /**
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL8 = "SELECT id, value, value2 FROM float_bean WHERE value=?";

  /**
   * SQL definition for method selectList
   */
  private static final String SELECT_LIST_SQL10 = "SELECT id, value, value2 FROM float_bean WHERE value=?";
  ...
  public FloatBean selectOne() {
    ...
    try (Cursor _cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      if (_cursor.moveToFirst()) {
        ...
        if (!_cursor.isNull(index1)) { resultBean.value=FloatBeanTable.parseValue(_cursor.getBlob(index1)); }
        if (!_cursor.isNull(index2)) { resultBean.value2=FloatBeanTable.parseValue2(_cursor.getBlob(index2)); }
  ...
  public long updateOne(List<Float> value, long id, List<Float> paramValue) {
    if (updateOnePreparedStatement0==null) {
      ...
      String _sql="UPDATE float_bean SET value=? WHERE id=? and value=?";
  ...
  public long insert(long id, List<Float> value) {
    ...
    if (insertPreparedStatement1==null) {
      // generate static SQL for statement
      String _sql="INSERT INTO float_bean (id, value) VALUES (?, ?)";
  ...
  public long insert(FloatBean bean) {
    ...
    _contentValues.put("value2", FloatBeanTable.serializeValue2(bean.value2));
  ...
  public long delete(List<Float> paramValue) {
    if (deletePreparedStatement3==null) {
      // generate static SQL for statement
      String _sql="DELETE FROM float_bean WHERE value=?";
