...
public class IntegerDaoImpl extends Dao implements IntegerDao {
   ...
   */
  private static final String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM integer_bean";
   ...
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL6 = "SELECT id, value, value2 FROM integer_bean WHERE value=?";

  /**
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL8 = "SELECT id, value, value2 FROM integer_bean WHERE value=?";

  /**
   * SQL definition for method selectList
   */
  private static final String SELECT_LIST_SQL10 = "SELECT id, value, value2 FROM integer_bean WHERE value=?";
  ...
  public IntegerDaoImpl(BindIntegerDaoFactory daoFactory) {
