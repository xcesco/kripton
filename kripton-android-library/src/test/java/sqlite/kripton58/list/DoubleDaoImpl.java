...
public class DoubleDaoImpl extends Dao implements DoubleDao {
  ...
  private static final String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM double_bean WHERE value=?";

  /** The Constant SELECT_ONE_SQL3. */
  private static final String SELECT_ONE_SQL3 = "SELECT id, value, value2 FROM double_bean WHERE value=?";

  /** The Constant SELECT_ONE_SQL4. */
  private static final String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM double_bean WHERE value=?";

  /** The Constant SELECT_LIST_SQL5. */
  private static final String SELECT_LIST_SQL5 = "SELECT id, value, value2 FROM double_bean WHERE value=?";
  ...
  /**
   * Instantiates a new double dao impl.
   *
   * @param context the context
   */
  public DoubleDaoImpl(SQLContext context) {
    super(context);
  }
  ...
  public DoubleBean selectOne() {
    ...
    try (Cursor _cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      if (_cursor.moveToFirst()) {
        ...
        if (!_cursor.isNull(index1)) { resultBean.value=DoubleBeanTable.parseValue(_cursor.getBlob(index1)); }
        if (!_cursor.isNull(index2)) { resultBean.value2=DoubleBeanTable.parseValue2(_cursor.getBlob(index2)); }
   ...
   *
   * @param value 	is binded to <code>${value}</code>
   * @param listener 	is the DoubleBean listener
   */
  @Override
  ...
  public long updateOne(List<Double> value, Double id, List<Double> paramValue) {
    if (updateOnePreparedStatement0==null) {
      ...
      String _sql="UPDATE double_bean SET value=? WHERE id=? and value=?";
    ...
    if (_context.isLogEnabled()) {
      ...
      // display log
      Logger.info("UPDATE double_bean SET value=:value WHERE id=? and value=?");
  ...
  public long insert(long id, List<Double> value) {
    if (insertPreparedStatement1==null) {
      // generate static SQL for statement
      String _sql="INSERT INTO double_bean (id, value) VALUES (?, ?)";
  ...
  public long insert(DoubleBean bean) {
    ...
    _contentValues.put("value", DoubleBeanTable.serializeValue(bean.value));
    _contentValues.put("value2", DoubleBeanTable.serializeValue2(bean.value2));
  ...
  public long delete(List<Double> paramValue) {
    if (deletePreparedStatement3==null) {
      // generate static SQL for statement
      String _sql="DELETE FROM double_bean WHERE value=?";
    ...
    if (_context.isLogEnabled()) {
      ...
      // display log
      Logger.info("DELETE FROM double_bean WHERE value=?");
