...
public class BindIntegerDataSource extends AbstractDataSource implements BindIntegerDaoFactory, IntegerDataSource {
  ...
  static volatile BindIntegerDataSource instance;
  ...
  /**
   * Instantiates a new bind integer data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton58.list.BindIntegerDaoFactory#getIntegerDao()
   */
  @Override
   ...
   *
   * @return the bind integer data source
   */
  ...
  public void clearCompiledStatements() {
    IntegerDaoImpl.clearCompiledStatements();
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindIntegerDaoFactory> {
     ...
     */
    TransactionResult onExecute(BindIntegerDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @return the t
     */
    T onExecute(BindIntegerDaoFactory daoFactory);
  }
  ...
  class DataSourceSingleThread implements BindIntegerDaoFactory {
    ...
    public IntegerDaoImpl getIntegerDao() {
      if (_integerDao==null) {
        _integerDao=new IntegerDaoImpl(_context);
      }
      return _integerDao;
    }
