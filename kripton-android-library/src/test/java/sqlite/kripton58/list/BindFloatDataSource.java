...
/**
 * <p>
 * Implementation of the FloatDataSource datasource.
...
public class BindFloatDataSource extends AbstractDataSource implements BindFloatDaoFactory, FloatDataSource {
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindFloatDaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindFloatDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindFloatDaoFactory daoFactory);
  }
