...
/**
 * This class is binder map for ByteBean
 *
 * @see ByteBean
 */
...
public class ByteBeanBindMap extends AbstractMapper<ByteBean> {
  @Override
  public int serializeOnJackson(ByteBean object, JsonGenerator jacksonSerializer) throws Exception {
   ...
   */
  @Override
  public void serializeOnXml(ByteBean object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public ByteBean parseOnJacksonAsString(JsonParser jacksonParser) throws Exception {
    ByteBean instance = new ByteBean();
    String fieldName;
   ...
   */
  @Override
  public ByteBean parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    ByteBean instance = new ByteBean();
            ...
            switch(currentTag) {
                ...
                case "value":
                  // property value (mapped on "value")
                   {
                    ArrayList<Byte> collection=CollectionUtils.merge(new ArrayList<>(), instance.value);
                    Byte item;
                    // add first element
                    item=null;
                ...
                case "value2":
                  // property value2 (mapped on "value2")
                   {
                    LinkedList<Byte> collection=CollectionUtils.merge(new LinkedList<>(), instance.value2);
                    Byte item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
