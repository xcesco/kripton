...
public class ByteDaoImpl extends Dao implements ByteDao {
   ...
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL6 = "SELECT id, value, value2 FROM byte_bean WHERE value=?";

  /**
   * SQL definition for method selectOne
   */
  private static final String SELECT_ONE_SQL8 = "SELECT id, value, value2 FROM byte_bean WHERE value=?";

  /**
   * SQL definition for method selectList
   */
  private static final String SELECT_LIST_SQL10 = "SELECT id, value, value2 FROM byte_bean WHERE value=?";
  ...
  public ByteBean selectOne() {
    ...
    try (Cursor _cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      if (_cursor.moveToFirst()) {
        ...
        if (!_cursor.isNull(index1)) { resultBean.value=ByteBeanTable.parseValue(_cursor.getBlob(index1)); }
        if (!_cursor.isNull(index2)) { resultBean.value2=ByteBeanTable.parseValue2(_cursor.getBlob(index2)); }
  ...
  public long updateOne(List<Byte> value, long id, List<Byte> paramValue) {
    if (updateOnePreparedStatement0==null) {
      ...
      String _sql="UPDATE byte_bean SET value=? WHERE id=? and value=?";
  ...
  public long insert(long id, List<Byte> value) {
    ...
    if (insertPreparedStatement1==null) {
      // generate static SQL for statement
      String _sql="INSERT INTO byte_bean (id, value) VALUES (?, ?)";
  ...
  public long delete(List<Byte> paramValue) {
    if (deletePreparedStatement3==null) {
      // generate static SQL for statement
      String _sql="DELETE FROM byte_bean WHERE value=?";
