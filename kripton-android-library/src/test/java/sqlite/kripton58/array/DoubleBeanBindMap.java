...
public class DoubleBeanBindMap extends AbstractMapper<DoubleBean> {
   ...
   */
  @Override
  public void serializeOnXml(DoubleBean object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public DoubleBean parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    DoubleBean instance = new DoubleBean();
            ...
            switch(currentTag) {
                ...
                case "value":
                  // property value (mapped on "value")
                   {
                    ArrayList<Double> collection=CollectionUtils.merge(new ArrayList<>(), instance.value);
                    Double item;
                    // add first element
                    item=null;
                ...
                case "value2":
                  // property value2 (mapped on "value2")
                   {
                    ArrayList<Double> collection=CollectionUtils.merge(new ArrayList<>(), instance.value2);
                    Double item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
