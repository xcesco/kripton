...
/**
 * <p>
 * Implementation of the CharDataSource datasource.
...
public class BindCharDataSource extends AbstractDataSource implements BindCharDaoFactory, CharDataSource {
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindCharDaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindCharDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindCharDaoFactory daoFactory);
  }
