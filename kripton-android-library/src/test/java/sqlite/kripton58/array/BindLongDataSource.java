...
/**
 * <p>
 * Implementation of the LongDataSource datasource.
...
public class BindLongDataSource extends AbstractDataSource implements BindLongDaoFactory, LongDataSource {
   ...
   */
  static volatile BindLongDataSource instance;
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindLongDaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindLongDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindLongDaoFactory daoFactory);
  }
