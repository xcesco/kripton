  ...
  public StringBean selectOne() {
    ...
    try (Cursor _cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      if (_cursor.moveToFirst()) {
        ...
        if (!_cursor.isNull(index1)) { resultBean.value=StringBeanTable.parseValue(_cursor.getBlob(index1)); }
        if (!_cursor.isNull(index2)) { resultBean.value2=StringBeanTable.parseValue2(_cursor.getBlob(index2)); }
