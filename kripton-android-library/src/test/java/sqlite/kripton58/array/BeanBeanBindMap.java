...
public class BeanBeanBindMap extends AbstractMapper<BeanBean> {
   ...
   */
  @Override
  public void serializeOnXml(BeanBean object, XMLSerializer xmlSerializer, int currentEventType)
      throws Exception {
            ...
            switch(currentTag) {
                ...
                case "value2":
                  // property value2 (mapped on "value2")
                   {
                    ArrayList<BeanInner> collection=CollectionUtils.merge(new ArrayList<>(), instance.value2);
                    BeanInner item;
                    // add first element
                    item=null;
                    if (xmlParser.isEmptyElement()) {
