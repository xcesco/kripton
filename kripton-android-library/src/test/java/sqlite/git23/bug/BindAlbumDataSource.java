...
/**
 * <p>
 * Implementation of the AlbumDataSource datasource.
 * This class expose database interface through Dao attribute.
 * </p>
 *
 * @see AlbumDataSource
 * @see BindAlbumDaoFactory
 * @see AlbumDao
 * @see AlbumDaoImpl
 * @see Album
 */
public class BindAlbumDataSource extends AbstractDataSource implements BindAlbumDaoFactory, AlbumDataSource {
  /**
   * <p>datasource singleton</p>
   */
  static volatile BindAlbumDataSource instance;
   ...
   */
  public static final int ALBUM_DAO_UID = 0;
  ...
  protected BindAlbumDataSource(DataSourceOptions options) {
    super("album.db", 1, options);
  }
   ...
   */
  public static BindAlbumDataSource getInstance() {
   ...
   */
  public static BindAlbumDataSource open() {
    BindAlbumDataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
   ...
   * @return opened dataSource instance.
   */
  public static BindAlbumDataSource openReadOnly() {
    BindAlbumDataSource instance=getInstance();
    ...
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindAlbumDataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindAlbumDataSource is already builded");
    }
    Logger.info("Datasource BindAlbumDataSource is created");
    return result;
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindAlbumDaoFactory> {
    /**
  ...
  class DataSourceSingleThread implements BindAlbumDaoFactory {
    ...
    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindAlbumDataSource.this);
    }
