...
/**
 * This class is binder map for Pet
 *
 * @see Pet
 */
@BindMap(Pet.class)
public class PetBindMap extends AbstractMapper<Pet> {
  @Override
  public int serializeOnJackson(Pet object, JsonGenerator jacksonSerializer) throws Exception {
   ...
   */
  @Override
  public void serializeOnXml(Pet object, XMLSerializer xmlSerializer, EventType currentEventType)
      throws Exception {
   ...
   */
  @Override
  public Pet parseOnJackson(JsonParser jacksonParser) throws Exception {
   ...
   */
  @Override
  public Pet parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Pet instance = new Pet();
