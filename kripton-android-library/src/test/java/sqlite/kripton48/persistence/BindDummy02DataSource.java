...
public class BindDummy02DataSource extends AbstractDataSource implements BindDummy02DaoFactory, Dummy02DataSource {
  ...
  /** <p>dao instance</p>. */
  protected DaoBean02Impl daoBean02 = new DaoBean02Impl(context);

  /** Used only in transactions (that can be executed one for time. */
  protected DataSourceSingleThread _daoFactorySingleThread = new DataSourceSingleThread();

  /**
   * Instantiates a new bind dummy 02 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton48.persistence.BindDummy02DaoFactory#getDaoBean02()
   */
  @Override
   ...
   *
   * @return the bind dummy 02 data source
   */
  ...
  class DataSourceSingleThread implements BindDummy02DaoFactory {
     ...
     *
     * @return the dao bean 02
     */
    public DaoBean02Impl getDaoBean02() {
      if (_daoBean02==null) {
        _daoBean02=new DaoBean02Impl(_context);
      }
      return _daoBean02;
    }
