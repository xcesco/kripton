...
public class BindBean64DataSource extends AbstractDataSource implements BindBean64DaoFactory, Bean64DataSource {
  ...
  /**
   * Instantiates a new bind bean 64 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton64.BindBean64DaoFactory#getBean64Dao()
   */
  @Override
   ...
   *
   * @return the bind bean 64 data source
   */
