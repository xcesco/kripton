...
/**
 * <p>
 * Implementation of the Bean64DataSource datasource.
...
public class BindBean64DataSource extends AbstractDataSource implements BindBean64DaoFactory, Bean64DataSource {
   ...
   */
  static volatile BindBean64DataSource instance;
  ...
  /**
   * Unique identifier for Dao Bean64Dao
   */
  public static final int BEAN64_DAO_UID = 0;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new Bean64Table()};
  ...
  public static BindBean64DataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindBean64DataSource is forced to be (re)builded");
      instance.forceClose();
      instance=null;
    }
    BindBean64DataSource result=instance;
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindBean64DataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindBean64DataSource is already builded");
    }
    Logger.info("Datasource BindBean64DataSource is created");
    return result;
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindBean64DaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindBean64DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindBean64DaoFactory daoFactory);
  }

  class DataSourceSingleThread implements BindBean64DaoFactory {
    private SQLContextInSessionImpl _context;

    protected Bean64DaoImpl _bean64Dao;

    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindBean64DataSource.this);
    }
    ...
    public Bean64DaoImpl getBean64Dao() {
      if (_bean64Dao==null) {
        _bean64Dao=new Bean64DaoImpl(this);
      }
      return _bean64Dao;
    }
