...
public class Bean64ADaoImpl extends Dao implements Bean64ADao {
   ...
   * <h2>Select SQL:</h2>
   *
   * <pre>SELECT id, value_map_string_bean, value_set_string, value_string FROM bean64_a</pre>
   *
   * <h2>Mapped class:</h2>
   * {@link Bean64A}
   *
        ...
        do
         {
          ...
          if (!_cursor.isNull(index1)) { resultBean.valueMapStringBean=Bean64ATable.parseValueMapStringBean(_cursor.getBlob(index1)); }
          if (!_cursor.isNull(index2)) { resultBean.valueSetString=Bean64ATable.parseValueSetString(_cursor.getBlob(index2)); }
   ...
   * <h2>Select SQL:</h2>
   *
   * <pre>SELECT id, value_map_string_bean, value_set_string, value_string FROM bean64_a WHERE id=${id}</pre>
   *
   * <h2>Mapped class:</h2>
   * {@link Bean64A}
   *
