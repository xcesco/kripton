...
public class Bean64BindMap extends AbstractMapper<Bean64> {
   ...
   */
  @Override
  public void serializeOnXml(Bean64 object, XMLSerializer xmlSerializer, EventType currentEventType)
      throws Exception {
    ...
    if (object.valueBean!=null)  {
      ...
      bean64BindMap.serializeOnXml(object.valueBean, xmlSerializer, EventType.START_TAG);
      xmlSerializer.writeEndElement();
    }
    ...
    if (object.valueBeanArray!=null)  {
      ...
      for (int i=0; i<n; i++) {
        ...
        if (item==null) {
          ...
          bean64BindMap.serializeOnXml(item, xmlSerializer, EventType.START_TAG);
          xmlSerializer.writeEndElement();
        }
      }
        ...
        xmlSerializer.writeStartElement("valueLinkedMapStringBean");
          ...
          if (item.getValue()==null) {
            ...
            if (item.getValue()!=null)  {
              ...
              bean64BindMap.serializeOnXml(item.getValue(), xmlSerializer, EventType.START_TAG);
              xmlSerializer.writeEndElement();
            }
          }
        xmlSerializer.writeEndElement();
   ...
   */
  @Override
  public Bean64 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean64 instance = new Bean64();
            ...
            switch(currentTag) {
                ...
                case "valueBeanArray":
                  // property valueBeanArray (mapped on "valueBeanArray")
                   {
                    ArrayList<Bean64> collection=CollectionUtils.merge(new ArrayList<>(), instance.valueBeanArray);
                    Bean64 item;
                    // add first element
                    item=null;
                ...
                case "valueCharArray":
                  // property valueCharArray (mapped on "valueCharArray")
                   {
                    ArrayList<Character> collection=CollectionUtils.merge(new ArrayList<>(), instance.valueCharArray);
                    Character item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                ...
                case "valueCharList":
                  // property valueCharList (mapped on "valueCharList")
                   {
                    LinkedList<Character> collection=CollectionUtils.merge(new LinkedList<>(), instance.valueCharList);
                    Character item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                ...
                case "valueCharTypeArray":
                  // property valueCharTypeArray (mapped on "valueCharTypeArray")
                   {
                    ArrayList<Character> collection=CollectionUtils.merge(new ArrayList<>(), instance.valueCharTypeArray);
                    Character item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                  ...
                  // property valueLinkedMapStringBean (mapped on "valueLinkedMapStringBean")
                   {
                    ...
                    xmlParser.nextTag();
                    collection.put(key, value);
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueLinkedMapStringBean")) {
                      xmlParser.nextTag();
                      key=StringEscapeUtils.unescapeXml(xmlParser.getElementText());
                      xmlParser.nextTag();
                      if (xmlParser.isEmptyElement()) {
                ...
                case "valueLongList":
                  // property valueLongList (mapped on "valueLongList")
                   {
                    LinkedList<Long> collection=CollectionUtils.merge(new LinkedList<>(), instance.valueLongList);
                    Long item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                ...
                case "valueLongTypeArray":
                  // property valueLongTypeArray (mapped on "valueLongTypeArray")
                   {
                    ArrayList<Long> collection=CollectionUtils.merge(new ArrayList<>(), instance.valueLongTypeArray);
                    Long item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                ...
                case "valueStrinList":
                  // property valueStrinList (mapped on "valueStrinList")
                   {
                    LinkedList<String> collection=CollectionUtils.merge(new LinkedList<>(), instance.valueStrinList);
                    String item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                ...
                case "valueTimeList":
                  // property valueTimeList (mapped on "valueTimeList")
                   {
                    ArrayList<Time> collection=CollectionUtils.merge(new ArrayList<>(), instance.valueTimeList);
                    Time item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
