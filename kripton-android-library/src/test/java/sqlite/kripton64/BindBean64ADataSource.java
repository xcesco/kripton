...
public class BindBean64ADataSource extends AbstractDataSource implements BindBean64ADaoFactory, Bean64ADataSource {
  ...
  static volatile BindBean64ADataSource instance;

  /** <p>Mutex to manage multithread access to instance</p>. */
  private static final Object mutex = new Object();

  /** Unique identifier for Dao Bean64ADao. */
  public static final int BEAN64_A_DAO_UID = 0;

  /** List of tables compose datasource. */
  static final SQLiteTable[] TABLES = {new Bean64ATable()};

  /** <p>dao instance</p>. */
  protected Bean64ADaoImpl bean64ADao = new Bean64ADaoImpl(context);

  /** Used only in transactions (that can be executed one for time. */
  protected DataSourceSingleThread _daoFactorySingleThread = new DataSourceSingleThread();

  /**
   * Instantiates a new bind bean 64 A data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton64.BindBean64ADaoFactory#getBean64ADao()
   */
  @Override
   ...
   *
   * @return the bind bean 64 A data source
   */
      ...
      synchronized(mutex) {
        ...
        if (result==null) {
          DataSourceOptions options=DataSourceOptions.builder()
          	...
          	.log(true)
          	.build();
          instance=result=new BindBean64ADataSource(options);
          try {
  ...
  public void clearCompiledStatements() {
    Bean64ADaoImpl.clearCompiledStatements();
  }
    ...
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindBean64ADataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindBean64ADataSource is already builded");
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindBean64ADaoFactory> {
     ...
     */
    TransactionResult onExecute(BindBean64ADaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @return the t
     */
    T onExecute(BindBean64ADaoFactory daoFactory);
  }

  /**
   * The Class DataSourceSingleThread.
   */
  class DataSourceSingleThread implements BindBean64ADaoFactory {
    
    /** The context. */
    private SQLContextInSessionImpl _context;

    /** The bean 64 A dao. */
    protected Bean64ADaoImpl _bean64ADao;

    /**
     * Instantiates a new data source single thread.
     */
    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindBean64ADataSource.this);
    }
    ...
    public Bean64ADaoImpl getBean64ADao() {
      if (_bean64ADao==null) {
        _bean64ADao=new Bean64ADaoImpl(_context);
      }
      return _bean64ADao;
    }
