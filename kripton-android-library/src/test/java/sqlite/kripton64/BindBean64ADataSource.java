...
/**
 * <p>
 * Implementation of the Bean64ADataSource datasource.
...
public class BindBean64ADataSource extends AbstractDataSource implements BindBean64ADaoFactory, Bean64ADataSource {
  ...
  public static BindBean64ADataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindBean64ADataSource is forced to be (re)builded");
      instance=null;
    }
    BindBean64ADataSource result=instance;
    if (result==null) {
    ...
    Logger.info("Datasource BindBean64ADataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindBean64ADaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindBean64ADaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindBean64ADaoFactory daoFactory);
  }
  ...
  class DataSourceSingleThread implements BindBean64ADaoFactory {
    ...
    public Bean64ADaoImpl getBean64ADao() {
      if (_bean64ADao==null) {
        _bean64ADao=new Bean64ADaoImpl(this);
      }
      return _bean64ADao;
    }
