...
public class BindBean64SharedPreferences extends AbstractSharedPreference {
   ...
   */
  private Subject<Bean64> valueBeanSubject = BehaviorSubject.create();
   ...
   */
  private Subject<Bean64[]> valueBeanArraySubject = BehaviorSubject.create();
   ...
   */
  private Subject<Map<String, Bean64>> valueMapStringBeanSubject = BehaviorSubject.create();

  /**
   * subject for field valueLinkedMapStringBean - shared pref value_linked_map_string_bean
   */
  private Subject<LinkedHashMap<String, Bean64>> valueLinkedMapStringBeanSubject = BehaviorSubject.create();
  ...
  private SharedPreferences.OnSharedPreferenceChangeListener prefsListener = new SharedPreferences.OnSharedPreferenceChangeListener() {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
      switch (key) {
        ...
        Bean64 _value=StringUtils.hasText(temp) ? parseValueBean(temp): defaultBean.valueBean;
        ...
        Bean64[] _value=StringUtils.hasText(temp) ? parseValueBeanArray(temp): defaultBean.valueBeanArray;
        ...
        Map<String, Bean64> _value=StringUtils.hasText(temp) ? parseValueMapStringBean(temp): defaultBean.valueMapStringBean;
        ...
        LinkedHashMap<String, Bean64> _value=StringUtils.hasText(temp) ? parseValueLinkedMapStringBean(temp): defaultBean.valueLinkedMapStringBean;
   ...
   */
  public BindBean64SharedPreferences refresh() {
    createPrefs();
    return this;
  }
   ...
   */
  public Subject<Bean64> getValueBeanAsObservable() {
   ...
   */
  public Subject<Bean64[]> getValueBeanArrayAsObservable() {
   ...
   */
  public Subject<Map<String, Bean64>> getValueMapStringBeanAsObservable() {
   ...
   */
  public Subject<LinkedHashMap<String, Bean64>> getValueLinkedMapStringBeanAsObservable() {
   ...
   */
  public Bean64[] getValueBeanArray() {
    String temp=prefs.getString("value_bean_array", null);
   ...
   */
  public Map<String, Bean64> getValueMapStringBean() {
    String temp=prefs.getString("value_map_string_bean", null);
   ...
   */
  public LinkedHashMap<String, Bean64> getValueLinkedMapStringBean() {
    String temp=prefs.getString("value_linked_map_string_bean", null);
  ...
  protected String serializeValueBean(Bean64 value) {
    ...
    try (KriptonByteArrayOutputStream stream=new KriptonByteArrayOutputStream(); JacksonWrapperSerializer wrapper=context.createSerializer(stream)) {
      ...
      if (value!=null)  {
        fieldCount++;
        bean64BindMap.serializeOnJackson(value, jacksonSerializer);
      }
      jacksonSerializer.flush();
      return stream.toString();
    } catch(Exception e) {
  ...
  protected Bean64 parseValueBean(String input) {
    ...
    try (JacksonWrapperParser wrapper=context.createParser(input)) {
      ...
      if (jacksonParser.currentToken()==JsonToken.START_OBJECT) {
        result=bean64BindMap.parseOnJackson(jacksonParser);
      }
      return result;
    } catch(Exception e) {
      throw(new KriptonRuntimeException(e.getMessage()));
