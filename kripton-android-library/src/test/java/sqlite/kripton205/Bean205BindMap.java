...
/**
 * This class is binder map for Bean205
 *
 * @see Bean205
 */
@BindMap(Bean205.class)
public class Bean205BindMap extends AbstractMapper<Bean205> {
  @Override
  public int serializeOnJackson(Bean205 object, JsonGenerator jacksonSerializer) throws Exception {
  ...
  @Override
  public int serializeOnJacksonAsString(Bean205 object, JsonGenerator jacksonSerializer) throws
      Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(Bean205 object, XMLSerializer xmlSerializer, int currentEventType)
      throws Exception {
    if (currentEventType == 0) {
      xmlSerializer.writeStartElement("bean205");
    }
   ...
   */
  @Override
  public Bean205 parseOnJacksonAsString(JsonParser jacksonParser) throws Exception {
    Bean205 instance = new Bean205();
    String fieldName;
   ...
   */
  @Override
  public Bean205 parseOnXml(XMLParser xmlParser, int currentEventType) throws Exception {
    Bean205 instance = new Bean205();
