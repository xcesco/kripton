...
public class Bean205BindMap extends AbstractMapper<Bean205> {
   ...
   */
  @Override
  public void serializeOnXml(Bean205 object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean205 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean205 instance = new Bean205();
