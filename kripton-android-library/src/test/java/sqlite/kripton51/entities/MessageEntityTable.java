...
public class MessageEntityTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT, channel_id INTEGER, channel_uid TEXT, face_uid TEXT, owner_type TEXT, owner_uid TEXT, text TEXT, type TEXT, uid TEXT, update_time INTEGER);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT, channel_id INTEGER, channel_uid TEXT, face_uid TEXT, owner_type TEXT, owner_uid TEXT, text TEXT, type TEXT, uid TEXT, update_time INTEGER);";
