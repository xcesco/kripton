...
public class MessageEntityTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, channel_id INTEGER, channel_uid TEXT, face_uid TEXT, owner_type TEXT, owner_uid TEXT, text TEXT, type TEXT, uid TEXT, update_time INTEGER);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, channel_id INTEGER, channel_uid TEXT, face_uid TEXT, owner_type TEXT, owner_uid TEXT, text TEXT, type TEXT, uid TEXT, update_time INTEGER);";
   ...
   * Columns array
   */
  private static final String[] COLUMNS = {COLUMN_ID, COLUMN_CHANNEL_ID, COLUMN_CHANNEL_UID, COLUMN_FACE_UID, COLUMN_OWNER_TYPE, COLUMN_OWNER_UID, COLUMN_TEXT, COLUMN_TYPE, COLUMN_UID, COLUMN_UPDATE_TIME};
