...
public class BindApp2DataSource extends AbstractDataSource implements BindApp2DaoFactory, App2DataSource {
  ...
  static volatile BindApp2DataSource instance;
  ...
  /**
   * Instantiates a new bind app 2 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton209.model2.BindApp2DaoFactory#getDeviceDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton209.model2.BindApp2DaoFactory#getUserDao()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton209.model2.BindApp2DaoFactory#getUserDeviceDao()
   */
  @Override
   ...
   *
   * @return the bind app 2 data source
   */
  public static BindApp2DataSource instance() {
