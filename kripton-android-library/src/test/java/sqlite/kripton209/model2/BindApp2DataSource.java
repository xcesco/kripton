...
/**
 * <p>
 * Implementation of the App2DataSource datasource.
...
public class BindApp2DataSource extends AbstractDataSource implements BindApp2DaoFactory, App2DataSource {
   ...
   */
  public static BindApp2DataSource getInstance() {
  ...
  public static BindApp2DataSource open() {
    BindApp2DataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindApp2DaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindApp2DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindApp2DaoFactory daoFactory);
  }
