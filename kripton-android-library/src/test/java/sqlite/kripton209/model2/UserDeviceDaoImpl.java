...
public class UserDeviceDaoImpl extends Dao implements GeneratedUserDeviceDao {
  private static final String SELECT_BY_ID_SQL5 = "SELECT id, device_id, user_id FROM user_2_device WHERE id=?";

  private static final String SELECT_BY_USER_ID_SQL6 = "SELECT id, device_id, user_id FROM user_2_device WHERE user_id=?";
