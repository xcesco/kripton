...
public class UserDeviceDaoImpl extends Dao implements GeneratedUserDeviceDao {
   ...
   */
  private static final String SELECT_BY_ID_SQL10 = "SELECT id, device_id, user_id FROM user_2_device WHERE id=?";

  /**
   * SQL definition for method selectByUserId
   */
  private static final String SELECT_BY_USER_ID_SQL12 = "SELECT id, device_id, user_id FROM user_2_device WHERE user_id=?";

  /**
   * SQL definition for method selectByDeviceId
   */
  private static final String SELECT_BY_DEVICE_ID_SQL14 = "SELECT id, device_id, user_id FROM user_2_device WHERE device_id=?";
