...
public class UserDeviceDaoImpl extends Dao implements GeneratedUserDeviceDao {
  ...
  private static final String SELECT_BY_DEVICE_ID_SQL7 = "SELECT id, user_id, device_id FROM user_2_device WHERE device_id=?";
   ...
   * <h2>Select SQL:</h2>
   *
   * <pre>SELECT id, user_id, device_id FROM user_2_device WHERE id=${id}</pre>
   *
   ...
   * <h2>Select SQL:</h2>
   *
   * <pre>SELECT id, user_id, device_id FROM user_2_device WHERE device_id=${deviceId}</pre>
   *
   * <h2>Projected columns:</h2>
   * <dl>
   * 	<dt>id</dt><dd>is associated to bean's property <strong>id</strong></dd>
  ...
  public int deleteById(long id) {
    ...
    if (_context.isLogEnabled()) {
      ...
      // display log
      Logger.info("DELETE FROM user_2_device WHERE id=?");
  ...
  public int deleteByUserId(long userId) {
    ...
    if (_context.isLogEnabled()) {
      ...
      // display log
      Logger.info("DELETE FROM user_2_device WHERE user_id=?");
  ...
  public int deleteByDeviceId(long deviceId) {
    ...
    if (_context.isLogEnabled()) {
      ...
      // display log
      Logger.info("DELETE FROM user_2_device WHERE device_id=?");
  ...
  /**
   * <p>SQL insert:</p>
   * <pre>INSERT INTO user_2_device (user_id, device_id) VALUES (${bean.userId}, ${bean.deviceId})</pre>
   *
  ...
  public int insert(UserDevice bean) {
    if (insertPreparedStatement3==null) {
      // generate static SQL for statement
      String _sql="INSERT INTO user_2_device (user_id, device_id) VALUES (?, ?)";
    ...
    if (_context.isLogEnabled()) {
      ...
      Logger.info("INSERT INTO user_2_device (%s) VALUES (%s)", _columnNameBuffer.toString(), _columnValueBuffer.toString());
