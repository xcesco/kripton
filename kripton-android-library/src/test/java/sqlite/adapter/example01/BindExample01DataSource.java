...
/**
 * <p>
 * Implementation of the Example01DataSource datasource.
...
public class BindExample01DataSource extends AbstractDataSource implements BindExample01DaoFactory, Example01DataSource {
   ...
   */
  static volatile BindExample01DataSource instance;
  ...
  protected BindExample01DataSource(DataSourceOptions options) {
   ...
   */
  public static BindExample01DataSource getInstance() {
  ...
  public static BindExample01DataSource open() {
    BindExample01DataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindExample01DaoFactory> {
    /**
  ...
  class DataSourceSingleThread implements BindExample01DaoFactory {
    ...
    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindExample01DataSource.this);
    }
