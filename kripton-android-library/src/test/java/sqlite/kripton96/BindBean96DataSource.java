...
public class BindBean96DataSource extends AbstractDataSource implements BindBean96DaoFactory, Bean96DataSource {
  ...
  /**
   * Instantiates a new bind bean 96 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton96.BindBean96DaoFactory#getBean96Dao()
   */
  @Override
   ...
   *
   * @return the bind bean 96 data source
   */
