...
public class PersonTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE person (id INTEGER PRIMARY KEY AUTOINCREMENT, birth_city TEXT, birth_day TEXT, name TEXT, surname TEXT, type_name TEXT); CREATE INDEX idx_person_name ON person(name);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE person (id INTEGER PRIMARY KEY AUTOINCREMENT, birth_city TEXT, birth_day TEXT, name TEXT, surname TEXT, type_name TEXT); CREATE INDEX idx_person_name ON person(name);";
