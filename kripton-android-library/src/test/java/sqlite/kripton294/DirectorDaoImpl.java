...
public class DirectorDaoImpl extends Dao implements DirectorDao {
   ...
   */
  private static final String FIND_DIRECTOR_BY_ID_SQL1 = "SELECT mid, full_name FROM director WHERE mid = ? LIMIT 1";

  /**
   * SQL definition for method findDirectorByName
   */
  private static final String FIND_DIRECTOR_BY_NAME_SQL2 = "SELECT mid, full_name FROM director WHERE full_name = ? LIMIT 1";
   ...
   */
  private static final String GET_ALL_DIRECTORS_SQL3 = "SELECT mid, full_name FROM director ORDER BY full_name ASC";
   ...
   * <h2>Select SQL:</h2>
   *
   * <pre>SELECT mid, full_name FROM director WHERE mid = :id LIMIT 1</pre>
   *
   * <h2>Mapped class:</h2>
   * {@link Director}
   *
   ...
   * <h2>Select SQL:</h2>
   *
   * <pre>SELECT mid, full_name FROM director WHERE full_name = :fullName LIMIT 1</pre>
   *
   * <h2>Mapped class:</h2>
   * {@link Director}
   *
   ...
   * <pre>INSERT OR IGNORE INTO director (full_name) VALUES (:fullName)</pre>
   *
   * <p><code>directors.id</code> is automatically updated because it is the primary key</p>
   *
   ...
   * <h2>Select SQL:</h2>
   *
   * <pre>SELECT mid, full_name FROM director ORDER BY full_name ASC</pre>
   *
   * <h2>Mapped class:</h2>
   * {@link Director}
   *
