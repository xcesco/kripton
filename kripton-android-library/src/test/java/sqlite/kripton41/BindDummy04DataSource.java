...
public class BindDummy04DataSource extends AbstractDataSource implements BindDummy04DaoFactory, Dummy04DataSource {
   ...
   */
  static volatile BindDummy04DataSource instance;
  ...
  /**
   * Unique identifier for Dao DaoBeanInsertOK
   */
  public static final int DAO_BEAN_INSERT_O_K_UID = 0;
   ...
   */
  public static BindDummy04DataSource getInstance() {
    BindDummy04DataSource result=instance;
    if (result==null) {
      synchronized(mutex) {
        result=instance;
        if (result==null) {
          DataSourceOptions options=DataSourceOptions.builder()
          	...
          	.log(true)
          	.build();
          instance=result=new BindDummy04DataSource(options);
          try {
  ...
  public static BindDummy04DataSource open() {
    BindDummy04DataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  public void clearCompiledStatements() {
    DaoBeanInsertOKImpl.clearCompiledStatements();
  }
  ...
  public static BindDummy04DataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindDummy04DataSource is forced to be (re)builded");
      instance=null;
    }
    BindDummy04DataSource result=instance;
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindDummy04DataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindDummy04DataSource is already builded");
    }
    Logger.info("Datasource BindDummy04DataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindDummy04DaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindDummy04DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindDummy04DaoFactory daoFactory);
  }

  class DataSourceSingleThread implements BindDummy04DaoFactory {
    private SQLContextInSessionImpl _context;

    protected DaoBeanInsertOKImpl _daoBeanInsertOK;

    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindDummy04DataSource.this);
    }
     ...
     */
    public DaoBeanInsertOKImpl getDaoBeanInsertOK() {
      if (_daoBeanInsertOK==null) {
        _daoBeanInsertOK=new DaoBeanInsertOKImpl(this);
      }
