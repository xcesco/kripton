...
public class BindDummy04DataSource extends AbstractDataSource implements BindDummy04DaoFactory, Dummy04DataSource {
  ...
  /**
   * Instantiates a new bind dummy 04 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton41.BindDummy04DaoFactory#getDaoBeanInsertOK()
   */
  @Override
   ...
   *
   * @return the bind dummy 04 data source
   */
