...
/**
 * <p>
 * Implementation of the Dummy06DataSource datasource.
...
public class BindDummy06DataSource extends AbstractDataSource implements BindDummy06DaoFactory, Dummy06DataSource {
   ...
   */
  static volatile BindDummy06DataSource instance;
  ...
  /**
   * Unique identifier for Dao DaoBeanUpdateOK
   */
  public static final int DAO_BEAN_UPDATE_O_K_UID = 0;
   ...
   */
  public static BindDummy06DataSource getInstance() {
      ...
      synchronized(mutex) {
        ...
        if (result==null) {
          DataSourceOptions options=DataSourceOptions.builder()
          	...
          	.neverClose(false)
          	.build();
          instance=result=new BindDummy06DataSource(options);
          try {
  ...
  public static BindDummy06DataSource open() {
    BindDummy06DataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
    ...
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindDummy06DataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindDummy06DataSource is already builded");
    }
    Logger.info("Datasource BindDummy06DataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindDummy06DaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindDummy06DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindDummy06DaoFactory daoFactory);
  }

  class DataSourceSingleThread implements BindDummy06DaoFactory {
    private SQLContextInSessionImpl _context;

    protected DaoBeanUpdateOKImpl _daoBeanUpdateOK;

    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindDummy06DataSource.this);
    }
    ...
    public DaoBeanUpdateOKImpl getDaoBeanUpdateOK() {
      if (_daoBeanUpdateOK==null) {
        _daoBeanUpdateOK=new DaoBeanUpdateOKImpl(this);
      }
