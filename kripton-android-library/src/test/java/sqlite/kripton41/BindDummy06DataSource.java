...
public class BindDummy06DataSource extends AbstractDataSource implements BindDummy06DaoFactory, Dummy06DataSource {
  ...
  /** <p>dao instance</p>. */
  protected DaoBeanUpdateOKImpl daoBeanUpdateOK = new DaoBeanUpdateOKImpl(context);

  /** Used only in transactions (that can be executed one for time. */
  protected DataSourceSingleThread _daoFactorySingleThread = new DataSourceSingleThread();

  /**
   * Instantiates a new bind dummy 06 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton41.BindDummy06DaoFactory#getDaoBeanUpdateOK()
   */
  @Override
   ...
   *
   * @return the bind dummy 06 data source
   */
