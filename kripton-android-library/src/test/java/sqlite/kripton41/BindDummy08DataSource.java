...
/**
 * <p>
 * Implementation of the Dummy08DataSource datasource.
...
public class BindDummy08DataSource extends AbstractDataSource implements BindDummy08DaoFactory, Dummy08DataSource {
   ...
   */
  public static BindDummy08DataSource getInstance() {
  ...
  public static BindDummy08DataSource open() {
    BindDummy08DataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  public static BindDummy08DataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindDummy08DataSource is forced to be (re)builded");
      instance=null;
    }
    BindDummy08DataSource result=instance;
    if (result==null) {
    ...
    Logger.info("Datasource BindDummy08DataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindDummy08DaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindDummy08DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindDummy08DaoFactory daoFactory);
  }
  ...
  class DataSourceSingleThread implements BindDummy08DaoFactory {
    ...
    public DaoBeanDeleteOKImpl getDaoBeanDeleteOK() {
      if (_daoBeanDeleteOK==null) {
        _daoBeanDeleteOK=new DaoBeanDeleteOKImpl(this);
      }
