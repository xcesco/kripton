...
public class BindDummy08DataSource extends AbstractDataSource implements BindDummy08DaoFactory, Dummy08DataSource {
  ...
  /**
   * Instantiates a new bind dummy 08 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton41.BindDummy08DaoFactory#getDaoBeanDeleteOK()
   */
  @Override
   ...
   *
   * @return the bind dummy 08 data source
   */
