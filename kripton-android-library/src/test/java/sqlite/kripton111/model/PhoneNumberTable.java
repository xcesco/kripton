...
public class PhoneNumberTable implements SQLiteTable {
  ...
  /** <p> DDL to create table phone_number </p>  <pre>CREATE TABLE phone_number (id INTEGER PRIMARY KEY AUTOINCREMENT, action_type TEXT, number TEXT, country_code TEXT, contact_name TEXT, contact_id TEXT); CREATE INDEX idx_phone_number_0 on phone_number (action_type);</pre>. */
  ...
  /** <p> DDL to drop table phone_number </p>  <pre> DROP INDEX IF EXISTS idx_phone_number_1;DROP TABLE IF EXISTS phone_number;</pre>. */
