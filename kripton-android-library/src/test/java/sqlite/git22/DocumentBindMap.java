...
public class DocumentBindMap extends AbstractMapper<Document> {
   ...
   */
  @Override
  public void serializeOnXml(Document object, XMLSerializer xmlSerializer, int currentEventType)
      throws Exception {
   ...
   */
  @Override
  public Document parseOnXml(XMLParser xmlParser, int currentEventType) throws Exception {
    Document instance = new Document();
