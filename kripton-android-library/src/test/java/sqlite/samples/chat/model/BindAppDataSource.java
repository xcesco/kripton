...
public class BindAppDataSource extends AbstractDataSource implements BindAppDaoFactory, AppDataSource {
  ...
  /**
   * Unique identifier for Dao DaoUser
   */
  public static final int DAO_USER_UID = 0;

  /**
   * Unique identifier for Dao DaoMessage
   */
  public static final int DAO_MESSAGE_UID = 1;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new MessageTable(), new UserTable()};

  /**
   * <p>dao instance</p>
   */
  protected DaoUserImpl daoUser = new DaoUserImpl(context);
  ...
  public void onCreate(SQLiteDatabase database) {
    ...
    // log section BEGIN
    if (this.logEnabled) {
      Logger.info("DDL: %s",MessageTable.CREATE_TABLE_SQL);
    }
    // log section END
    database.execSQL(MessageTable.CREATE_TABLE_SQL);
  ...
  public void clearCompiledStatements() {
    DaoUserImpl.clearCompiledStatements();
  ...
  class DataSourceSingleThread implements BindAppDaoFactory {
    ...
    protected DaoUserImpl _daoUser;
    ...
    public DaoUserImpl getDaoUser() {
      if (_daoUser==null) {
        _daoUser=new DaoUserImpl(_context);
      }
      return _daoUser;
    }
