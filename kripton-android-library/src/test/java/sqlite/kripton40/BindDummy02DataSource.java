...
/**
 * <p>
 * Implementation of the Dummy02DataSource datasource.
...
public class BindDummy02DataSource extends AbstractDataSource implements BindDummy02DaoFactory, Dummy02DataSource {
   ...
   */
  static volatile BindDummy02DataSource instance;
  ...
  /**
   * Unique identifier for Dao DaoBean02
   */
  public static final int DAO_BEAN02_UID = 0;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new Bean02Table()};
   ...
   */
  public static BindDummy02DataSource getInstance() {
  ...
  public static BindDummy02DataSource open() {
    BindDummy02DataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  public void clearCompiledStatements() {
    DaoBean02Impl.clearCompiledStatements();
  }
  ...
  public static BindDummy02DataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindDummy02DataSource is forced to be (re)builded");
      instance=null;
    }
    BindDummy02DataSource result=instance;
    if (result==null) {
    ...
    Logger.info("Datasource BindDummy02DataSource is created");
    return result;
  }
  ...
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindDummy02DaoFactory> {
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindDummy02DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindDummy02DaoFactory daoFactory);
  }

  class DataSourceSingleThread implements BindDummy02DaoFactory {
    private SQLContextInSessionImpl _context;

    protected DaoBean02Impl _daoBean02;
    ...
    public DaoBean02Impl getDaoBean02() {
      if (_daoBean02==null) {
        _daoBean02=new DaoBean02Impl(this);
      }
      return _daoBean02;
    }
