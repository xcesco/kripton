...
public class BeanBindMap extends AbstractMapper<Bean> {
  ...
  public void serializeOnXml(Bean object, XMLSerializer xmlSerializer, EventType currentEventType)
    ...
    if (object.valueBean!=null)  {
      ...
      beanBindMap.serializeOnXml(object.valueBean, xmlSerializer, EventType.START_TAG);
      xmlSerializer.writeEndElement();
    }
    ...
    if (object.valueBeanArray!=null)  {
      ...
      for (int i=0; i<n; i++) {
        ...
        if (item==null) {
          ...
          beanBindMap.serializeOnXml(item, xmlSerializer, EventType.START_TAG);
          xmlSerializer.writeEndElement();
        }
      }
        ...
        xmlSerializer.writeStartElement("valueLinkedMapStringBean");
          ...
          if (item.getValue()==null) {
            ...
            if (item.getValue()!=null)  {
              ...
              beanBindMap.serializeOnXml(item.getValue(), xmlSerializer, EventType.START_TAG);
              xmlSerializer.writeEndElement();
            }
          }
        xmlSerializer.writeEndElement();
            ...
            switch(currentTag) {
                ...
                case "valueBeanArray":
                  // property valueBeanArray (mapped on "valueBeanArray")
                   {
                    ArrayList<Bean> collection=CollectionUtils.merge(new ArrayList<>(), instance.valueBeanArray);
                    Bean item;
                    // add first element
                    item=null;
