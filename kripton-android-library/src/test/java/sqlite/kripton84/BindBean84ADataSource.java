...
/**
 * <p>
 * Implementation of the Bean84ADataSource datasource.
...
public class BindBean84ADataSource extends AbstractDataSource implements BindBean84ADaoFactory, Bean84ADataSource {
   ...
   */
  static volatile BindBean84ADataSource instance;
  ...
  /**
   * Unique identifier for Dao Bean84ADao
   */
  public static final int BEAN84_A_DAO_UID = 0;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new Bean84ATable()};
  ...
  protected BindBean84ADataSource(DataSourceOptions options) {
   ...
   */
  public static BindBean84ADataSource getInstance() {
    BindBean84ADataSource result=instance;
    if (result==null) {
      synchronized(mutex) {
        result=instance;
        if (result==null) {
          DataSourceOptions options=DataSourceOptions.builder()
          	...
          	.log(true)
          	.build();
          instance=result=new BindBean84ADataSource(options);
          try {
  ...
  public static BindBean84ADataSource open() {
    BindBean84ADataSource instance=getInstance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  public void clearCompiledStatements() {
    Bean84ADaoImpl.clearCompiledStatements();
  }
  ...
  public static BindBean84ADataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindBean84ADataSource is forced to be (re)builded");
      instance=null;
    }
    BindBean84ADataSource result=instance;
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindBean84ADataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindBean84ADataSource is already builded");
    }
    Logger.info("Datasource BindBean84ADataSource is created");
    return result;
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindBean84ADaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindBean84ADaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindBean84ADaoFactory daoFactory);
  }

  class DataSourceSingleThread implements BindBean84ADaoFactory {
    private SQLContextInSessionImpl _context;

    protected Bean84ADaoImpl _bean84ADao;

    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindBean84ADataSource.this);
    }
    ...
    public Bean84ADaoImpl getBean84ADao() {
      if (_bean84ADao==null) {
        _bean84ADao=new Bean84ADaoImpl(this);
      }
      return _bean84ADao;
    }
