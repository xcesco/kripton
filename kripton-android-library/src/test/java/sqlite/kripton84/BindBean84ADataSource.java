...
public class BindBean84ADataSource extends AbstractDataSource implements BindBean84ADaoFactory, Bean84ADataSource {
  ...
  /** <p>dao instance</p>. */
  protected Bean84ADaoImpl bean84ADao = new Bean84ADaoImpl(context);

  /** Used only in transactions (that can be executed one for time. */
  protected DataSourceSingleThread _daoFactorySingleThread = new DataSourceSingleThread();

  /**
   * Instantiates a new bind bean 84 A data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton84.BindBean84ADaoFactory#getBean84ADao()
   */
  @Override
   ...
   *
   * @return the bind bean 84 A data source
   */
  ...
  public static BindBean84ADataSource open() {
    BindBean84ADataSource instance=instance();
    instance.openWritableDatabase();
    return instance;
  }
  ...
  class DataSourceSingleThread implements BindBean84ADaoFactory {
    ...
    public Bean84ADaoImpl getBean84ADao() {
      if (_bean84ADao==null) {
        _bean84ADao=new Bean84ADaoImpl(_context);
      }
      return _bean84ADao;
    }
