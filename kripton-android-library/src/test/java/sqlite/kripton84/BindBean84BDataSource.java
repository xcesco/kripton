...
public class BindBean84BDataSource extends AbstractDataSource implements BindBean84BDaoFactory, Bean84BDataSource {
  ...
  /**
   * Instantiates a new bind bean 84 B data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton84.BindBean84BDaoFactory#getBean84BDao()
   */
  @Override
   ...
   *
   * @return the bind bean 84 B data source
   */
