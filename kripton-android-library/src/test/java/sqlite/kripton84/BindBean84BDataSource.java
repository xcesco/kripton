...
/**
 * <p>
 * Implementation of the Bean84BDataSource datasource.
...
public class BindBean84BDataSource extends AbstractDataSource implements BindBean84BDaoFactory, Bean84BDataSource {
   ...
   */
  static volatile BindBean84BDataSource instance;
  ...
  /**
   * Unique identifier for Dao Bean84BDao
   */
  public static final int BEAN84_B_DAO_UID = 0;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new Bean84BTable()};
      ...
      synchronized(mutex) {
        ...
        if (result==null) {
          DataSourceOptions options=DataSourceOptions.builder()
          	...
          	.neverClose(false)
          	.build();
          instance=result=new BindBean84BDataSource(options);
          try {
  ...
  public void clearCompiledStatements() {
    Bean84BDaoImpl.clearCompiledStatements();
  }

  /**
   * <p>Build instance. This method can be used only one time, on the application start.</p>
   */
  public static BindBean84BDataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindBean84BDataSource is forced to be (re)builded");
      instance.forceClose();
      instance=null;
    }
    BindBean84BDataSource result=instance;
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindBean84BDataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindBean84BDataSource is already builded");
    }
    Logger.info("Datasource BindBean84BDataSource is created");
    return result;
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindBean84BDaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindBean84BDaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindBean84BDaoFactory daoFactory);
  }

  class DataSourceSingleThread implements BindBean84BDaoFactory {
    private SQLContextInSessionImpl _context;

    protected Bean84BDaoImpl _bean84BDao;

    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindBean84BDataSource.this);
    }
    ...
    public Bean84BDaoImpl getBean84BDao() {
      if (_bean84BDao==null) {
        _bean84BDao=new Bean84BDaoImpl(this);
      }
      return _bean84BDao;
    }
