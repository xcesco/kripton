...
public class Bean93BindMap extends AbstractMapper<Bean93> {
   ...
   */
  @Override
  public void serializeOnXml(Bean93 object, XMLSerializer xmlSerializer, EventType currentEventType)
      throws Exception {
   ...
   */
  @Override
  public Bean93 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean93 instance = new Bean93();
