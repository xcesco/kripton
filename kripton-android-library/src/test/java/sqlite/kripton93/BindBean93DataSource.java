...
public class BindBean93DataSource extends AbstractDataSource implements BindBean93DaoFactory, Bean93DataSource {
  ...
  /** <p>dao instance</p>. */
  protected Bean93DaoImpl bean93Dao = new Bean93DaoImpl(context);

  /** Used only in transactions (that can be executed one for time. */
  protected DataSourceSingleThread _daoFactorySingleThread = new DataSourceSingleThread();

  /**
   * Instantiates a new bind bean 93 data source.
   *
  ...
  /* (non-Javadoc)
   * @see sqlite.kripton93.BindBean93DaoFactory#getBean93Dao()
   */
  @Override
   ...
   *
   * @return the bind bean 93 data source
   */
