...
/**
 * <p>
 * Implementation of the Bean93DataSource datasource.
...
public class BindBean93DataSource extends AbstractDataSource implements BindBean93DaoFactory, Bean93DataSource {
   ...
   */
  static volatile BindBean93DataSource instance;
  ...
  /**
   * Unique identifier for Dao Bean93Dao
   */
  public static final int BEAN93_DAO_UID = 0;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new Bean93Table()};
      ...
      synchronized(mutex) {
        ...
        if (result==null) {
          DataSourceOptions options=DataSourceOptions.builder()
          	...
          	.log(true)
          	.build();
          instance=result=new BindBean93DataSource(options);
          try {
  ...
  public void clearCompiledStatements() {
    Bean93DaoImpl.clearCompiledStatements();
  }
  ...
  public static BindBean93DataSource build(DataSourceOptions options) {
    if (options.forceBuild && instance!=null) {
      Logger.info("Datasource BindBean93DataSource is forced to be (re)builded");
      instance=null;
    }
    BindBean93DataSource result=instance;
    if (result==null) {
      synchronized(mutex) {
        ...
        if (result==null) {
          ...
          throw new KriptonRuntimeException("Datasource BindBean93DataSource is already builded");
        }
      }
    } else {
      throw new KriptonRuntimeException("Datasource BindBean93DataSource is already builded");
    }
    Logger.info("Datasource BindBean93DataSource is created");
    return result;
  }
   ...
   */
  public interface Transaction extends AbstractDataSource.AbstractExecutable<BindBean93DaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    TransactionResult onExecute(@NonNull BindBean93DaoFactory daoFactory);
  }
  ...
  public interface Batch<T> {
     ...
     * @throws Throwable
     */
    T onExecute(@NonNull BindBean93DaoFactory daoFactory);
  }

  class DataSourceSingleThread implements BindBean93DaoFactory {
    private SQLContextInSessionImpl _context;

    protected Bean93DaoImpl _bean93Dao;

    DataSourceSingleThread() {
      _context=new SQLContextInSessionImpl(BindBean93DataSource.this);
    }
    ...
    public Bean93DaoImpl getBean93Dao() {
      if (_bean93Dao==null) {
        _bean93Dao=new Bean93DaoImpl(this);
      }
      return _bean93Dao;
    }
