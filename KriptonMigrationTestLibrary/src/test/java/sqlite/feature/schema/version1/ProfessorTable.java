...
public class ProfessorTable {
   ...
   * </p>
   *
   * <pre> DROP INDEX idx_professor_1;DROP TABLE IF EXISTS professor;</pre>
   */
  public static final String DROP_TABLE_SQL = " DROP INDEX idx_professor_1;DROP TABLE IF EXISTS professor;";
