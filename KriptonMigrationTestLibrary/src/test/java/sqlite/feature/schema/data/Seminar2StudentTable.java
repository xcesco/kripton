...
public class Seminar2StudentTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE seminar_2_student (id INTEGER PRIMARY KEY AUTOINCREMENT, student_id INTEGER, seminar_id INTEGER, FOREIGN KEY(student_id) REFERENCES student(id), FOREIGN KEY(seminar_id) REFERENCES seminar(id)); CREATE UNIQUE INDEX IF NOT EXISTS idx_seminar_2_student_0 on seminar_2_student (student_id asc, seminar_id desc);</pre>
   */
  ...
  /**
   * Entity's property <code>studentId</code> is associated to table column <code>student_id</code>. This costant represents column typeName.
   *
  ...
  /**
   * Entity's property <code>seminarId</code> is associated to table column <code>seminar_id</code>. This costant represents column typeName.
   *
