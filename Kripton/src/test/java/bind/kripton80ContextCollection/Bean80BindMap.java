 ...
 * @see Bean80
 */
@BindMap(Bean80.class)
public class Bean80BindMap extends AbstractMapper<Bean80> {
  /**
   * Bean80BindMap */
  private Bean80BindMap bean80BindMap;
  ...
  private Bean80BindMap bean80BindMap() {
    if (bean80BindMap==null) {
      bean80BindMap=AbstractContext.mapperFor(Bean80.class);
    }
    return bean80BindMap;
  }
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, Bean80 object, JacksonWrapperSerializer wrapper) {
    try {
      ...
      if (object.valueBean!=null)  {
        ...
        bean80BindMap().serializeOnJackson(context, object.valueBean, wrapper);
      }
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, Bean80 object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
      ...
      if (object.valueBean!=null)  {
        fieldCount++;
        jacksonSerializer.writeFieldName("valueBean");
        if (bean80BindMap().serializeOnJacksonAsString(context, object.valueBean, wrapper)==0) {
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, Bean80 object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
      ...
      if (object.valueBean!=null)  {
        ...
        bean80BindMap().serializeOnXml(context, object.valueBean, wrapper, 2);
   ...
   */
  @Override
  public Bean80 parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      ...
      while (jacksonParser.nextToken() != JsonToken.END_OBJECT) {
        ...
        switch (fieldName) {
            case "valueBean":
              // field valueBean (mapped with "valueBean")
              if (jacksonParser.currentToken()==JsonToken.START_OBJECT) {
                instance.valueBean=bean80BindMap().parseOnJackson(context, wrapper);
              }
            break;
   ...
   */
  @Override
  public Bean80 parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      Bean80 instance = createInstance();
      String fieldName;
        ...
        switch (fieldName) {
            case "valueBean":
              ...
              if (jacksonParser.currentToken()==JsonToken.START_OBJECT || jacksonParser.currentToken()==JsonToken.VALUE_STRING) {
                instance.valueBean=bean80BindMap().parseOnJacksonAsString(context, wrapper);
              }
            break;
            case "valueBigDecimal":
              // field valueBigDecimal (mapped with "valueBigDecimal")
   ...
   */
  @Override
  public Bean80 parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
            ...
            case XmlPullParser.START_TAG:
              ...
              switch(currentTag) {
                  case "valueBean":
                    ...
                    instance.valueBean=bean80BindMap().parseOnXml(context, wrapper, eventType);
                  break;
                  case "valueBigDecimal":
