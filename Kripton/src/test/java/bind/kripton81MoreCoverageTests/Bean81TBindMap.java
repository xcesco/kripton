...
public class Bean81TBindMap extends AbstractMapper<Bean81T> {
   ...
   */
  @Override
  public int serializeOnJackson(JacksonContext context, Bean81T object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(JacksonContext context, Bean81T object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(XmlBinderContext context, Bean81T object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public Bean81T parseOnJackson(JacksonContext context, JacksonWrapperParser wrapper) {
    try {
   ...
   */
  @Override
  public Bean81T parseOnJacksonAsString(JacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      Bean81T instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public Bean81T parseOnXml(XmlBinderContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
