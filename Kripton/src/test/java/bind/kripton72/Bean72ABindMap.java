...
public class Bean72ABindMap extends AbstractMapper<Bean72A> {
   ...
   */
  @Override
  public int serializeOnJackson(JacksonContext context, Bean72A object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(JacksonContext context, Bean72A object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(XmlBinderContext context, Bean72A object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
      ...
      if (object.valueBeanSet!=null)  {
        for (Bean72A item: object.valueBeanSet) {
          if (item==null) {
            ...
            context.mapperFor(Bean72A.class).serializeOnXml(context, item, wrapper, 1);
            xmlSerializer.writeEndElement();
          }
        }
      }
   ...
   */
  @Override
  public Bean72A parseOnJackson(JacksonContext context, JacksonWrapperParser wrapper) {
    try {
   ...
   */
  @Override
  public Bean72A parseOnJacksonAsString(JacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      Bean72A instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public Bean72A parseOnXml(XmlBinderContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
                    ...
                    // property valueBeanSet
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEventConstants.END_ELEMENT && xmlParser.getName().toString().equals("valueBeanSet")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueBigIntegerSet
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEventConstants.END_ELEMENT && xmlParser.getName().toString().equals("valueBigIntegerSet")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueByteSet
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEventConstants.END_ELEMENT && xmlParser.getName().toString().equals("valueByteSet")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueCharacterSet
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEventConstants.END_ELEMENT && xmlParser.getName().toString().equals("valueCharacterSet")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueDoubleSet
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEventConstants.END_ELEMENT && xmlParser.getName().toString().equals("valueDoubleSet")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueFloatSet
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEventConstants.END_ELEMENT && xmlParser.getName().toString().equals("valueFloatSet")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueIntSet
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEventConstants.END_ELEMENT && xmlParser.getName().toString().equals("valueIntSet")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueLongSet
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEventConstants.END_ELEMENT && xmlParser.getName().toString().equals("valueLongSet")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueShortSet
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEventConstants.END_ELEMENT && xmlParser.getName().toString().equals("valueShortSet")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueStringSet
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEventConstants.END_ELEMENT && xmlParser.getName().toString().equals("valueStringSet")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
