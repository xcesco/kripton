...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		{
			Attribute attribute = new Attribute("granaBollicine", "grana bollicine", "grain des bulles",
					"size of bubbles");
		...
		{
			Attribute attribute = new Attribute("numeroBollicine", "numero bollicine", "nombre des bulles",
					"number of bubbles");
		...
		{
			Attribute attribute = new Attribute("persistenzaPerlage", "persistenza del perlage",
					"persistance du perlage", "persistence of perlage");
