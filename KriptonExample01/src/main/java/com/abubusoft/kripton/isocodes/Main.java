...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		for (InputCountry item : list) {
			...
			if (item.callingCode == null || item.callingCode.size() != 1)
				continue;
			...
			if (item.translations.fra != null)
				country.translatedName.put(Translation.FR, item.translations.fra.common);
			if (item.translations.deu != null)
				country.translatedName.put(Translation.GE, item.translations.deu.common);
			if (item.translations.ita != null)
				country.translatedName.put(Translation.IT, item.translations.ita.common);
			if (item.translations.jpn != null)
				country.translatedName.put(Translation.JP, item.translations.jpn.common);
			if (item.translations.rus != null)
				country.translatedName.put(Translation.RU, item.translations.rus.common);
			if (item.translations.spa != null)
				country.translatedName.put(Translation.ES, item.translations.spa.common);
