...
public class BeanBindMap extends AbstractMapper<Bean> {
  ...
  public void serializeOnXml(KriptonXmlContext context, Bean object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
      ...
      // field description
      if (object.description!=null) {
        xmlSerializer.writeAttribute("description", object.description);
      }

      // field id
      xmlSerializer.writeAttribute("id", PrimitiveUtils.writeInteger(object.id));
    ...
    try {
      ...
      for (int attributeIndex = 0; attributeIndex < attributesCount; attributeIndex++) {
        ...
        switch(attributeName) {
            case "description":
              // field description
              instance.description=xmlParser.getAttributeValue(attributeIndex);
            break;
            case "id":
              // field id
              instance.id=PrimitiveUtils.readInteger(xmlParser.getAttributeValue(attributeIndex), 0);
            break;
            default:
            break;
        }
