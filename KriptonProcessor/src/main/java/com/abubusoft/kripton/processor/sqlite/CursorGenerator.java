 ...
 *
 */
public class CursorGenerator extends AbstractCodeGenerator implements ModelElementVisitor {

	public static final String SUFFIX = "Cursor";
	
	private int counter;

	public CursorGenerator(Elements elementUtils, Filer filer, SQLiteDatabaseSchema model) {
		super(elementUtils, filer, model);
	}

	public static void generate(Elements elementUtils, Filer filer, SQLiteDatabaseSchema model) throws Exception {
		CursorGenerator visitor = new CursorGenerator(elementUtils, filer, model);
