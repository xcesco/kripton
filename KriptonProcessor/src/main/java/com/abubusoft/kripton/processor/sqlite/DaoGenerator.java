...
import com.abubusoft.kripton.android.sqlite.AbstractBinderDao;
...
public class DaoGenerator implements SQLiteModelElementVisitor {
	...
	public void visit(SQLDaoDefinition value) throws Exception {
		...
		builder = TypeSpec.classBuilder(classTableName).superclass(AbstractBinderDao.class).addSuperinterface(typeName(value.getElement())).addModifiers(Modifier.PUBLIC);
