 ...
 * @see BindSecurityDataSource
 */
public abstract class BindSecurityAsyncTask<I, U, R> {
  /**
   ...
   */
  public BindSecurityAsyncTask(boolean readOnlyTask) {
   ...
   */
  public abstract R onExecute(BindSecurityDaoFactory daoFactory);
  ...
  public void execute(@SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindSecurityAsyncTask.this.onPreExecute();
      }
      ...
      public void onPostExecute(R result) {
        BindSecurityAsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindSecurityDataSource
   */
  public abstract static class Simple<R> extends BindSecurityAsyncTask<Void, Void, R> {
  }
}
