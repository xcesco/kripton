 ...
 *  @see com.abubusoft.kripton.tutorial.DaoUser
 *  @see com.abubusoft.kripton.tutorial.UserTable
 */
public class BindDaoUser extends AbstractDao implements DaoUser {
  public BindDaoUser(BindSecurityDataSource dataSet) {
    super(dataSet);
  }
