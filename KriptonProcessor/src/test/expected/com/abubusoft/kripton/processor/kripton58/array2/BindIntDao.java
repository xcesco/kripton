 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.array2.IntBean
 *  @see com.abubusoft.kripton.processor.kripton58.array2.IntDao
 *  @see com.abubusoft.kripton.processor.kripton58.array2.IntBeanTable
 */
public class BindIntDao extends AbstractDao implements IntDao {
  ...
  public IntBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.setValue(CollectionUtility.asIntegerTypeArray(ProcessorHelper.asList(Integer.TYPE, cursor.getBlob(index1)))); }
      if (!cursor.isNull(index2)) { resultBean.setValue2(CollectionUtility.asIntegerArray(ProcessorHelper.asList(Integer.class, cursor.getBlob(index2)))); }
