 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.array2.LongBean
 *  @see com.abubusoft.kripton.processor.kripton58.array2.LongDao
 *  @see com.abubusoft.kripton.processor.kripton58.array2.LongBeanTable
 */
public class BindLongDao extends AbstractDao implements LongDao {
  ...
  public LongBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.setValue(CollectionUtility.toLongTypeArray(DaoHelper.toList(Long.TYPE, cursor.getBlob(index1)))); }
      if (!cursor.isNull(index2)) { resultBean.setValue2(CollectionUtility.toLongArray(DaoHelper.toList(Long.class, cursor.getBlob(index2)))); }
