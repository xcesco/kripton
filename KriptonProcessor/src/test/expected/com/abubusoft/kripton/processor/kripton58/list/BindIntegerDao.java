 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.list.IntegerBean
 *  @see com.abubusoft.kripton.processor.kripton58.list.IntegerDao
 *  @see com.abubusoft.kripton.processor.kripton58.list.IntegerBeanTable
 */
public class BindIntegerDao extends AbstractDao implements IntegerDao {
  public BindIntegerDao(BindIntegerDataSource dataSet) {
    super(dataSet);
  }
  ...
  public IntegerBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=ProcessorHelper.asList(new ArrayList<Integer>(), Integer.class, cursor.getBlob(index1)); }
      if (!cursor.isNull(index2)) { resultBean.value2=ProcessorHelper.asList(new LinkedList<Integer>(), Integer.class, cursor.getBlob(index2)); }
   ...
   */
  @Override
  public void selectOne(List<Integer> value, ReadBeanListener<IntegerBean> listener) {
    // build where condition
    String[] args={(value==null?null:new String(ProcessorHelper.asByteArray(value),StandardCharsets.UTF_8))};
   ...
   */
  @Override
  public void selectOne(List<Integer> value, ReadCursorListener listener) {
    // build where condition
    String[] args={(value==null?null:new String(ProcessorHelper.asByteArray(value),StandardCharsets.UTF_8))};
