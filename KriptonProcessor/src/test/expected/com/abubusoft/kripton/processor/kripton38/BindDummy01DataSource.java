...
public class BindDummy01DataSource extends AbstractDataSource implements BindDummy01DaoFactory {
  ...
  public void onCreate(SQLiteDatabase database) {
    // generate tables
    Logger.info("DDL: %s",com.abubusoft.kripton.processor.kripton38.Bean01Table.CREATE_TABLE_SQL);
    database.execSQL(com.abubusoft.kripton.processor.kripton38.Bean01Table.CREATE_TABLE_SQL);
  }
  ...
  public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
    // drop tables
    Logger.info("DDL: %s",com.abubusoft.kripton.processor.kripton38.Bean01Table.DROP_TABLE_SQL);
    database.execSQL(com.abubusoft.kripton.processor.kripton38.Bean01Table.DROP_TABLE_SQL);
