...
public class LongBeanTable {
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.LongBean#id
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.LongBean#value
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.LongBean#value2
   */
