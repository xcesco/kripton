 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.list.StringBean
 *  @see com.abubusoft.kripton.processor.kripton58.list.StringDao
 *  @see com.abubusoft.kripton.processor.kripton58.list.StringBeanTable
 */
public class BindStringDao extends AbstractDao implements StringDao {
  ...
  public StringBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=ProcessorHelper.asList(new ArrayList<String>(), String.class, cursor.getBlob(index1)); }
      if (!cursor.isNull(index2)) { resultBean.value2=ProcessorHelper.asList(new LinkedList<String>(), String.class, cursor.getBlob(index2)); }
  ...
  public StringBean selectOne(List<String> value) {
    ...
    Logger.info(StringUtil.formatSQL("SELECT id, value, value2 FROM string_bean WHERE value='%s'"),(Object[])args);
   ...
   */
  @Override
  public void selectOne(List<String> value, ReadBeanListener<StringBean> listener) {
    // build where condition
    String[] args={(value==null?null:new String(ProcessorHelper.asByteArray(value),StandardCharsets.UTF_8))};
   ...
   */
  @Override
  public void selectOne(List<String> value, ReadCursorListener listener) {
    // build where condition
    String[] args={(value==null?null:new String(ProcessorHelper.asByteArray(value),StandardCharsets.UTF_8))};
  ...
  public boolean updateOne(List<String> value, long id, List<String> paramValue) {
    ...
    Logger.info(StringUtil.formatSQL("UPDATE string_bean SET value='"+StringUtil.checkSize(contentValues.get("value"))+"' WHERE id=%s and value=%s"), (Object[])whereConditions);
  ...
  public long insert(long id, List<String> value) {
    ...
    // log
    Logger.info(StringUtil.formatSQL("SQL: INSERT INTO string_bean (id, value) VALUES ('"+StringUtil.checkSize(contentValues.get("id"))+"', '"+StringUtil.checkSize(contentValues.get("value"))+"')"));
  ...
  public long delete(List<String> paramValue) {
    ...
    Logger.info(StringUtil.formatSQL("DELETE string_bean WHERE value=%s"), (Object[])whereConditions);
