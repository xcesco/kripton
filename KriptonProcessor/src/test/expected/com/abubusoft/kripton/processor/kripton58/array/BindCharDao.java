...
public class BindCharDao extends AbstractDao implements CharDao {
  ...
  public CharBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=CollectionUtility.toCharacterTypeArray(DaoHelper.toList(Character.TYPE, cursor.getBlob(index1))); }
      if (!cursor.isNull(index2)) { resultBean.value2=CollectionUtility.toCharacterArray(DaoHelper.toList(Character.class, cursor.getBlob(index2))); }
