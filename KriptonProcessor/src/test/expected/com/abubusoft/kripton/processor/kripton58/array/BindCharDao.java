 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.array.CharBean
 *  @see com.abubusoft.kripton.processor.kripton58.array.CharDao
 *  @see com.abubusoft.kripton.processor.kripton58.array.CharBeanTable
 */
public class BindCharDao extends AbstractDao implements CharDao {
  ...
  public CharBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=CollectionUtility.asCharacterTypeArray(ProcessorHelper.asList(Character.TYPE, cursor.getBlob(index1))); }
      if (!cursor.isNull(index2)) { resultBean.value2=CollectionUtility.asCharacterArray(ProcessorHelper.asList(Character.class, cursor.getBlob(index2))); }
