 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.array2.ShortBean
 *  @see com.abubusoft.kripton.processor.kripton58.array2.ShortDao
 *  @see com.abubusoft.kripton.processor.kripton58.array2.ShortBeanTable
 */
public class BindShortDao extends AbstractDao implements ShortDao {
  ...
  public ShortBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.setValue(CollectionUtility.toShortTypeArray(DaoHelper.toList(Short.TYPE, cursor.getBlob(index1)))); }
      if (!cursor.isNull(index2)) { resultBean.setValue2(CollectionUtility.toShortArray(DaoHelper.toList(Short.class, cursor.getBlob(index2)))); }
