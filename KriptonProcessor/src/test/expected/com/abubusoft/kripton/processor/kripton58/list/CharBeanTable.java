...
public class CharBeanTable {
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.CharBean#id
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.CharBean#value
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.CharBean#value2
   */
