...
public class DoubleBeanTable {
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.DoubleBean#id
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.DoubleBean#value
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.DoubleBean#value2
   */
