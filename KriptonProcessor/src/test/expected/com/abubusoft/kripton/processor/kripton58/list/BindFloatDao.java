 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.list.FloatBean
 *  @see com.abubusoft.kripton.processor.kripton58.list.FloatDao
 *  @see com.abubusoft.kripton.processor.kripton58.list.FloatBeanTable
 */
public class BindFloatDao extends AbstractDao implements FloatDao {
  ...
  public FloatBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=ProcessorHelper.asList(new ArrayList<Float>(), Float.class, cursor.getBlob(index1)); }
      if (!cursor.isNull(index2)) { resultBean.value2=ProcessorHelper.asList(new LinkedList<Float>(), Float.class, cursor.getBlob(index2)); }
