...
public class BindFloatDao extends AbstractDao implements FloatDao {
  ...
  public FloatBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=DaoHelper.toList(new ArrayList<Float>(), Float.class, cursor.getBlob(index1)); }
      if (!cursor.isNull(index2)) { resultBean.value2=DaoHelper.toList(new LinkedList<Float>(), Float.class, cursor.getBlob(index2)); }
