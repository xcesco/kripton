 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.array.LongBean
 *  @see com.abubusoft.kripton.processor.kripton58.array.LongDao
 *  @see com.abubusoft.kripton.processor.kripton58.array.LongBeanTable
 */
public class BindLongDao extends AbstractDao implements LongDao {
  public BindLongDao(BindLongDataSource dataSet) {
    super(dataSet);
  }
  ...
  public LongBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=CollectionUtility.asLongTypeArray(ProcessorHelper.asList(Long.TYPE, cursor.getBlob(index1))); }
      if (!cursor.isNull(index2)) { resultBean.value2=CollectionUtility.asLongArray(ProcessorHelper.asList(Long.class, cursor.getBlob(index2))); }
