 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.list.CharBean
 *  @see com.abubusoft.kripton.processor.kripton58.list.CharDao
 *  @see com.abubusoft.kripton.processor.kripton58.list.CharBeanTable
 */
public class BindCharDao extends AbstractDao implements CharDao {
  ...
  public CharBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=DaoHelper.toList(new ArrayList<Character>(), Character.class, cursor.getBlob(index1)); }
      if (!cursor.isNull(index2)) { resultBean.value2=DaoHelper.toList(new LinkedList<Character>(), Character.class, cursor.getBlob(index2)); }
