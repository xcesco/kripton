...
public class BeanBeanTable {
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.BeanBean#id
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.BeanBean#value
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.BeanBean#value2
   */
