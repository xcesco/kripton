...
public class BindWhisperDataSource extends AbstractDataSource implements BindWhisperDaoFactory {
  ...
  public void onCreate(SQLiteDatabase database) {
    // generate tables
    Logger.info("DDL: %s",com.abubusoft.kripton.processor.kripton56.entities.MessageEntityTable.CREATE_TABLE_SQL);
    database.execSQL(com.abubusoft.kripton.processor.kripton56.entities.MessageEntityTable.CREATE_TABLE_SQL);
  }
  ...
  public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
    // drop tables
    Logger.info("DDL: %s",com.abubusoft.kripton.processor.kripton56.entities.MessageEntityTable.DROP_TABLE_SQL);
    database.execSQL(com.abubusoft.kripton.processor.kripton56.entities.MessageEntityTable.DROP_TABLE_SQL);
