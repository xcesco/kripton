...
import com.abubusoft.kripton.processor.kripton56.entities.MessageEntity$Table;
...
public class BindWhisperDataSource extends AbstractDataSource implements BindWhisperDaoFactory, WhisperDataSource {
  ...
  public void onCreate(SQLiteDatabase database) {
    // generate tables
    Logger.info("DDL: %s",MessageEntity$Table.CREATE_TABLE_SQL);
    database.execSQL(MessageEntity$Table.CREATE_TABLE_SQL);
  }
  ...
  public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
    // drop tables
    Logger.info("DDL: %s",MessageEntity$Table.DROP_TABLE_SQL);
    database.execSQL(MessageEntity$Table.DROP_TABLE_SQL);
