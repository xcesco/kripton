...
public class StringBeanTable {
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.StringBean#id
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.StringBean#value
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.StringBean#value2
   */
