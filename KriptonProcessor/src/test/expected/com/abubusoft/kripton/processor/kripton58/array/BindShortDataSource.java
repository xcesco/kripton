...
public class BindShortDataSource extends AbstractDataSource implements BindShortDaoFactory, ShortDataSource {
  ...
  public void onCreate(SQLiteDatabase database) {
    // generate tables
    Logger.info("DDL: %s",ShortBean$Table.CREATE_TABLE_SQL);
    database.execSQL(ShortBean$Table.CREATE_TABLE_SQL);
  }
  ...
  public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
    // drop tables
    Logger.info("DDL: %s",ShortBean$Table.DROP_TABLE_SQL);
    database.execSQL(ShortBean$Table.DROP_TABLE_SQL);
