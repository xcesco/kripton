...
public class ShortBeanTable {
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.ShortBean#id
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.ShortBean#value
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.ShortBean#value2
   */
