 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.array.DoubleBean
 *  @see com.abubusoft.kripton.processor.kripton58.array.DoubleDao
 *  @see com.abubusoft.kripton.processor.kripton58.array.DoubleBeanTable
 */
public class BindDoubleDao extends AbstractDao implements DoubleDao {
  ...
  public DoubleBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=CollectionUtility.toDoubleTypeArray(DaoHelper.toList(Double.TYPE, cursor.getBlob(index1))); }
      if (!cursor.isNull(index2)) { resultBean.value2=CollectionUtility.toDoubleArray(DaoHelper.toList(Double.class, cursor.getBlob(index2))); }
