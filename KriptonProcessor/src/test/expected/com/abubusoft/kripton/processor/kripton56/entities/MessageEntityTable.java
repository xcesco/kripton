package com.abubusoft.kripton.processor.kripton56.entities;
...
public class MessageEntityTable {
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton56.entities.MessageEntity#id
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton56.entities.MessageEntity#channelId
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton56.entities.MessageEntity#ownerType
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton56.entities.MessageEntity#faceUid
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton56.entities.MessageEntity#text
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton56.entities.MessageEntity#ownerUid
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton56.entities.MessageEntity#channelUid
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton56.entities.MessageEntity#updateTime
   */
