...
public class FloatBeanTable {
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.FloatBean#id
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.FloatBean#value
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.FloatBean#value2
   */
