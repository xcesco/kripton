 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.array2.DoubleBean
 *  @see com.abubusoft.kripton.processor.kripton58.array2.DoubleDao
 *  @see com.abubusoft.kripton.processor.kripton58.array2.DoubleBeanTable
 */
public class BindDoubleDao extends AbstractDao implements DoubleDao {
  ...
  public DoubleBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.setValue(CollectionUtility.asDoubleTypeArray(ProcessorHelper.asList(Double.TYPE, cursor.getBlob(index1)))); }
      if (!cursor.isNull(index2)) { resultBean.setValue2(CollectionUtility.asDoubleArray(ProcessorHelper.asList(Double.class, cursor.getBlob(index2)))); }
