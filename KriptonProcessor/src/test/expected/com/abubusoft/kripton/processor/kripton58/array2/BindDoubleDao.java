...
public class BindDoubleDao extends AbstractDao implements DoubleDao {
  ...
  public DoubleBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.setValue(CollectionUtility.toDoubleTypeArray(DaoHelper.toList(Double.TYPE, cursor.getBlob(index1)))); }
      if (!cursor.isNull(index2)) { resultBean.setValue2(CollectionUtility.toDoubleArray(DaoHelper.toList(Double.class, cursor.getBlob(index2)))); }
