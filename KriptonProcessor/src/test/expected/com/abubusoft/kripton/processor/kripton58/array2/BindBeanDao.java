 ...
 *  @see com.abubusoft.kripton.processor.kripton58.array2.BeanDao
 *  @see com.abubusoft.kripton.processor.kripton58.array2.BeanBeanTable
 */
public class BindBeanDao extends AbstractDao implements BeanDao {
  ...
  public BeanBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.setValue(CollectionUtility.toArray(DaoHelper.toList(BeanInner.class, cursor.getBlob(index1)))); }
      if (!cursor.isNull(index2)) { resultBean.setValue2(CollectionUtility.toArray(DaoHelper.toList(BeanInner.class, cursor.getBlob(index2)))); }
