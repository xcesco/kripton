...
public class IntegerBeanTable {
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.IntegerBean#id
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.IntegerBean#value
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton58.list.IntegerBean#value2
   */
