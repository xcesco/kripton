 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.array.ByteBean
 *  @see com.abubusoft.kripton.processor.kripton58.array.ByteDao
 *  @see com.abubusoft.kripton.processor.kripton58.array.ByteBeanTable
 */
public class BindByteDao extends AbstractDao implements ByteDao {
  ...
  public ByteBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index2)) { resultBean.value2=CollectionUtility.toByteArray(DaoHelper.toList(Byte.class, cursor.getBlob(index2))); }
