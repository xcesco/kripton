...
public class BindDaoBean01 extends AbstractDao implements DaoBean01 {
  ...
  public Bean01 selectOne(byte[] value, long[] longValue) {
    ...
    String[] args={(value==null?null:new String(value)), (longValue==null?null:new String(DaoHelper.toByteArray(CollectionUtility.toList(longValue, ArrayList.class))))};
  ...
  public long updateOne(byte[] value, long[] longValue, long uid) {
    ...
    String[] whereConditions={String.valueOf(String.valueOf(uid))};
  ...
  public long selectLongSingle(long id, long[] longValue) {
    // build where condition
    String[] args={String.valueOf(id), (longValue==null?null:new String(DaoHelper.toByteArray(CollectionUtility.toList(longValue, ArrayList.class))))};
  ...
  public List<Bean01> selectBeanSingle(Bean01 bean) {
    // build where condition
    String[] args={String.valueOf(bean.id), (bean.longValue==null?null:new String(DaoHelper.toByteArray(CollectionUtility.toList(bean.longValue, ArrayList.class)))), (bean.integerValue==null?null:new String(DaoHelper.toByteArray(CollectionUtility.toList(bean.integerValue, ArrayList.class))))};
  ...
  public long selectRawSingle(long id, long[] longValue, Byte[] byteValue) {
    // build where condition
    String[] args={String.valueOf(id), (longValue==null?null:new String(DaoHelper.toByteArray(CollectionUtility.toList(longValue, ArrayList.class)))), (byteValue==null?null:new String(DaoHelper.toByteArray(CollectionUtility.toList(byteValue, ArrayList.class))))};
  ...
  public long delete(Bean01 bean) {
    String[] whereConditions={(bean.longValue==null?null:new String(DaoHelper.toByteArray(CollectionUtility.toList(bean.longValue, ArrayList.class))))};
