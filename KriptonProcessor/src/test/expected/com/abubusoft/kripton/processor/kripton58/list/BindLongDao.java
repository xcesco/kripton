 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.list.LongBean
 *  @see com.abubusoft.kripton.processor.kripton58.list.LongDao
 *  @see com.abubusoft.kripton.processor.kripton58.list.LongBeanTable
 */
public class BindLongDao extends AbstractDao implements LongDao {
  ...
  public LongBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=ProcessorHelper.asList(new ArrayList<Long>(), Long.class, cursor.getBlob(index1)); }
      if (!cursor.isNull(index2)) { resultBean.value2=ProcessorHelper.asList(new LinkedList<Long>(), Long.class, cursor.getBlob(index2)); }
