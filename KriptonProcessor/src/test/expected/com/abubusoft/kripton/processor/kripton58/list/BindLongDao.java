...
public class BindLongDao extends AbstractDao implements LongDao {
  ...
  public LongBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=DaoHelper.toList(new ArrayList<Long>(), Long.class, cursor.getBlob(index1)); }
      if (!cursor.isNull(index2)) { resultBean.value2=DaoHelper.toList(new LinkedList<Long>(), Long.class, cursor.getBlob(index2)); }
