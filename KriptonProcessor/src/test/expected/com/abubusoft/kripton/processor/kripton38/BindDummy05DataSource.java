...
public class BindDummy05DataSource extends AbstractDataSource implements BindDummy05DaoFactory {
  ...
  public void onCreate(SQLiteDatabase database) {
    // generate tables
    Logger.info("DDL: %s",com.abubusoft.kripton.processor.kripton38.Bean05Table.CREATE_TABLE_SQL);
    database.execSQL(com.abubusoft.kripton.processor.kripton38.Bean05Table.CREATE_TABLE_SQL);
  }
  ...
  public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
    // drop tables
    Logger.info("DDL: %s",com.abubusoft.kripton.processor.kripton38.Bean05Table.DROP_TABLE_SQL);
    database.execSQL(com.abubusoft.kripton.processor.kripton38.Bean05Table.DROP_TABLE_SQL);
