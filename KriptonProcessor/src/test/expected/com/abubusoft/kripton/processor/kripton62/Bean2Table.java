...
public class Bean2Table {
  /**
   * Costant represents name of table bean2
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#id
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#valueByteSet
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#valueShortSet
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#valueIntegerSet
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#valueStringSet
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#valueCharacterSet
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#valueFloatSet
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#valueDoubleSet
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#valueBigDecimalSet
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#valueBeanSet
   */
   ...
   *
   *  @see com.abubusoft.kripton.processor.kripton62.Bean2#valueEnumTypeSet
   */
