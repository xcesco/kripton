 ...
 *  @see com.abubusoft.kripton.processor.kripton58.list.ByteDao
 *  @see com.abubusoft.kripton.processor.kripton58.list.ByteBeanTable
 */
public class BindByteDao extends AbstractDao implements ByteDao {
  public BindByteDao(BindByteDataSource dataSet) {
    super(dataSet);
  }
  ...
  public ByteBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=ProcessorHelper.asList(new ArrayList<Byte>(), Byte.class, cursor.getBlob(index1)); }
      if (!cursor.isNull(index2)) { resultBean.value2=ProcessorHelper.asList(new LinkedList<Byte>(), Byte.class, cursor.getBlob(index2)); }
