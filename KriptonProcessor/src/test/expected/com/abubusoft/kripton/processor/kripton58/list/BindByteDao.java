...
public class BindByteDao extends AbstractDao implements ByteDao {
  ...
  public ByteBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=DaoHelper.toList(new ArrayList<Byte>(), Byte.class, cursor.getBlob(index1)); }
      if (!cursor.isNull(index2)) { resultBean.value2=DaoHelper.toList(new LinkedList<Byte>(), Byte.class, cursor.getBlob(index2)); }
