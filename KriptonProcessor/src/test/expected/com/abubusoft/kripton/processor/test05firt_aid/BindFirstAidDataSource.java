...
public class BindFirstAidDataSource extends AbstractDataSource implements BindFirstAidDaoFactory, FirstAidDataSource {
  ...
  public void onCreate(SQLiteDatabase database) {
    // generate tables
    Logger.info("DDL: %s",FirstAid$Table.CREATE_TABLE_SQL);
    database.execSQL(FirstAid$Table.CREATE_TABLE_SQL);
  }
  ...
  public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
    // drop tables
    Logger.info("DDL: %s",FirstAid$Table.DROP_TABLE_SQL);
    database.execSQL(FirstAid$Table.DROP_TABLE_SQL);
