...
public class BindFloatDao extends AbstractDao implements FloatDao {
  ...
  public FloatBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=CollectionUtility.toFloatTypeArray(DaoHelper.toList(Float.TYPE, cursor.getBlob(index1))); }
      if (!cursor.isNull(index2)) { resultBean.value2=CollectionUtility.toFloatArray(DaoHelper.toList(Float.class, cursor.getBlob(index2))); }
