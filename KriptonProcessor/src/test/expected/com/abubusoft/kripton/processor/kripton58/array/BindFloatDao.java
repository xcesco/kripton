 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.array.FloatBean
 *  @see com.abubusoft.kripton.processor.kripton58.array.FloatDao
 *  @see com.abubusoft.kripton.processor.kripton58.array.FloatBeanTable
 */
public class BindFloatDao extends AbstractDao implements FloatDao {
  public BindFloatDao(BindFloatDataSource dataSet) {
    super(dataSet);
  }
  ...
  public FloatBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.value=CollectionUtility.asFloatTypeArray(ProcessorHelper.asList(Float.TYPE, cursor.getBlob(index1))); }
      if (!cursor.isNull(index2)) { resultBean.value2=CollectionUtility.asFloatArray(ProcessorHelper.asList(Float.class, cursor.getBlob(index2))); }
