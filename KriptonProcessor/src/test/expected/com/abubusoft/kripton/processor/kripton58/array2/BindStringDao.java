 ...
 * </p>
 *  @see com.abubusoft.kripton.processor.kripton58.array2.StringBean
 *  @see com.abubusoft.kripton.processor.kripton58.array2.StringDao
 *  @see com.abubusoft.kripton.processor.kripton58.array2.StringBeanTable
 */
public class BindStringDao extends AbstractDao implements StringDao {
  ...
  public StringBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.setValue(CollectionUtility.asStringArray(ProcessorHelper.asList(String.class, cursor.getBlob(index1)))); }
      if (!cursor.isNull(index2)) { resultBean.setValue2(CollectionUtility.asStringArray(ProcessorHelper.asList(String.class, cursor.getBlob(index2)))); }
