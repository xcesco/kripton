...
public class BindStringDao extends AbstractDao implements StringDao {
  ...
  public StringBean selectOne() {
    ...
    if (cursor.moveToFirst()) {
      ...
      if (!cursor.isNull(index1)) { resultBean.setValue(CollectionUtility.toStringArray(DaoHelper.toList(String.class, cursor.getBlob(index1)))); }
      if (!cursor.isNull(index2)) { resultBean.setValue2(CollectionUtility.toStringArray(DaoHelper.toList(String.class, cursor.getBlob(index2)))); }
