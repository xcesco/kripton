...
/**
 * This class is the shared preference binder defined for BeanAttribute76
 *
 * @see BeanAttribute76
 */
@BindMap
public class BeanAttribute76BindMap extends AbstractMapper<BeanAttribute76> {
  /**
   ...
   */
  @Override
  public int serializeOnJackson(JacksonContext context, BeanAttribute76 object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(JacksonContext context, BeanAttribute76 object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
