...
/**
 * This class is the shared preference binder defined for BeanAttribute76Array
 *
 * @see BeanAttribute76Array
 */
@BindMap
public class BeanAttribute76ArrayBindMap extends AbstractMapper<BeanAttribute76Array> {
  /**
   ...
   */
  @Override
  public int serializeOnJackson(JacksonContext context, BeanAttribute76Array object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(JacksonContext context, BeanAttribute76Array object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
