...
public class LongDaoImpl extends AbstractDao implements LongDao {
  ...
  public long insert(long id, List<Long> value) {
    ...
    // log
    Logger.info(StringUtils.formatSQL("SQL: INSERT INTO long_bean (id, value) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"')"));
   ...
   * write
   */
  protected static byte[] java2Content1(List<Long> value) {
    if (value==null) {
      return null;
    }
