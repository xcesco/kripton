...
public class DoubleDaoImpl extends AbstractDao implements DoubleDao {
  ...
  public long updateOne(List<Double> value, Double id, List<Double> paramValue) {
    ...
    String[] whereConditions={(id==null?null:String.valueOf(id)), (paramValue==null?null:new String(java2Content1(paramValue),StandardCharsets.UTF_8))};
   ...
   * write
   */
  protected static byte[] java2Content1(List<Double> value) {
    if (value==null) {
      return null;
    }
