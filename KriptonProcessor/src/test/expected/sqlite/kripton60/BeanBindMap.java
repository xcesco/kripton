    ...
    try {
      ...
      if (object.valueLinkedMapStringBean!=null)  {
        ...
        if (object.valueLinkedMapStringBean.size()>0) {
          ...
          jacksonSerializer.writeStartArray();
          for (Map.Entry<String, Bean> item: object.valueLinkedMapStringBean.entrySet()) {
            jacksonSerializer.writeStartObject();
      ...
      if (object.valueMapStringBean!=null)  {
        ...
        if (object.valueMapStringBean.size()>0) {
          ...
          jacksonSerializer.writeStartArray();
          for (Map.Entry<String, Bean> item: object.valueMapStringBean.entrySet()) {
            jacksonSerializer.writeStartObject();
            jacksonSerializer.writeStringField("key", item.getKey());
            if (item.getValue()==null) {
              jacksonSerializer.writeNullField("value");
  ...
  public int serializeOnJacksonAsString(JacksonContext context, Bean object, JacksonWrapperSerializer wrapper) {
    try {
      ...
      if (object.valueBean!=null)  {
        fieldCount++;
        jacksonSerializer.writeFieldName("valueBean");
        if (context.mapperFor(Bean.class).serializeOnJacksonAsString(context, object.valueBean, wrapper)==0) {
        ...
        if (n>0) {
          ...
          for (int i=0; i<n; i++) {
            ...
            if (item==null) {
              ...
              if (context.mapperFor(Bean.class).serializeOnJacksonAsString(context, item, wrapper)==0) {
        ...
        if (object.valueLinkedMapStringBean.size()>0) {
          ...
          for (Map.Entry<String, Bean> item: object.valueLinkedMapStringBean.entrySet()) {
            ...
            if (item.getValue()==null) {
              ...
              jacksonSerializer.writeFieldName("value");
              if (context.mapperFor(Bean.class).serializeOnJacksonAsString(context, item.getValue(), wrapper)==0) {
                jacksonSerializer.writeNullField("value");
              }
            }
            jacksonSerializer.writeEndObject();
      ...
      if (object.valueBeanArray!=null)  {
        ...
        for (int i=0; i<n; i++) {
          ...
          if (item==null) {
            ...
            context.mapperFor(Bean.class).serializeOnXml(context, item, wrapper, 1);
            xmlSerializer.writeEndElement();
          }
        }
      }
          ...
          xmlSerializer.writeStartElement("valueLinkedMapStringBean");
            ...
            if (item.getValue()==null) {
              ...
              if (item.getValue()!=null)  {
                ...
                context.mapperFor(Bean.class).serializeOnXml(context, item.getValue(), wrapper, 1);
                xmlSerializer.writeEndElement();
              }
            }
          xmlSerializer.writeEndElement();
              ...
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                while (jacksonParser.nextToken() != JsonToken.END_ARRAY) {
                  ...
                  if (jacksonParser.currentToken()==JsonToken.VALUE_STRING && "null".equals(tempValue)) {
                    ...
                    item=context.mapperFor(Bean.class).parseOnJacksonAsString(context, wrapper);
                  }
                  collection.add(item);
                }
                instance.valueBeanArray=CollectionUtils.asArray(collection, new Bean[collection.size()]);
                  ...
                  for (int i=0; i<2 ;i++) {
                    ...
                    case "value":
                      ...
                      if (jacksonParser.currentToken()==JsonToken.VALUE_STRING && "null".equals(tempValue)) {
                        ...
                        if (jacksonParser.currentToken()==JsonToken.START_OBJECT) {
                          value=context.mapperFor(Bean.class).parseOnJacksonAsString(context, wrapper);
                        }
                      }
                    break;
                    }
                    ...
                    // property valueBeanArray
                     {
                      ...
                      if (xmlParser.isEmptyElement()) {
                        ...
                        item=context.mapperFor(Bean.class).parseOnXml(context, wrapper, eventType);
                      }
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueBeanArray")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueCharArray
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueCharArray")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueCharList
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueCharList")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueCharTypeArray
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueCharTypeArray")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueLinkedMapStringBean
                     {
                      ...
                      if (xmlParser.isEmptyElement()) {
                        ...
                        value=context.mapperFor(Bean.class).parseOnXml(context, wrapper, eventType);
                      }
                      xmlParser.nextTag();
                      collection.put(key, value);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueLinkedMapStringBean")) {
                        xmlParser.nextTag();
                        key=StringEscapeUtils.unescapeXml(xmlParser.getElementText());
                        xmlParser.nextTag();
                        if (xmlParser.isEmptyElement()) {
                    ...
                    // property valueLongArray
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueLongArray")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueLongList
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueLongList")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueLongTypeArray
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueLongTypeArray")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueStrinList
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueStrinList")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueStringArray
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueStringArray")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
                    ...
                    // property valueTimeList
                     {
                      ...
                      collection.add(item);
                      while (xmlParser.nextTag() != XMLEvent.END_ELEMENT && xmlParser.getName().toString().equals("valueTimeList")) {
                        if (xmlParser.isEmptyElement()) {
                          item=null;
                          xmlParser.nextTag();
                        } else {
