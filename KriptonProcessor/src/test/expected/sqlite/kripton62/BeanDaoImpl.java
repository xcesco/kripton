...
public class BeanDaoImpl extends AbstractDao implements BeanDao {
  ...
  public Bean selectOne() {
    ...
    Logger.info(StringUtils.formatSQL("SELECT id, value_byte_set, value_short_set, value_integer_set, value_string_set, value_character_set, value_float_set, value_double_set, value_big_decimal_set, value_bean_set, value_enum_type_set FROM bean WHERE 1=1"),(Object[])args);
  ...
  public long insert(HashSet<BigDecimal> valueBigDecimalSet) {
    ...
    // log
    Logger.info(StringUtils.formatSQL("SQL: INSERT INTO bean (value_big_decimal_set) VALUES ('"+StringUtils.checkSize(contentValues.get("value_big_decimal_set"))+"')"));
    long result = database().insert("bean", null, contentValues);
    return result;
  }
