...
import kripton49.entities.Bean01EntityTable;
 ...
 * @see DaoBean01
 * @see DaoBean01Impl
 * @see kripton49.entities.Bean01Entity
 */
public class BindDummy01DataSource extends AbstractDataSource implements BindDummy01DaoFactory, Dummy01DataSource {
  ...
  public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
    // drop tables
    Logger.info("DDL: %s",Bean01EntityTable.DROP_TABLE_SQL);
    database.execSQL(Bean01EntityTable.DROP_TABLE_SQL);
