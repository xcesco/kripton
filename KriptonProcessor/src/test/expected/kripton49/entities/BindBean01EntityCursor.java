...
/**
 * <p>
 * Cursor implementation for entity <code>Bean01Entity</code>
 * </p>
 *  @see Bean01Entity
 */
public class BindBean01EntityCursor {
  /**
   ...
   */
  BindBean01EntityCursor(Cursor cursor) {
    wrap(cursor);
  }
   ...
   */
  public BindBean01EntityCursor wrap(Cursor cursor) {
    this.cursor=cursor;
   ...
   */
  public LinkedList<Bean01Entity> execute() {

    LinkedList<Bean01Entity> resultList=new LinkedList<Bean01Entity>();
    Bean01Entity resultBean=new Bean01Entity();
   ...
   */
  public void executeListener(OnBean01EntityListener listener) {
    Bean01Entity resultBean=new Bean01Entity();
   ...
   */
  public static BindBean01EntityCursor create(Cursor cursor) {
    return new BindBean01EntityCursor(cursor);
  }

  /**
   * <p>Listener for row read from database.</p>
   */
  public interface OnBean01EntityListener {
    /**
     ...
     */
    void onRow(Bean01Entity bean, int rowPosition, int rowCount);
  }
}
