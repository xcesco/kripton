...
/**
 * This class is the shared preference binder defined for BeanAttribute71
 *
 * @see BeanAttribute71
 */
@BindMap
public class BeanAttribute71BindMap extends AbstractMapper<BeanAttribute71> {
  /**
   * create new object instance
   */
  @Override
  public BeanAttribute71 createInstance() {
    return new BeanAttribute71();
  }
   ...
   */
  @Override
  public void serializeOnJackson(JacksonContext context, BeanAttribute71 object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public void serializeOnJacksonAsString(JacksonContext context, BeanAttribute71 object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
   ...
   */
  @Override
  public void serializeOnXml(XmlBinderContext context, BeanAttribute71 object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public BeanAttribute71 parseOnJackson(JacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      BeanAttribute71 instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public BeanAttribute71 parseOnJacksonAsString(JacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      BeanAttribute71 instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public BeanAttribute71 parseOnXml(XmlBinderContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
