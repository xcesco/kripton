...
@RunWith(Suite.class)
@Suite.SuiteClasses({ TestDatabase01.class, TestDao01.class, Test03.class, TestKripton33.class, TestKripton38.class, TestKripton40.class, TestKripton41.class, TestKripton42.class, TestKripton45.class, TestKripton46.class,
		TestFirstAid.class })
