...
public class Bean632 {
	...
	public LinkedHashSet<Bean63> getValueBeanSet() {
		return valueBeanSet;
	}

	public void setValueBeanSet(LinkedHashSet<Bean63> valueBeanSet) {
	...
	LinkedHashSet<Bean63> valueBeanSet;
