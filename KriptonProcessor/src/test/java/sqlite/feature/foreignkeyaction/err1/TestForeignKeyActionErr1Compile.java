...
public class TestForeignKeyActionErr1Compile extends AbstractBindSQLiteProcessorTest {
	...
	public void testForeignKeyAction() throws IOException, InstantiationException, IllegalAccessException {
		...
		buildDataSourceProcessorTest(BaseDao.class, Album.class, Artist.class, AlbumDao.class, ArtistDao.class, ArtistErr1DataSource.class);
	}
