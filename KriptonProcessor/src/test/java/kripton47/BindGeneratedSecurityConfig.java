...
public class BindGeneratedSecurityConfig extends AbstractSharedPreference {
  ...
  public SecurityPreferences read() {
    ...
    bean.authorizationToken=(kripton47.DeviceAccessToken)readObj(prefs.getString("authorizationToken", null), kripton47.DeviceAccessToken.class);
    ...
    bean.userIdentity=(kripton47.UserIdentity)readObj(prefs.getString("userIdentity", null), kripton47.UserIdentity.class);
  ...
  public DeviceAccessToken authorizationToken() {
    kripton47.DeviceAccessToken temp=(kripton47.DeviceAccessToken)readObj(prefs.getString("authorizationToken", null), kripton47.DeviceAccessToken.class);
    if (temp!=null)  {
      return temp;
    }
  ...
  public UserIdentity userIdentity() {
    ...
    kripton47.UserIdentity temp=(kripton47.UserIdentity)readObj(buffer, kripton47.UserIdentity.class);
    if (temp!=null)  {
      return temp;
    }
