...
public class TestKripton76 extends BaseProcessorTest {
	...
	{
		buildBindProcessorTest(BeanElement76.class, BeanEnum.class);
	}
	
	@Test
	public void testRun() throws IOException, InstantiationException, IllegalAccessException
	{
		Assert.assertNotNull(new BeanElement76BindMap());
		
		BeanElement76 bean=new BeanElement76();
		...
		bean.id=25;
		bean.valueBean=new BeanElement76();
