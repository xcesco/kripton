...
public class BindGeneratedSecurityConfig extends AbstractSharedPreference {
  ...
  public SecurityPreferences read() {
    ...
    bean.authorizationToken=(shared.kripton47.DeviceAccessToken)readObj(prefs.getString("authorizationToken", null), shared.kripton47.DeviceAccessToken.class);
    ...
    bean.userIdentity=(shared.kripton47.UserIdentity)readObj(prefs.getString("userIdentity", null), shared.kripton47.UserIdentity.class);
  ...
  public DeviceAccessToken authorizationToken() {
    shared.kripton47.DeviceAccessToken temp=(shared.kripton47.DeviceAccessToken)readObj(prefs.getString("authorizationToken", null), shared.kripton47.DeviceAccessToken.class);
    if (temp!=null)  {
      return temp;
    }
  ...
  public UserIdentity userIdentity() {
    ...
    shared.kripton47.UserIdentity temp=(shared.kripton47.UserIdentity)readObj(buffer, shared.kripton47.UserIdentity.class);
    if (temp!=null)  {
      return temp;
    }
