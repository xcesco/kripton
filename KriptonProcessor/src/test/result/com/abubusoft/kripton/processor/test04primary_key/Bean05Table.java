 ...
 *
 *  @since Wed May 25 01:06:02 CEST 2016
 *
 */
public class Bean05Table {
  public static final String TABLE_NAME = "bean05";

  public static final String CREATE_TABLE_SQL = "CREATE TABLE bean05( pk INTEGER PRIMARY KEY AUTOINCREMENT, text TEXT, content BLOB, creation_time TEXT);";
