 ...
 *
 *  @since Wed May 18 00:55:40 CEST 2016
 *
 */
public class BindDaoBean01 extends AbstractBindDao implements DaoBean01 {
   ...
   *
   * <pre>select id, message_date, message_text, value from bean01</pre>
   *
  ...
  public List<Bean01> listAll() {
    ...
    Cursor cursor = database.rawQuery("select id, message_date, message_text, value from bean01", args);
      ...
      do
       {
        ...
        resultBean.setMessageDate(cursor.getLong(index1));
        resultBean.setMessageText(cursor.getString(index2));
        resultBean.setValue(cursor.getLong(index3));
