...
public class BindDaoBean01 extends AbstractBindDao implements DaoBean01 {
  ...
  public Bean01 selectOne(long id) {
    ...
    Logger.info("SQL: select id, text from bean01 where id='%s'",(Object[])args);
  ...
  public long updateOne(String text, long id) {
    ...
    Logger.info("SQL: UPDATE bean01 SET text='"+checkSize(contentValues.get("text"))+"' WHERE id=%s", (Object[])whereConditions);
