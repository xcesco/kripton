 ...
 *
 * @since Thu May 26 04:08:55 CEST 2016
 *
 */
public class BindDaoBean05 extends AbstractBindDao implements DaoBean05 {
  ...
  public Bean05 selectOne(Long id) {
    ...
    ElioLogger.info("SQL : select pk, number, bean_type, text, content, creation_time from bean05 where pk=?");
    ElioLogger.info("args:"+args);
