...
public class BindDaoBean05 extends AbstractBindDao implements DaoBean05 {
  ...
  public Bean05 selectOne(Long id) {
    ...
    Logger.info("SQL: select pk, number, bean_type, text, content, creation_time from bean05 where pk='%s'",(Object[])args);
  ...
  public Bean05 selectOne(Bean05 bean) {
    ...
    Logger.info("SQL: select pk, number, bean_type, text, content, creation_time from bean05 where pk='%s' and prova='%s'",(Object[])args);
  ...
  public List<Long> selectPK() {
    ...
    Logger.info("SQL: select pk from bean05 where  1 = 1",(Object[])args);
  ...
  public long insertRaw(String text, byte[] content, Date creationTime) {
    ...
    // log
    Logger.info("SQL: INSERT INTO bean05 (text, content, creation_time) VALUES ('"+checkSize(contentValues.get("text"))+"', '"+checkSize(contentValues.get("content"))+"', '"+checkSize(contentValues.get("creation_time"))+"')");
  ...
  public void insert(Bean05 bean) {
    ...
    // log
    Logger.info("SQL: INSERT INTO bean05 (number, bean_type, text, content, creation_time) VALUES ('"+checkSize(contentValues.get("number"))+"', '"+checkSize(contentValues.get("bean_type"))+"', '"+checkSize(contentValues.get("text"))+"', '"+checkSize(contentValues.get("content"))+"', '"+checkSize(contentValues.get("creation_time"))+"')");
    long result = database.insert("bean05", null, contentValues);
    bean.setPk(result);
  }
  ...
  public long updateOne(Bean05 bean) {
    ...
    Logger.info("UPDATE bean05 SET number='"+checkSize(contentValues.get("number"))+"', bean_type='"+checkSize(contentValues.get("bean_type"))+"', text='"+checkSize(contentValues.get("text"))+"', content='"+checkSize(contentValues.get("content"))+"', creation_time='"+checkSize(contentValues.get("creation_time"))+"' WHERE pk=%s and text=%s and creationTime=%s", (Object[])whereConditions);
  ...
  public long updateOne(byte[] content, String text, long uid, Date validoIn, Date valido) {
    ...
    Logger.info("SQL: UPDATE bean05 SET content='"+checkSize(contentValues.get("content"))+"', text='"+checkSize(contentValues.get("text"))+"' WHERE pk=%s and creationTime=%s and creationTime=%s", (Object[])whereConditions);
  ...
  public long deleteOne(Bean05 bean) {
    ...
    Logger.info("DELETE bean05 WHERE number='"+checkSize(contentValues.get("number"))+"', bean_type='"+checkSize(contentValues.get("bean_type"))+"', text='"+checkSize(contentValues.get("text"))+"', content='"+checkSize(contentValues.get("content"))+"', creation_time='"+checkSize(contentValues.get("creation_time"))+"'", (Object[])whereConditions);
  ...
  public long deleteOne(long uid, Date validoIn, Date valido) {
    ...
    Logger.info("SQL: DELETE bean05 WHERE ", (Object[])whereConditions);
  ...
  public byte[] getOne(long id) {
    ...
    Logger.info("SQL: select content from bean05 where pk='%s'",(Object[])args);
