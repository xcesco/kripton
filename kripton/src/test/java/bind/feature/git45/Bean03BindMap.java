...
public class Bean03BindMap extends AbstractMapper<Bean03> {
   ...
   */
  @Override
  public void serializeOnXml(Bean03 object, XMLSerializer xmlSerializer, EventType currentEventType)
      throws Exception {
   ...
   */
  @Override
  public Bean03 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean03 instance = new Bean03();
                  ...
                  // property miscellaneus (mapped on "miscellaneus")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("miscellaneus")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
