...
public class BindAppDataSource extends AbstractDataSource implements BindAppDaoFactory, AppDataSource {
  ...
  /**
   * Unique identifier for Dao DaoRssFeed
   */
  public static final int DAO_RSS_FEED_UID = 0;

  /**
   * List of tables compose datasource
   */
  static final SQLiteTable[] TABLES = {new RssFeedTable()};

  /**
   * <p>dao instance</p>
   */
  protected DaoRssFeedImpl daoRssFeed = new DaoRssFeedImpl(this);
  ...
  @Override
  public DaoRssFeedImpl getDaoRssFeed() {
    return daoRssFeed;
  }
  ...
  public void clearCompiledStatements() {
    DaoRssFeedImpl.clearCompiledStatements();
  }
  ...
  class DataSourceSingleThread implements BindAppDaoFactory {
    ...
    protected DaoRssFeedImpl _daoRssFeed;
    ...
    public DaoRssFeedImpl getDaoRssFeed() {
      if (_daoRssFeed==null) {
        _daoRssFeed=new DaoRssFeedImpl(this);
      }
      return _daoRssFeed;
    }
