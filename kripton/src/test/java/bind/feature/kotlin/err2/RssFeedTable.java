...
public class RssFeedTable implements SQLiteTable {
   ...
   * </p>
   *
   * <pre>CREATE TABLE rss_feed (id INTEGER PRIMARY KEY AUTOINCREMENT, uid TEXT);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE rss_feed (id INTEGER PRIMARY KEY AUTOINCREMENT, uid TEXT);";
   ...
   * Columns array
   */
  private static final String[] COLUMNS = {COLUMN_ID, COLUMN_UID};
