...
public class Class3BindMap extends AbstractMapper<Class3> {
   ...
   */
  @Override
  public void serializeOnXml(Class3 object, XMLSerializer xmlSerializer, EventType currentEventType)
      throws Exception {
   ...
   */
  @Override
  public Class3 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Class3 instance = new Class3();
