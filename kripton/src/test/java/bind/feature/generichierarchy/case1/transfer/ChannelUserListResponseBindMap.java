...
public class ChannelUserListResponseBindMap extends AbstractMapper<ChannelUserListResponse> {
    ...
    if (object.getList()!=null)  {
      ...
      for (int i=0; i<n; i++) {
        ...
        if (item==null) {
          ...
          channelUserBindMap.serializeOnXml(item, xmlSerializer, EventType.START_TAG);
          xmlSerializer.writeEndElement();
        }
      }
   ...
   */
  @Override
  public ChannelUserListResponse parseOnXml(XMLParser xmlParser, EventType currentEventType) throws
      Exception {
    ChannelUserListResponse instance = new ChannelUserListResponse();
