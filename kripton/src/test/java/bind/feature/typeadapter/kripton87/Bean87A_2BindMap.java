...
public class Bean87A_2BindMap extends AbstractMapper<Bean87A_2> {
   ...
   */
  @Override
  public void serializeOnXml(Bean87A_2 object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean87A_2 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean87A_2 instance = new Bean87A_2();
