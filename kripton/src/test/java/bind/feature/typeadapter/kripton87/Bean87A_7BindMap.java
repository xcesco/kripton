...
public class Bean87A_7BindMap extends AbstractMapper<Bean87A_7> {
   ...
   */
  @Override
  public void serializeOnXml(Bean87A_7 object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean87A_7 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean87A_7 instance = new Bean87A_7();
