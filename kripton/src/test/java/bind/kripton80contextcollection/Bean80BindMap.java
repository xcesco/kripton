...
public class Bean80BindMap extends AbstractMapper<Bean80> {
  ...
  public int serializeOnJackson(Bean80 object, JsonGenerator jacksonSerializer) throws Exception {
    ...
    if (object.valueBean!=null)  {
      ...
      bean80BindMap.serializeOnJackson(object.valueBean, jacksonSerializer);
    }
  ...
  @Override
  public int serializeOnJacksonAsString(Bean80 object, JsonGenerator jacksonSerializer) throws
      Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
    ...
    if (object.valueBean!=null)  {
      fieldCount++;
      jacksonSerializer.writeFieldName("valueBean");
      if (bean80BindMap.serializeOnJacksonAsString(object.valueBean, jacksonSerializer)==0) {
   ...
   */
  @Override
  public void serializeOnXml(Bean80 object, XMLSerializer xmlSerializer, EventType currentEventType)
      throws Exception {
    ...
    if (object.valueBean!=null)  {
      ...
      bean80BindMap.serializeOnXml(object.valueBean, xmlSerializer, EventType.START_TAG);
    ...
    while (jacksonParser.nextToken() != JsonToken.END_OBJECT) {
      ...
      switch (fieldName) {
          case "valueBean":
            // field valueBean (mapped with "valueBean")
            if (jacksonParser.currentToken()==JsonToken.START_OBJECT) {
              instance.valueBean=bean80BindMap.parseOnJackson(jacksonParser);
            }
          break;
      ...
      switch (fieldName) {
          case "valueBean":
            ...
            if (jacksonParser.currentToken()==JsonToken.START_OBJECT || jacksonParser.currentToken()==JsonToken.VALUE_STRING) {
              instance.valueBean=bean80BindMap.parseOnJacksonAsString(jacksonParser);
            }
          break;
          case "valueBigDecimal":
            // field valueBigDecimal (mapped with "valueBigDecimal")
   ...
   */
  @Override
  public Bean80 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean80 instance = new Bean80();
          ...
          case START_TAG:
            ...
            switch(currentTag) {
                case "valueBean":
                  ...
                  instance.valueBean=bean80BindMap.parseOnXml(xmlParser, eventType);
                break;
                case "valueBigDecimal":
