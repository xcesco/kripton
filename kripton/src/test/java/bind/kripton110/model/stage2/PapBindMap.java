...
public class PapBindMap extends AbstractMapper<Pap> {
   ...
   */
  @Override
  public void serializeOnXml(Pap object, XMLSerializer xmlSerializer, EventType currentEventType)
      throws Exception {
   ...
   */
  @Override
  public Pap parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Pap instance = new Pap();
