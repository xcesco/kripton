...
public class Bean72BindMap extends AbstractMapper<Bean72> {
    ...
    if (object.valueBeanSet!=null)  {
      ...
      for (Bean72 item: object.valueBeanSet) {
        if (item==null) {
          ...
          bean72BindMap.serializeOnJackson(item, jacksonSerializer);
        }
      }
  ...
  @Override
  public int serializeOnJacksonAsString(Bean72 object, JsonGenerator jacksonSerializer) throws
      Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
      ...
      if (n>0) {
        ...
        for (Bean72 item: object.valueBeanSet) {
          if (item==null) {
            ...
            if (bean72BindMap.serializeOnJacksonAsString(item, jacksonSerializer)==0) {
   ...
   */
  @Override
  public void serializeOnXml(Bean72 object, XMLSerializer xmlSerializer, EventType currentEventType)
      throws Exception {
    ...
    if (object.valueBeanSet!=null)  {
      ...
      for (Bean72 item: object.valueBeanSet) {
        if (item==null) {
          ...
          bean72BindMap.serializeOnXml(item, xmlSerializer, EventType.START_TAG);
          xmlSerializer.writeEndElement();
        }
      }
      xmlSerializer.writeEndElement();
            ...
            if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
              ...
              while (jacksonParser.nextToken() != JsonToken.END_ARRAY) {
                if (jacksonParser.currentToken()==JsonToken.VALUE_NULL) {
                  ...
                  item=bean72BindMap.parseOnJackson(jacksonParser);
                }
                collection.add(item);
              }
            ...
            if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
              ...
              while (jacksonParser.nextToken() != JsonToken.END_ARRAY) {
                ...
                if (jacksonParser.currentToken()==JsonToken.VALUE_STRING && "null".equals(tempValue)) {
                  ...
                  item=bean72BindMap.parseOnJacksonAsString(jacksonParser);
                }
                collection.add(item);
              }
              instance.valueBeanSet=collection;
   ...
   */
  @Override
  public Bean72 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean72 instance = new Bean72();
                  ...
                  // property valueBeanSet (mapped on "valueBeanSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("item")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        ...
                        item=bean72BindMap.parseOnXml(xmlParser, eventType);
                      }
                      collection.add(item);
                    }
                    instance.valueBeanSet=collection;
