...
/**
 * This class is binder map for Bean72A
 *
 * @see Bean72A
 */
...
public class Bean72ABindMap extends AbstractMapper<Bean72A> {
  ...
  @Override
  public int serializeOnJacksonAsString(Bean72A object, JsonGenerator jacksonSerializer) throws
      Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(Bean72A object, XMLSerializer xmlSerializer,
    ...
    if (object.valueBeanSet!=null)  {
      ...
      for (Bean72A item: object.valueBeanSet) {
        if (item==null) {
          ...
          bean72ABindMap.serializeOnXml(item, xmlSerializer, EventType.START_TAG);
          xmlSerializer.writeEndElement();
        }
      }
   ...
   */
  @Override
  public Bean72A parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean72A instance = new Bean72A();
            ...
            switch(currentTag) {
                ...
                case "valueBeanSet":
                  // property valueBeanSet (mapped on "valueBeanSet")
                   {
                    HashSet<Bean72A> collection=CollectionUtils.merge(new HashSet<>(), instance.valueBeanSet);
                    Bean72A item;
                    // add first element
                    item=null;
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueBeanSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                  ...
                  // property valueBigDecimalSet (mapped on "valueBigDecimalSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueBigDecimalSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                  ...
                  // property valueBigIntegerSet (mapped on "valueBigIntegerSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueBigIntegerSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                  ...
                  // property valueByteSet (mapped on "valueByteSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueByteSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                  ...
                  // property valueCharacterSet (mapped on "valueCharacterSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueCharacterSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                  ...
                  // property valueDoubleSet (mapped on "valueDoubleSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueDoubleSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                ...
                case "valueEnumSet":
                  // property valueEnumSet (mapped on "valueEnumSet")
                   {
                    HashSet<Enum72> collection=CollectionUtils.merge(new HashSet<>(), instance.valueEnumSet);
                    Enum72 item;
                    // add first element
                    item=null;
                    if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueEnumSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                  ...
                  // property valueFloatSet (mapped on "valueFloatSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueFloatSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                  ...
                  // property valueIntSet (mapped on "valueIntSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueIntSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                  ...
                  // property valueLongSet (mapped on "valueLongSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueLongSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                  ...
                  // property valueShortSet (mapped on "valueShortSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueShortSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
                  ...
                  // property valueStringSet (mapped on "valueStringSet")
                   {
                    ...
                    while (xmlParser.nextTag() != EventType.END_TAG && xmlParser.getName().toString().equals("valueStringSet")) {
                      if (XmlAttributeUtils.isEmptyTag(xmlParser)) {
                        item=null;
                        xmlParser.nextTag();
                      } else {
