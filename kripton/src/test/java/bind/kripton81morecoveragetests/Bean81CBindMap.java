...
public class Bean81CBindMap extends AbstractMapper<Bean81C> {
   ...
   */
  @Override
  public void serializeOnXml(Bean81C object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean81C parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean81C instance = new Bean81C();
