...
public class Bean81ABindMap extends AbstractMapper<Bean81A> {
   ...
   */
  @Override
  public void serializeOnXml(Bean81A object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean81A parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean81A instance = new Bean81A();
