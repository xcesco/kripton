...
public class Bean81OBindMap extends AbstractMapper<Bean81O> {
   ...
   */
  @Override
  public void serializeOnXml(Bean81O object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean81O parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean81O instance = new Bean81O();
