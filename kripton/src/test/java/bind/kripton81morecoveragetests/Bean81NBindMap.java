...
public class Bean81NBindMap extends AbstractMapper<Bean81N> {
   ...
   */
  @Override
  public void serializeOnXml(Bean81N object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean81N parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean81N instance = new Bean81N();
