...
public class Bean81V3BindMap extends AbstractMapper<Bean81V3> {
   ...
   */
  @Override
  public void serializeOnXml(Bean81V3 object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean81V3 parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean81V3 instance = new Bean81V3();
