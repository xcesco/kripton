...
public class Bean81TBindMap extends AbstractMapper<Bean81T> {
   ...
   */
  @Override
  public void serializeOnXml(Bean81T object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean81T parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean81T instance = new Bean81T();
