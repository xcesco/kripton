...
public class Bean81GBindMap extends AbstractMapper<Bean81G> {
   ...
   */
  @Override
  public void serializeOnXml(Bean81G object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean81G parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean81G instance = new Bean81G();
