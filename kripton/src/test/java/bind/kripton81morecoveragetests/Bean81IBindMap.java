...
public class Bean81IBindMap extends AbstractMapper<Bean81I> {
   ...
   */
  @Override
  public void serializeOnXml(Bean81I object, XMLSerializer xmlSerializer,
   ...
   */
  @Override
  public Bean81I parseOnXml(XMLParser xmlParser, EventType currentEventType) throws Exception {
    Bean81I instance = new Bean81I();
