...
public class BarChart extends View {
    ...
    private void init(Context context) {
        ...
        mPaints[0].setColor(Color.parseColor("#EF9A9A"));

        mPaints[1] = new Paint();
        mPaints[1].setColor(Color.parseColor("#9FA8DA"));

        mPaints[2] = new Paint();
        mPaints[2].setColor(Color.parseColor("#80DEEA"));

        mPaints[3] = new Paint();
        mPaints[3].setColor(Color.parseColor("#A5D6A7"));

        mPaints[4] = new Paint();
        mPaints[4].setColor(Color.parseColor("#FFE082"));
