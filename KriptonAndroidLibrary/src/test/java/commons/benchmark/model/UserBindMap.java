...
public class UserBindMap extends AbstractMapper<User> {
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, User object, JacksonWrapperSerializer wrapper) {
    try {
      ...
      if (object.friends!=null)  {
        ...
        for (int i=0; i<n; i++) {
          ...
          if (item==null) {
            ...
            friendBindMap().serializeOnJackson(context, item, wrapper);
          }
        }
      ...
      if (object.images!=null)  {
        ...
        for (int i=0; i<n; i++) {
          ...
          if (item==null) {
            ...
            imageBindMap().serializeOnJackson(context, item, wrapper);
          }
        }
        jacksonSerializer.writeEndArray();
      }
      ...
      if (object.name!=null)  {
        ...
        nameBindMap().serializeOnJackson(context, object.name, wrapper);
      }
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, User object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
        ...
        if (n>0) {
          ...
          for (int i=0; i<n; i++) {
            ...
            if (item==null) {
              ...
              if (friendBindMap().serializeOnJacksonAsString(context, item, wrapper)==0) {
        ...
        if (n>0) {
          ...
          for (int i=0; i<n; i++) {
            ...
            if (item==null) {
              ...
              if (imageBindMap().serializeOnJacksonAsString(context, item, wrapper)==0) {
      ...
      if (object.name!=null)  {
        fieldCount++;
        jacksonSerializer.writeFieldName("name");
        if (nameBindMap().serializeOnJacksonAsString(context, object.name, wrapper)==0) {
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, User object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
      ...
      if (object.friends!=null)  {
        ...
        for (int i=0; i<n; i++) {
          ...
          if (item==null) {
            ...
            friendBindMap().serializeOnXml(context, item, wrapper, 2);
            xmlSerializer.writeEndElement();
          }
        }
      ...
      if (object.images!=null)  {
        ...
        for (int i=0; i<n; i++) {
          ...
          if (item==null) {
            ...
            imageBindMap().serializeOnXml(context, item, wrapper, 2);
            xmlSerializer.writeEndElement();
          }
        }
        // to distinguish between first empty element and empty collection, we write an attribute emptyCollection
      ...
      if (object.name!=null)  {
        ...
        nameBindMap().serializeOnXml(context, object.name, wrapper, 2);
        xmlSerializer.writeEndElement();
      }
   ...
   */
  @Override
  public User parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      ...
      while (jacksonParser.nextToken() != JsonToken.END_OBJECT) {
        ...
        switch (fieldName) {
              ...
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                while (jacksonParser.nextToken() != JsonToken.END_ARRAY) {
                  if (jacksonParser.currentToken()==JsonToken.VALUE_NULL) {
                    ...
                    item=friendBindMap().parseOnJackson(context, wrapper);
                  }
                  collection.add(item);
                }
              ...
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                while (jacksonParser.nextToken() != JsonToken.END_ARRAY) {
                  if (jacksonParser.currentToken()==JsonToken.VALUE_NULL) {
                    ...
                    item=imageBindMap().parseOnJackson(context, wrapper);
                  }
                  collection.add(item);
                }
            ...
            case "name":
              // field name (mapped with "name")
              if (jacksonParser.currentToken()==JsonToken.START_OBJECT) {
                instance.name=nameBindMap().parseOnJackson(context, wrapper);
              }
            break;
            case "phone":
              // field phone (mapped with "phone")
   ...
   */
  @Override
  public User parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      User instance = createInstance();
      String fieldName;
        ...
        switch (fieldName) {
              ...
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                while (jacksonParser.nextToken() != JsonToken.END_ARRAY) {
                  ...
                  if (jacksonParser.currentToken()==JsonToken.VALUE_STRING && "null".equals(tempValue)) {
                    ...
                    item=friendBindMap().parseOnJacksonAsString(context, wrapper);
                  }
                  collection.add(item);
                }
                instance.friends=collection;
              ...
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                while (jacksonParser.nextToken() != JsonToken.END_ARRAY) {
                  ...
                  if (jacksonParser.currentToken()==JsonToken.VALUE_STRING && "null".equals(tempValue)) {
                    ...
                    item=imageBindMap().parseOnJacksonAsString(context, wrapper);
                  }
                  collection.add(item);
                }
                instance.images=collection;
            ...
            case "name":
              ...
              if (jacksonParser.currentToken()==JsonToken.START_OBJECT || jacksonParser.currentToken()==JsonToken.VALUE_STRING) {
                instance.name=nameBindMap().parseOnJacksonAsString(context, wrapper);
              }
            break;
            case "phone":
              // field phone (mapped with "phone")
   ...
   */
  @Override
  public User parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
            ...
            case XmlPullParser.START_TAG:
              ...
              switch(currentTag) {
                    ...
                    // property friends (mapped on "friends")
                     {
                      ...
                      if (xmlParser.isEmptyElement()) {
                        ...
                        item=friendBindMap().parseOnXml(context, wrapper, eventType);
                        collection.add(item);
                      }
                    ...
                    // property images (mapped on "images")
                     {
                      ...
                      if (xmlParser.isEmptyElement()) {
                        ...
                        item=imageBindMap().parseOnXml(context, wrapper, eventType);
                        collection.add(item);
                      }
                  ...
                  case "name":
                    ...
                    instance.name=nameBindMap().parseOnXml(context, wrapper, eventType);
                  break;
                  case "phone":
