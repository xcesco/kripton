 ...
 * @see BindBenchmarkDataSource
 */
public abstract class BindBenchmarkAsyncTask<I, U, R> {
  /**
   ...
   */
  public BindBenchmarkAsyncTask(boolean readOnlyTask) {
   ...
   */
  public abstract R onExecute(BindBenchmarkDaoFactory daoFactory);
  ...
  public void execute(@SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindBenchmarkAsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindBenchmarkDataSource dataSource=BindBenchmarkDataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindBenchmarkAsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindBenchmarkAsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindBenchmarkDataSource
   */
  public abstract static class Simple<R> extends BindBenchmarkAsyncTask<Void, Void, R> {
  }
}
