 ...
 * @see BindBean8DataSource
 * @see BindAsyncTaskType
 */
public abstract class BindBean8AsyncTask<I, U, R> {
  /**
   ...
   */
  public BindBean8AsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindBean8DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindBean8AsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindBean8DataSource dataSource=BindBean8DataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindBean8AsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindBean8AsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindBean8DataSource
   */
  public abstract static class Simple<R> extends BindBean8AsyncTask<Void, Void, R> {
  }
}
