 ...
 * @see BindError16DataSource
 * @see BindAsyncTaskType
 */
public abstract class BindError16AsyncTask<I, U, R> {
  /**
   ...
   */
  public BindError16AsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindError16DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindError16AsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindError16DataSource dataSource=BindError16DataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindError16AsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindError16AsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindError16DataSource
   */
  public abstract static class Simple<R> extends BindError16AsyncTask<Void, Void, R> {
    /**
