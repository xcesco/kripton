...
public abstract class JsonMapper<E> extends AbstractMapper<E> {
     ...
     */
	public abstract E parse(BinderParser parser) throws IOException;
     ...
     * @param jsonParser The pre-configured JsonParser
     */
	public abstract void parseField(E instance, String fieldName) throws IOException;
     ...
     */
	public abstract void serialize(E object, BinderGenerator generator, boolean writeStartAndEnd) throws IOException;
    ...
    public E parse(InputStream is) throws IOException {
        JsonParser jsonParser = binderFactory.createParser(is);
    ...
    public E parse(byte[] byteArray) throws IOException {
        JsonParser jsonParser = binderFactory.createParser(byteArray);
        jsonParser.nextToken();
        return parse(jsonParser);
    }
    ...
    public E parse(char[] charArray) throws IOException {
        JsonParser jsonParser = binderFactory.createParser(charArray);
        jsonParser.nextToken();
        return parse(jsonParser);
    }
    ...
    public E parse(String jsonString) throws IOException {
        JsonParser jsonParser = binderFactory.createParser(jsonString);
        jsonParser.nextToken();
        return parse(jsonParser);
    }
    ...
    public String serialize(E object) throws IOException {
        ...
        JsonGenerator jsonGenerator = binderFactory.createGenerator(sw);
    ...
    public void serialize(E object, OutputStream os) throws IOException {
        JsonGenerator jsonGenerator = binderFactory.createGenerator(os);
        serialize(object, jsonGenerator, true);
        jsonGenerator.close();
    }
