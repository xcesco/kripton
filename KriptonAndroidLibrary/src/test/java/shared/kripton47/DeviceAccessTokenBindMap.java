...
public class DeviceAccessTokenBindMap extends AbstractMapper<DeviceAccessToken> {
   ...
   */
  @Override
  public void serializeOnXml(BinderContext context, DeviceAccessToken object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public DeviceAccessToken parseOnXml(BinderContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
