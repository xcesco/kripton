...
public abstract class BindDummy01AsyncTask<I, U, R> {
   ...
   */
  public BindDummy01AsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindDummy01DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindDummy01AsyncTask.this.onProgressUpdate(values);
      }
