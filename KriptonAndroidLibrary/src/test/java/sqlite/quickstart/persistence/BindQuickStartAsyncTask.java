 ...
 * @see BindQuickStartDataSource
 * @see BindAsyncTaskType
 */
public abstract class BindQuickStartAsyncTask<I, U, R> {
  /**
   ...
   * </p>
   */
  public BindQuickStartAsyncTask() {
   ...
   */
  public BindQuickStartAsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindQuickStartDataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindQuickStartAsyncTask.this.onPreExecute();
      }
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindQuickStartAsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindQuickStartAsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindQuickStartDataSource
   */
  public abstract static class Simple<R> extends BindQuickStartAsyncTask<Void, Void, R> {
  }
}
