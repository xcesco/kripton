...
public class BindDummy08DataSource extends AbstractDataSource implements BindDummy08DaoFactory, Dummy08DataSource {
   ...
   */
  public static synchronized BindDummy08DataSource build(DataSourceOptions options) {
    if (instance==null) {
      instance=new BindDummy08DataSource(options);
    }
    return instance;
   ...
   */
  public static synchronized BindDummy08DataSource build() {
  ...
  class DataSourceSingleThread implements BindDummy08DaoFactory {
    ...
    private DaoBeanDeleteOKImpl _daoBeanDeleteOK;

    DataSourceSingleThread() {
      _context=new SQLContextInTransactionImpl(BindDummy08DataSource.this);
    }
