 ...
 * @see BindDummy04DataSource
 * @see BindAsyncTaskType
 */
public abstract class BindDummy04AsyncTask<I, U, R> {
  /**
   ...
   */
  public BindDummy04AsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindDummy04DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindDummy04AsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindDummy04DataSource dataSource=BindDummy04DataSource.instance();
        R result=null;
      ...
      public void onPostExecute(R result) {
        BindDummy04AsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindDummy04DataSource
   */
  public abstract static class Simple<R> extends BindDummy04AsyncTask<Void, Void, R> {
  }
}
