...
public abstract class BindDummy08AsyncTask<I, U, R> {
   ...
   */
  public BindDummy08AsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindDummy08DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindDummy08AsyncTask.this.onProgressUpdate(values);
      }
