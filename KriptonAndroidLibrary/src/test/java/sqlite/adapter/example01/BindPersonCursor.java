...
public class BindPersonCursor {
  ...
  public BindPersonCursor wrap(Cursor cursor) {
    ...
    index3=cursor.getColumnIndex("birth_date");
      ...
      do
       {
        ...
        if (index3>=0 && !cursor.isNull(index3)) { resultBean.setBirthDate(DateUtils.read(cursor.getString(index3)));}
      ...
      do
       {
        ...
        if (index3>=0) { resultBean.setBirthDate(null);}
