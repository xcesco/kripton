 ...
 * @see BindExample01DataSource
 * @see BindAsyncTaskType
 */
public abstract class BindExample01AsyncTask<I, U, R> {
  /**
   ...
   */
  public BindExample01AsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindExample01DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindExample01AsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindExample01DataSource dataSource=BindExample01DataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindExample01AsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindExample01AsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindExample01DataSource
   */
  public abstract static class Simple<R> extends BindExample01AsyncTask<Void, Void, R> {
    /**
