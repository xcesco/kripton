 ...
 * @see BindPetUserDataSource
 * @see BindAsyncTaskType
 */
public abstract class BindPetUserAsyncTask<I, U, R> {
  /**
   ...
   */
  public BindPetUserAsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindPetUserDataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindPetUserAsyncTask.this.onPreExecute();
      }
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindPetUserAsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindPetUserAsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindPetUserDataSource
   */
  public abstract static class Simple<R> extends BindPetUserAsyncTask<Void, Void, R> {
    /**
