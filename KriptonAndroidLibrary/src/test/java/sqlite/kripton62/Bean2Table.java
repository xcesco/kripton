...
/**
 * <p>
 * Entity <code>Bean2</code> is associated to table <code>bean2</code>
 * This class represents table associated to entity.
 * </p>
 *  @see Bean2
 */
public class Bean2Table {
  /**
   * Costant represents typeName of table bean2
   */
  public static final String TABLE_NAME = "bean2";
   ...
   * </p>
   *
   * <pre>CREATE TABLE bean2 (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, value TEXT, value_byte_set BLOB, value_short_set BLOB, value_integer_set BLOB, value_string_set BLOB, value_character_set BLOB, value_float_set BLOB, value_double_set BLOB, value_big_decimal_set BLOB, value_bean_set BLOB, value_enum_type_set BLOB);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE bean2 (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, value TEXT, value_byte_set BLOB, value_short_set BLOB, value_integer_set BLOB, value_string_set BLOB, value_character_set BLOB, value_float_set BLOB, value_double_set BLOB, value_big_decimal_set BLOB, value_bean_set BLOB, value_enum_type_set BLOB);";

  /**
   * <p>
   * DDL to drop table bean2
   * </p>
   *
   * <pre>DROP TABLE IF EXISTS bean2;</pre>
   */
  ...
  /**
   * Entity's property <code>valueShortSet</code> is associated to table column <code>value_short_set</code>. This costant represents column typeName.
   *
  ...
  /**
   * Entity's property <code>valueIntegerSet</code> is associated to table column <code>value_integer_set</code>. This costant represents column typeName.
   *
  ...
  /**
   * Entity's property <code>valueStringSet</code> is associated to table column <code>value_string_set</code>. This costant represents column typeName.
   *
  ...
  /**
   * Entity's property <code>valueCharacterSet</code> is associated to table column <code>value_character_set</code>. This costant represents column typeName.
   *
  ...
  /**
   * Entity's property <code>valueFloatSet</code> is associated to table column <code>value_float_set</code>. This costant represents column typeName.
   *
  ...
  /**
   * Entity's property <code>valueDoubleSet</code> is associated to table column <code>value_double_set</code>. This costant represents column typeName.
   *
  ...
  /**
   * Entity's property <code>valueBigDecimalSet</code> is associated to table column <code>value_big_decimal_set</code>. This costant represents column typeName.
   *
  ...
  /**
   * Entity's property <code>valueBeanSet</code> is associated to table column <code>value_bean_set</code>. This costant represents column typeName.
   *
  ...
  /**
   * Entity's property <code>valueEnumTypeSet</code> is associated to table column <code>value_enum_type_set</code>. This costant represents column typeName.
   *
