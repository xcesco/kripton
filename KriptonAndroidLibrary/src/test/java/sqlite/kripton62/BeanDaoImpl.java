...
public class BeanDaoImpl extends AbstractDao implements BeanDao {
  ...
  public long updateOne(Bean value) {
    ...
    // display log
    Logger.info("UPDATE bean SET value=:value, valueByteSet=:valueByteSet, valueShortSet=:valueShortSet, valueIntegerSet=:valueIntegerSet, valueStringSet=:valueStringSet, valueCharacterSet=:valueCharacterSet, valueFloatSet=:valueFloatSet, valueDoubleSet=:valueDoubleSet, valueBigDecimalSet=:valueBigDecimalSet, valueBeanSet=:valueBeanSet, valueEnumTypeSet=:valueEnumTypeSet WHERE id=?");
