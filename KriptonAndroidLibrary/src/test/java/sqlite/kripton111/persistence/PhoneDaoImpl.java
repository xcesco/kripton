...
public class PhoneDaoImpl extends AbstractDao implements PhoneDao {
  ...
  protected String SELECT_BY_ID_SQL1 = "SELECT id, action_type, number, country_code, contact_name, contact_id FROM phone_number WHERE id = ?";

  private SQLiteStatement deleteByIdPreparedStatement1;

  protected String SELECT_BY_NUMBER_SQL2 = "SELECT id, action_type, number, country_code, contact_name, contact_id FROM phone_number WHERE number = ?";

  protected String SELECT_ALL_SQL3 = "SELECT id, action_type, number, country_code, contact_name, contact_id FROM phone_number ORDER BY contact_name, number";
