...
public class FirstAidBindMap extends AbstractMapper<FirstAid> {
   ...
   */
  @Override
  public FirstAid createInstance() {
    return new FirstAid();
  }
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, FirstAid object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, FirstAid object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, FirstAid object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public FirstAid parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      FirstAid instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public FirstAid parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      FirstAid instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public FirstAid parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
