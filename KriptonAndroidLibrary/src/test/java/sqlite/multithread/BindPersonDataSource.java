...
/**
 * <p>
 * Represents implementation of datasource PersonDataSource. This class expose
...
public class BindPersonDataSource extends AbstractDataSource implements BindPersonDaoFactory, PersonDataSource {
	...
	/**
	 * <p>
	 * executes a transaction. This method is synchronized to avoid concurrent
	 * problems. The database will be open in write mode.
	 * </p>
	 *
	 * @param transaction
