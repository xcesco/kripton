...
public class BindDummy05DataSource extends AbstractDataSource implements BindDummy05DaoFactory, Dummy05DataSource {
   ...
   */
  public static synchronized BindDummy05DataSource build(DataSourceOptions options) {
    if (instance==null) {
      instance=new BindDummy05DataSource(options);
    }
    return instance;
   ...
   */
  public static synchronized BindDummy05DataSource build() {
  ...
  class DataSourceSingleThread implements BindDummy05DaoFactory {
    ...
    private DaoBean05Impl _daoBean05;

    DataSourceSingleThread() {
      _context=new SQLContextInTransactionImpl(BindDummy05DataSource.this);
    }
    ...
    public DaoBean05Impl getDaoBean05() {
      if (_daoBean05==null) {
        _daoBean05=new DaoBean05Impl(_context);
      }
      return _daoBean05;
    }
