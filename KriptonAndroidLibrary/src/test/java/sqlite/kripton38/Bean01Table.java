...
public class Bean01Table {
   ...
   * </p>
   *
   * <pre>CREATE TABLE bean01 (temp BLOB, id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, text TEXT);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE bean01 (temp BLOB, id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, text TEXT);";
  ...
  /**
   * Entity's property <code>temp</code> is associated to table column <code>temp</code>. This costant represents column typeName.
   *
   *  @see Bean01#temp
   */
