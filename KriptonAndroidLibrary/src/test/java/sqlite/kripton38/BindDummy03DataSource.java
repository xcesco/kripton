...
/**
 * <p>
 * Rapresents implementation of datasource Dummy03DataSource.
...
public class BindDummy03DataSource extends AbstractDataSource implements BindDummy03DaoFactory, Dummy03DataSource {
  ...
  public static BindDummy03DataSource instance() {
    if (instance==null) {
      instance=new BindDummy03DataSource();
    }
    return instance;
  }
   ...
   */
  public static Dummy03DataSource build(DataSourceOptions options) {
    if (instance==null) {
