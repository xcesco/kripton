 ...
 * @see BindDummy03DataSource
 * @see BindAsyncTaskType
 */
public abstract class BindDummy03AsyncTask<I, U, R> {
  /**
   ...
   */
  public BindDummy03AsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindDummy03DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindDummy03AsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindDummy03DataSource dataSource=BindDummy03DataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindDummy03AsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindDummy03AsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindDummy03DataSource
   */
  public abstract static class Simple<R> extends BindDummy03AsyncTask<Void, Void, R> {
    /**
