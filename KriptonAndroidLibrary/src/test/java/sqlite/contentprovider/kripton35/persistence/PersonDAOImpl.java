...
public class PersonDAOImpl extends AbstractDao implements PersonDAO {
  ...
  /**
   * <h2>SQL insert</h2>
   * <pre>INSERT INTO person (alias_parent_id, birth_city, birth_day, value, name, surname) VALUES (${parentId}, ${birthCity}, ${birthDay}, ${value}, ${tempName}, ${surname})</pre>
   *
   * <h2>Inserted columns:</strong></h2>
   * <dl>
   * 	<dt>alias_parent_id</dt><dd>is binded to query's parameter <strong>${parentId}</strong> and method's parameter <strong>parentId</strong></dd>
   ...
   *
   * <h2>JQL INSERT for Content Provider</h2>
   * <pre>INSERT INTO Person (parentId, birthCity, birthDay, value, name, surname) VALUES (${parentId}, ${birthCity}, ${birthDay}, ${value}, ${name}, ${surname})</pre>
   *
   * <h2>SQL INSERT for Content Provider</h2>
   * <pre>INSERT INTO person (alias_parent_id, birth_city, birth_day, value, name, surname) VALUES (${parentId}, ${birthCity}, ${birthDay}, ${value}, ${name}, ${surname})</pre>
   *
  ...
  /**
   * <h1>Content provider URI (DELETE operation):</h1>
   * <pre>content://sqlite.contentprovider.kripton35/persons/test0/#</pre>
   *
   * <h2>JQL DELETE for Content Provider</h2>
   * <pre>DELETE FROM Person WHERE id = ${id} AND #{DYNAMIC_WHERE}</pre>
   *
   ...
   * <p><strong>In URI, * is replaced with [*] for javadoc rapresentation</strong></p>
   *
   * @param uri "content://sqlite.contentprovider.kripton35/persons/test0/#"
  ...
  /**
   * <h2>SQL delete:</h2>
   * <pre>DELETE person WHERE WHERE id = ${bean.id}</pre>
   *
  ...
  /**
   * <h1>Content provider URI (DELETE operation):</h1>
   * <pre>content://sqlite.contentprovider.kripton35/persons/test1/#</pre>
   *
   * <h2>JQL DELETE for Content Provider</h2>
   ...
   * <p><strong>In URI, * is replaced with [*] for javadoc rapresentation</strong></p>
   *
   * @param uri "content://sqlite.contentprovider.kripton35/persons/test1/#"
   * @param selection dynamic part of <code>where</code> statement <b>NOT USED</b>
   * @param selectionArgs arguments of dynamic part of <code>where</code> statement <b>NOT USED</b>
   * @return number of effected rows
   */
  ...
  int updateRaw5(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
    ...
    for (String columnName:contentValues.keySet()) {
      if (!updateRaw5ColumnSet.contains(columnName)) {
        throw new KriptonRuntimeException(String.format("For URI 'content://sqlite.contentprovider.kripton35/persons/test0/#', column '%s' does not exists in table '%s' or can not be defined in this UPDATE operation", columnName, "person" ));
      }
    }
  ...
  int updateRaw6(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
    ...
    for (String columnName:contentValues.keySet()) {
      if (!updateRaw6ColumnSet.contains(columnName)) {
        throw new KriptonRuntimeException(String.format("For URI 'content://sqlite.contentprovider.kripton35/persons/test1/#', column '%s' does not exists in table '%s' or can not be defined in this UPDATE operation", columnName, "person" ));
      }
    }
  ...
  /**
   * <h1>Content provider URI (UPDATE operation):</h1>
   * <pre>content://sqlite.contentprovider.kripton35/persons/test2/#</pre>
   *
   * <h2>JQL UPDATE for Content Provider</h2>
   * <pre>UPDATE Person SET name=${name} WHERE id=${id} AND #{DYNAMIC_WHERE}</pre>
   *
   ...
   * <p><strong>In URI, * is replaced with [*] for javadoc rapresentation</strong></p>
   *
   * @param uri "content://sqlite.contentprovider.kripton35/persons/test2/#"
   * @param contentValues content values
   * @param selection dynamic part of <code>where</code> statement 
   * @param selectionArgs arguments of dynamic part of <code>where</code> statement 
   * @return number of effected rows
  ...
  int updateRaw7(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
    ...
    for (String columnName:contentValues.keySet()) {
      if (!updateRaw7ColumnSet.contains(columnName)) {
        throw new KriptonRuntimeException(String.format("For URI 'content://sqlite.contentprovider.kripton35/persons/test2/#', column '%s' does not exists in table '%s' or can not be defined in this UPDATE operation", columnName, "person" ));
      }
    }
  ...
  /**
   * <h2>SQL update:</h2>
   * <pre>UPDATE person SET alias_parent_id=${person.parentId}, birth_city=${person.birthCity}, birth_day=${person.birthDay}, value=${person.value}, name=${person.name}, surname=${person.surname} WHERE WHERE id=${person.id}</pre>
   *
  ...
  public int updateBean(Person person) {
    ...
    // display log
    Logger.info("UPDATE person SET parentId=:alias_parent_id, birthCity=:birth_city, birthDay=:birth_day, value=:value, name=:name, surname=:surname WHERE id=?");
  ...
  /**
   * <h1>Content provider URI (UPDATE operation):</h1>
   * <pre>content://sqlite.contentprovider.kripton35/persons/test3/#</pre>
   *
   * <h2>JQL UPDATE for Content Provider</h2>
   ...
   *
   * <h2>SQL UPDATE for Content Provider</h2>
   * <pre>UPDATE person SET alias_parent_id=${person.parentId}, birth_city=${person.birthCity}, birth_day=${person.birthDay}, value=${person.value}, name=${person.name}, surname=${person.surname} WHERE id=${person.id}</pre>
   *
   * <h3>Path variables defined:</h3>
   * <ul>
   ...
   * <p><strong>In URI, * is replaced with [*] for javadoc rapresentation</strong></p>
   *
   * @param uri "content://sqlite.contentprovider.kripton35/persons/test3/#"
   * @param contentValues content values
   * @param selection dynamic part of <code>where</code> statement <b>NOT USED</b>
   * @param selectionArgs arguments of dynamic part of <code>where</code> statement <b>NOT USED</b>
   * @return number of effected rows
  ...
  int updateBean8(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
    ...
    for (String columnName:contentValues.keySet()) {
      if (!updateBean8ColumnSet.contains(columnName)) {
        throw new KriptonRuntimeException(String.format("For URI 'content://sqlite.contentprovider.kripton35/persons/test3/#', column '%s' does not exists in table '%s' or can not be defined in this UPDATE operation", columnName, "person" ));
      }
    }
    ...
    if (projection!=null && projection.length>0) {
      for (String columnName:projection) {
        if (!selectOne9ColumnSet.contains(columnName)) {
          throw new KriptonRuntimeException(String.format("For URI 'content://sqlite.contentprovider.kripton35/persons/*/test0', column '%s' does not exists in table '%s' or can not be defined in this SELECT operation", columnName, "person" ));
        }
    ...
    if (projection!=null && projection.length>0) {
      for (String columnName:projection) {
        if (!selectOne11ColumnSet.contains(columnName)) {
          throw new KriptonRuntimeException(String.format("For URI 'content://sqlite.contentprovider.kripton35/persons/*/test1', column '%s' does not exists in table '%s' or can not be defined in this SELECT operation", columnName, "person" ));
        }
        _projectionBuffer.append(_columnSeparator + columnName);
        _columnSeparator=", ";
      }
    ...
    if (projection!=null && projection.length>0) {
      for (String columnName:projection) {
        if (!selectBean12ColumnSet.contains(columnName)) {
          throw new KriptonRuntimeException(String.format("For URI 'content://sqlite.contentprovider.kripton35/persons/test3', column '%s' does not exists in table '%s' or can not be defined in this SELECT operation", columnName, "person" ));
        }
        _projectionBuffer.append(_columnSeparator + columnName);
        _columnSeparator=", ";
      }
