...
public class PersonDAOImpl extends AbstractDao implements PersonDAO {
	...
	public Cursor selectBeanListener(String[] projection, String sortOrder) {
		Cursor cursor = database().query(true, PersonTable.TABLE_NAME, projection, null, null, null, null, sortOrder, null, null);
		return cursor;
	}
