 ...
 * @see BindPerson1DataSource
 * @see BindAsyncTaskType
 */
public abstract class BindPerson1AsyncTask<I, U, R> {
  /**
   ...
   */
  public BindPerson1AsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindPerson1DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindPerson1AsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindPerson1DataSource dataSource=BindPerson1DataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindPerson1AsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindPerson1AsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindPerson1DataSource
   */
  public abstract static class Simple<R> extends BindPerson1AsyncTask<Void, Void, R> {
    /**
