 ...
 * @see BindErr2UpdateDataSource
 */
public abstract class BindErr2UpdateAsyncTask<I, U, R> {
  /**
   ...
   * </p>
   */
  public BindErr2UpdateAsyncTask() {
    this(true);}
   ...
   */
  public BindErr2UpdateAsyncTask(boolean readOnlyTask) {
   ...
   */
  public abstract R onExecute(BindErr2UpdateDataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindErr2UpdateAsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindErr2UpdateDataSource dataSource=BindErr2UpdateDataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindErr2UpdateAsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindErr2UpdateAsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindErr2UpdateDataSource
   */
  public abstract static class Simple<R> extends BindErr2UpdateAsyncTask<Void, Void, R> {
  }
}
