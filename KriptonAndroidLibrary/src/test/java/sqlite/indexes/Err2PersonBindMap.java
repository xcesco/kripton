...
/**
 * This class is the shared preference binder defined for Err2Person
 *
 * @see Err2Person
 */
@BindMap(Err2Person.class)
public class Err2PersonBindMap extends AbstractMapper<Err2Person> {
  /**
   * reset shared preferences
   */
  @Override
  public int serializeOnJackson(Err2Person object, JsonGenerator jacksonSerializer) throws Exception {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(Err2Person object, JsonGenerator jacksonSerializer) throws Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(Err2Person object, XMLSerializer xmlSerializer, int currentEventType) throws Exception {
    if (currentEventType == 0) {
      xmlSerializer.writeStartElement("err2Person");
    }
   ...
   */
  @Override
  public Err2Person parseOnJackson(JsonParser jacksonParser) throws Exception {
    Err2Person instance = new Err2Person();
    String fieldName;
   ...
   */
  @Override
  public Err2Person parseOnJacksonAsString(JsonParser jacksonParser) throws Exception {
    Err2Person instance = new Err2Person();
    String fieldName;
   ...
   */
  @Override
  public Err2Person parseOnXml(XMLParser xmlParser, int currentEventType) throws Exception {
    Err2Person instance = new Err2Person();
