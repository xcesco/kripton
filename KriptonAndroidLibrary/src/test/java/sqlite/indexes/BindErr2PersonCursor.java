...
/**
 * <p>
 * Cursor implementation for entity <code>Err2Person</code>
 * </p>
 *  @see Err2Person
 */
public class BindErr2PersonCursor {
  /**
   ...
   */
  BindErr2PersonCursor(Cursor cursor) {
    wrap(cursor);
  }
   ...
   */
  public BindErr2PersonCursor wrap(Cursor cursor) {
    this.cursor=cursor;
   ...
   */
  public LinkedList<Err2Person> execute() {
   ...
   */
  public void executeListener(OnErr2PersonListener listener) {
    Err2Person resultBean=new Err2Person();
   ...
   */
  public static BindErr2PersonCursor create(Cursor cursor) {
    return new BindErr2PersonCursor(cursor);
  }

  /**
   * <p>Listener for row read from database.</p>
   */
  public interface OnErr2PersonListener {
    /**
     ...
     */
    void onRow(Err2Person bean, int rowPosition, int rowCount);
  }
}
