 ...
 * @see BindErr2PersonDataSource
 */
public abstract class BindErr2PersonAsyncTask<I, U, R> {
  /**
   ...
   * </p>
   */
  public BindErr2PersonAsyncTask() {
    this(true);}
   ...
   */
  public BindErr2PersonAsyncTask(boolean readOnlyTask) {
   ...
   */
  public abstract R onExecute(BindErr2PersonDataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindErr2PersonAsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindErr2PersonDataSource dataSource=BindErr2PersonDataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindErr2PersonAsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindErr2PersonAsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindErr2PersonDataSource
   */
  public abstract static class Simple<R> extends BindErr2PersonAsyncTask<Void, Void, R> {
  }
}
