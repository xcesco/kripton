 ...
 * @see BindPersonUpdateDataSource
 * @see BindAsyncTaskType
 */
public abstract class BindPersonUpdateAsyncTask<I, U, R> {
  /**
   ...
   * </p>
   */
  public BindPersonUpdateAsyncTask() {
   ...
   */
  public BindPersonUpdateAsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindPersonUpdateDataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindPersonUpdateAsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindPersonUpdateDataSource dataSource=BindPersonUpdateDataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindPersonUpdateAsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindPersonUpdateAsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindPersonUpdateDataSource
   */
  public abstract static class Simple<R> extends BindPersonUpdateAsyncTask<Void, Void, R> {
    /**
