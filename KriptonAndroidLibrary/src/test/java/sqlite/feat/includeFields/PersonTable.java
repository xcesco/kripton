...
public class PersonTable {
   ...
   * </p>
   *
   * <pre> DROP INDEX idx_person_name; DROP INDEX idx_person_1;DROP TABLE IF EXISTS person;</pre>
   */
  public static final String DROP_TABLE_SQL = " DROP INDEX idx_person_name; DROP INDEX idx_person_1;DROP TABLE IF EXISTS person;";
