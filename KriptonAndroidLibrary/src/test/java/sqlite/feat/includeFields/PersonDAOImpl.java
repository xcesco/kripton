...
public class PersonDAOImpl extends AbstractDao implements PersonDAO {
  ...
  public void updateIncludeOne(Person bean) {
    ...
    // generate sql
    String _sql=String.format("UPDATE person SET name=?, id=?");
  ...
  public void updateExcludeOne(Person bean) {
    ...
    // generate sql
    String _sql=String.format("UPDATE person SET surname=?, birth_city=?, birth_day=?, type_name=?");
  ...
  public void deleteIncludeOne(Person bean) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM person");
