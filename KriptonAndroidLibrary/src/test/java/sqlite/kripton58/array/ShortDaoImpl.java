...
public class ShortDaoImpl extends AbstractDao implements ShortDao {
  ...
  public long updateOne(long id, short[] value, Short[] value2) {
    ...
    // generate sql
    String _sql=String.format("UPDATE short_bean SET id=? WHERE value=? and value2=?");
    ...
    // log for where parameters -- END
    int result = database().update("short_bean", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
  ...
  public long delete(short[] value, Short[] value2) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM short_bean WHERE value=? and value2=?");
    ...
    // log for where parameters -- END
    int result = database().delete("short_bean", _sqlWhereStatement, _contentValues.whereArgsAsArray());
    return result;
  }
