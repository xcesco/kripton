...
public class ByteDaoImpl extends AbstractDao implements ByteDao {
  ...
  public ByteBean selectOne(byte[] value, Byte[] value2) {
    ...
    //StringUtils, SqlUtils will be used in case of dynamic parts of SQL
    Logger.info(SqlUtils.formatSQL("SELECT id, value, value2 FROM byte_bean WHERE value='%s' and value2='%s'",(Object[])_args));
    try (Cursor cursor = database().rawQuery("SELECT id, value, value2 FROM byte_bean WHERE value=? and value2=?", _args)) {
      Logger.info("Rows found: %s",cursor.getCount());
  ...
  public long updateOne(long id, byte[] value, Byte[] value2) {
    ...
    Logger.info(SqlUtils.formatSQL("UPDATE byte_bean SET id='"+StringUtils.checkSize(contentValues.get("id"))+"' WHERE value=%s and value2=%s", (Object[])whereConditionsArray));
  ...
  public long insert(long id, byte[] value, Byte[] value2) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    // log
    Logger.info(SqlUtils.formatSQL("INSERT INTO byte_bean (id, value, value2) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"', '"+StringUtils.checkSize(contentValues.get("value2"))+"')"));
  ...
  /**
   * <h2>SQL delete:</h2>
   * <pre>DELETE byte_bean WHERE value=${value} and value2=${value2}</pre></pre>
   *
   * <h2>Where parameters:</h2>
   * <dl>
   * 	<dt>${value}</dt><dd>is mapped to method's parameter <strong>value</strong></dd>
  ...
  public long delete(byte[] value, Byte[] value2) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    Logger.info(SqlUtils.formatSQL("DELETE byte_bean WHERE value=%s and value2=%s", (Object[])whereConditionsArray));
