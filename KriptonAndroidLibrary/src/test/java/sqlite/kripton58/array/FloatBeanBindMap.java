...
public class FloatBeanBindMap extends AbstractMapper<FloatBean> {
   ...
   */
  @Override
  public FloatBean createInstance() {
    return new FloatBean();
  }
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, FloatBean object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, FloatBean object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, FloatBean object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public FloatBean parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      FloatBean instance = createInstance();
      String fieldName;
        ...
        switch (fieldName) {
            ...
            case "value":
              ...
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                instance.value=CollectionUtils.asFloatTypeArray(collection);
              }
            break;
            case "value2":
              // field value2 (mapped with "value2")
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                instance.value2=CollectionUtils.asFloatArray(collection);
              }
            break;
            default:
              jacksonParser.skipChildren();
   ...
   */
  @Override
  public FloatBean parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      FloatBean instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public FloatBean parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
