...
public class CharDaoImpl extends AbstractDao implements CharDao {
  ...
  protected String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM char_bean WHERE value=? and value2=?";

  protected String SELECT_ONE_SQL3 = "SELECT id, value, value2 FROM char_bean WHERE value=? and value2=?";

  protected String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM char_bean WHERE value=? and value2=?";

  protected String SELECT_LIST_SQL5 = "SELECT id, value, value2 FROM char_bean WHERE value=? and value2=?";
