...
public class IntDaoImpl extends AbstractDao implements IntDao {
  ...
  public long updateOne(long id, int[] value, Integer[] value2) {
    ...
    // generate sql
    String _sql=String.format("UPDATE int_bean SET id=? WHERE value=? and value2=?");
    ...
    // log for where parameters -- END
    int result = database().update("int_bean", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
  ...
  public long delete(int[] value, Integer[] value2) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM int_bean WHERE value=? and value2=?");
    ...
    // log for where parameters -- END
    int result = database().delete("int_bean", _sqlWhereStatement, _contentValues.whereArgsAsArray());
    return result;
  }
