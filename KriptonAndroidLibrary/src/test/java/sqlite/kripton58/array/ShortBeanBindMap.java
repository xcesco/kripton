...
public class ShortBeanBindMap extends AbstractMapper<ShortBean> {
   ...
   */
  @Override
  public ShortBean createInstance() {
    return new ShortBean();
  }
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, ShortBean object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, ShortBean object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, ShortBean object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public ShortBean parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      ShortBean instance = createInstance();
      String fieldName;
        ...
        switch (fieldName) {
            ...
            case "value":
              ...
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                instance.value=CollectionUtils.asShortTypeArray(collection);
              }
            break;
            case "value2":
              // field value2 (mapped with "value2")
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                instance.value2=CollectionUtils.asShortArray(collection);
              }
            break;
            default:
              jacksonParser.skipChildren();
   ...
   */
  @Override
  public ShortBean parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      ShortBean instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public ShortBean parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
