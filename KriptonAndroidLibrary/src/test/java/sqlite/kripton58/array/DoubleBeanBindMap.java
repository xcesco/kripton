...
public class DoubleBeanBindMap extends AbstractMapper<DoubleBean> {
   ...
   */
  @Override
  public DoubleBean createInstance() {
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, DoubleBean object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, DoubleBean object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, DoubleBean object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public DoubleBean parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      DoubleBean instance = createInstance();
      String fieldName;
        ...
        switch (fieldName) {
            ...
            case "value":
              ...
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                instance.value=CollectionUtils.asDoubleTypeArray(collection);
              }
            break;
            case "value2":
              // field value2 (mapped with "value2")
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                instance.value2=CollectionUtils.asDoubleArray(collection);
              }
            break;
            default:
              jacksonParser.skipChildren();
   ...
   */
  @Override
  public DoubleBean parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      DoubleBean instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public DoubleBean parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
