...
public class CharDaoImpl extends AbstractDao implements CharDao {
  ...
  public CharBean selectOne() {
    ...
    Logger.info(StringUtils.formatSQL("SELECT id, value, value2 FROM char_bean",(Object[])args));
  ...
  public long updateOne(long id, char[] value, Character[] value2) {
    ...
    Logger.info(StringUtils.formatSQL("UPDATE char_bean SET id='"+StringUtils.checkSize(contentValues.get("id"))+"' WHERE value=%s and value2=%s", (Object[])whereConditionsArray));
  ...
  public long insert(long id, char[] value, Character[] value2) {
    ...
    // log
    Logger.info(StringUtils.formatSQL("INSERT INTO char_bean (id, value, value2) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"', '"+StringUtils.checkSize(contentValues.get("value2"))+"')"));
  ...
  public long delete(char[] value, Character[] value2) {
    ...
    Logger.info(StringUtils.formatSQL("DELETE char_bean WHERE value=%s and value2=%s", (Object[])whereConditionsArray));
