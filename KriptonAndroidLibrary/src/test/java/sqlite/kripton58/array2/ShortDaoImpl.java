...
public class ShortDaoImpl extends AbstractDao implements ShortDao {
  ...
  public ShortBean selectOne() {
    ...
    Logger.info(SqlUtils.formatSQL("SELECT id, value, value2 FROM short_bean",(Object[])_args));
    try (Cursor cursor = database().rawQuery("SELECT id, value, value2 FROM short_bean", _args)) {
  ...
  public ShortBean selectOne(short[] value, Short[] value2) {
    ...
    //StringUtils, SqlUtils will be used in case of dynamic parts of SQL
    Logger.info(SqlUtils.formatSQL("SELECT id, value, value2 FROM short_bean WHERE value='%s' and value2='%s'",(Object[])_args));
    try (Cursor cursor = database().rawQuery("SELECT id, value, value2 FROM short_bean WHERE value=? and value2=?", _args)) {
      Logger.info("Rows found: %s",cursor.getCount());
  ...
  public long updateOne(long id, short[] value, Short[] value2) {
    ...
    Logger.info(SqlUtils.formatSQL("UPDATE short_bean SET id='"+StringUtils.checkSize(contentValues.get("id"))+"' WHERE value=%s and value2=%s", (Object[])whereConditionsArray));
  ...
  public long insert(long id, short[] value, Short[] value2) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    // log
    Logger.info(SqlUtils.formatSQL("INSERT INTO short_bean (id, value, value2) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"', '"+StringUtils.checkSize(contentValues.get("value2"))+"')"));
  ...
  public long insert(ShortBean bean) {
    ...
    if (bean.getValue()!=null) {
      contentValues.put("value", ShortBeanTable.serializeValue(bean.getValue()));
    } else {
      contentValues.putNull("value");
    }

    if (bean.getValue2()!=null) {
      contentValues.put("value2", ShortBeanTable.serializeValue2(bean.getValue2()));
    } else {
      contentValues.putNull("value2");
    }

    //StringUtils and SqlUtils will be used to format SQL
    Logger.info(SqlUtils.formatSQL("INSERT INTO short_bean (value, value2) VALUES ('"+StringUtils.checkSize(contentValues.get("value"))+"', '"+StringUtils.checkSize(contentValues.get("value2"))+"')"));
    long result = database().insert("short_bean", null, contentValues);
    bean.setId(result);
  ...
  /**
   * <h2>SQL delete:</h2>
   * <pre>DELETE short_bean WHERE value=${value} and value2=${value2}</pre></pre>
   *
   * <h2>Where parameters:</h2>
   * <dl>
   * 	<dt>${value}</dt><dd>is mapped to method's parameter <strong>value</strong></dd>
  ...
  public long delete(short[] value, Short[] value2) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    Logger.info(SqlUtils.formatSQL("DELETE short_bean WHERE value=%s and value2=%s", (Object[])whereConditionsArray));
