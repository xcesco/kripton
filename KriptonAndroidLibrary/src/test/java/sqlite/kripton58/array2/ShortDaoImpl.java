...
public class ShortDaoImpl extends AbstractDao implements ShortDao {
  ...
  public ShortBean selectOne() {
    ...
    Logger.info(SqlUtils.formatSQL("SELECT id, value, value2 FROM short_bean",(Object[])args));
    try (Cursor cursor = database().rawQuery("SELECT id, value, value2 FROM short_bean", args)) {
  ...
  public ShortBean selectOne(short[] value, Short[] value2) {
    ...
    //StringUtils, SqlUtils will be used in case of dynamic parts of SQL
    Logger.info(SqlUtils.formatSQL("SELECT id, value, value2 FROM short_bean WHERE value='%s' and value2='%s'",(Object[])args));
    try (Cursor cursor = database().rawQuery("SELECT id, value, value2 FROM short_bean WHERE value=? and value2=?", args)) {
      Logger.info("Rows found: %s",cursor.getCount());
