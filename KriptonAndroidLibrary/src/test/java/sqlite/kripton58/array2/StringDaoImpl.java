...
public class StringDaoImpl extends AbstractDao implements StringDao {
  ...
  public long updateOne(long id, String[] value, String[] value2) {
    ...
    // log for where parameters -- END
    int result = database().update("string_bean", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
  ...
  public long delete(String[] value, String[] value2) {
    ...
    // log for where parameters -- END
    int result = database().delete("string_bean", _sqlWhereStatement, _contentValues.whereArgsAsArray());
    return result;
  }
