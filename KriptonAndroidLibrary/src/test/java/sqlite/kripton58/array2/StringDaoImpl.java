...
public class StringDaoImpl extends AbstractDao implements StringDao {
  ...
  public long updateOne(long id, String[] value, String[] value2) {
    ...
    Logger.info(StringUtils.formatSQL("UPDATE string_bean SET id='"+StringUtils.checkSize(contentValues.get("id"))+"' WHERE value=%s and value2=%s", (Object[])whereConditionsArray));
  ...
  public long insert(long id, String[] value, String[] value2) {
    ...
    // log
    Logger.info(StringUtils.formatSQL("INSERT INTO string_bean (id, value, value2) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"', '"+StringUtils.checkSize(contentValues.get("value2"))+"')"));
  ...
  public long delete(String[] value, String[] value2) {
    ...
    Logger.info(StringUtils.formatSQL("DELETE string_bean WHERE value=%s and value2=%s", (Object[])whereConditionsArray));
