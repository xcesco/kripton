...
public class LongBeanBindMap extends AbstractMapper<LongBean> {
   ...
   */
  @Override
  public LongBean createInstance() {
    return new LongBean();
  }
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, LongBean object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, LongBean object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, LongBean object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public LongBean parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      LongBean instance = createInstance();
      String fieldName;
        ...
        switch (fieldName) {
            ...
            case "value":
              ...
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                instance.setValue(CollectionUtils.asLongTypeArray(collection));
              }
            break;
            case "value2":
              // field value2 (mapped with "value2")
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                instance.setValue2(CollectionUtils.asLongArray(collection));
              }
            break;
            default:
              jacksonParser.skipChildren();
   ...
   */
  @Override
  public LongBean parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      LongBean instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public LongBean parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
