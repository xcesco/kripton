...
public class FloatDaoImpl extends AbstractDao implements FloatDao {
  ...
  public FloatBean selectOne(float[] value, Float[] value2) {
    ...
    //StringUtils, SqlUtils will be used in case of dynamic parts of SQL
    Logger.info(SqlUtils.formatSQL("SELECT id, value, value2 FROM float_bean WHERE value='%s' and value2='%s'",(Object[])_args));
    try (Cursor cursor = database().rawQuery("SELECT id, value, value2 FROM float_bean WHERE value=? and value2=?", _args)) {
      Logger.info("Rows found: %s",cursor.getCount());
  ...
  public long updateOne(long id, float[] value, Float[] value2) {
    ...
    Logger.info(SqlUtils.formatSQL("UPDATE float_bean SET id='"+StringUtils.checkSize(contentValues.get("id"))+"' WHERE value=%s and value2=%s", (Object[])whereConditionsArray));
  ...
  public long insert(long id, float[] value, Float[] value2) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    // log
    Logger.info(SqlUtils.formatSQL("INSERT INTO float_bean (id, value, value2) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"', '"+StringUtils.checkSize(contentValues.get("value2"))+"')"));
  ...
  public long insert(FloatBean bean) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    Logger.info(SqlUtils.formatSQL("INSERT INTO float_bean (value, value2) VALUES ('"+StringUtils.checkSize(contentValues.get("value"))+"', '"+StringUtils.checkSize(contentValues.get("value2"))+"')"));
    long result = database().insert("float_bean", null, contentValues);
    bean.setId(result);
  ...
  public long delete(float[] value, Float[] value2) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    Logger.info(SqlUtils.formatSQL("DELETE float_bean WHERE value=%s and value2=%s", (Object[])whereConditionsArray));
