...
public class FloatDaoImpl extends AbstractDao implements FloatDao {
  protected String SELECT_ONE_SQL1 = "SELECT id, value, value2 FROM float_bean";

  protected String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM float_bean WHERE value=? and value2=?";

  protected String SELECT_ONE_SQL3 = "SELECT id, value, value2 FROM float_bean WHERE value=? and value2=?";

  protected String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM float_bean WHERE value=? and value2=?";

  protected String SELECT_LIST_SQL5 = "SELECT id, value, value2 FROM float_bean WHERE value=? and value2=?";
  ...
  public List<FloatBean> selectList(float[] value, Float[] value2) {
    ...
    try (Cursor cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      ArrayList<FloatBean> resultList=new ArrayList<FloatBean>(cursor.getCount());
      FloatBean resultBean=null;
  ...
  public long insert(long id, float[] value, Float[] value2) {
    ...
    if (insertPreparedStatement1==null) {
      ...
      String _sql=String.format("INSERT INTO float_bean (%s) VALUES (%s)", _contentValues.keyList(), _contentValues.keyValueList());
