...
public class LongDaoImpl extends AbstractDao implements LongDao {
  protected String SELECT_ONE_SQL1 = "SELECT id, value, value2 FROM long_bean";

  protected String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM long_bean WHERE value=? and value2=?";

  protected String SELECT_ONE_SQL3 = "SELECT id, value, value2 FROM long_bean WHERE value=? and value2=?";

  protected String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM long_bean WHERE value=? and value2=?";

  protected String SELECT_LIST_SQL5 = "SELECT id, value, value2 FROM long_bean WHERE value=? and value2=?";
  ...
  public List<LongBean> selectList(long[] value, Long[] value2) {
    ...
    try (Cursor cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      ArrayList<LongBean> resultList=new ArrayList<LongBean>(cursor.getCount());
      LongBean resultBean=null;
  ...
  public long updateOne(long id, long[] value, Long[] value2) {
    ...
    if (updateOnePreparedStatement0==null) {
      ...
      // generate sql
      String _sql="UPDATE long_bean SET id=? WHERE value=? and value2=?";
  ...
  public long delete(long[] value, Long[] value2) {
    ...
    if (deletePreparedStatement3==null) {
      ...
      // generate sql
      String _sql="DELETE FROM long_bean WHERE value=? and value2=?";
