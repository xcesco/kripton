...
public class LongDaoImpl extends AbstractDao implements LongDao {
   ...
   * <h2>Select SQL:</h2>
   *
   * <pre>SELECT value, value2 FROM long_bean WHERE value=${value} and value2=${value2}</pre>
   *
   * <h2>Projected columns:</h2>
   * <dl>
   * 	<dt>id</dt><dd>is associated to bean's property <strong>id</strong></dd>
  ...
  public long updateOne(long id, long[] value, Long[] value2) {
    ...
    // log for where parameters -- END
    int result = database().update("long_bean", contentValues, _sqlWhereStatement, _sqlWhereParams.toArray(new String[_sqlWhereParams.size()]));
    return result;
  }
  ...
  public long insert(long id, long[] value, Long[] value2) {
    ...
    Logger.info(SqlUtils.formatSQL("INSERT INTO long_bean (%s) VALUES (%s)", _columnNameBuffer.toString(), _columnValueBuffer.toString()));
  ...
  public long insert(LongBean bean) {
    ...
    if (bean.getValue()!=null) {
      contentValues.put("value", LongBeanTable.serializeValue(bean.getValue()));
    } else {
      contentValues.putNull("value");
    }

    if (bean.getValue2()!=null) {
      contentValues.put("value2", LongBeanTable.serializeValue2(bean.getValue2()));
    } else {
      contentValues.putNull("value2");
    }
  ...
  public long delete(long[] value, Long[] value2) {
    ...
    // log for where parameters -- END
    int result = database().delete("long_bean", _sqlWhereStatement, _sqlWhereParams.toArray(new String[_sqlWhereParams.size()]));
    return result;
  }
