...
public class LongDaoImpl extends AbstractDao implements LongDao {
   ...
   * write
   */
  protected static byte[] serializer2(Long[] value) {
    if (value==null) {
      return null;
    }
   ...
   * parse
   */
  protected static Long[] parser2(byte[] input) {
    if (input==null) {
      return null;
    }
    JacksonContext context=KriptonBinder.getJsonBinderContext();
   ...
   * write
   */
  protected static byte[] serializer1(long[] value) {
    if (value==null) {
      return null;
    }
    JacksonContext context=KriptonBinder.getJsonBinderContext();
   ...
   * parse
   */
  protected static long[] parser1(byte[] input) {
    if (input==null) {
      return null;
    }
    JacksonContext context=KriptonBinder.getJsonBinderContext();
