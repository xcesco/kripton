...
public class CharDaoImpl extends AbstractDao implements CharDao {
  ...
  public long updateOne(List<Character> value, long id, List<Character> paramValue) {
    ...
    // log for where parameters -- END
    int result = database().update("char_bean", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
  ...
  public long insert(long id, List<Character> value) {
    ...
    long result = database().insert("char_bean", null, _contentValues.values());
    return result;
  }
  ...
  public long delete(List<Character> paramValue) {
    ...
    // log for where parameters -- END
    int result = database().delete("char_bean", _sqlWhereStatement, _contentValues.whereArgsAsArray());
    return result;
  }
