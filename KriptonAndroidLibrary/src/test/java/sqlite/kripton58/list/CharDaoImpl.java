...
public class CharDaoImpl extends AbstractDao implements CharDao {
  protected String SELECT_ONE_SQL1 = "SELECT id, value, value2 FROM char_bean";

  protected String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM char_bean WHERE value=?";

  protected String SELECT_ONE_SQL3 = "SELECT id, value, value2 FROM char_bean WHERE value=?";

  protected String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM char_bean WHERE value=?";

  protected String SELECT_LIST_SQL5 = "SELECT id, value, value2 FROM char_bean WHERE value=?";
  ...
  public List<CharBean> selectList(List<Character> value) {
    ...
    try (Cursor cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      ArrayList<CharBean> resultList=new ArrayList<CharBean>(cursor.getCount());
      CharBean resultBean=null;
  ...
  /**
   * <h2>SQL delete</h2>
   * <pre>DELETE FROM char_bean WHERE value=${paramValue}</pre>
   *
   *
   * <h2>Where parameters:</h2>
   * <dl>
