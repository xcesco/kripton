...
public class CharDaoImpl extends AbstractDao implements CharDao {
  ...
  public long updateOne(List<Character> value, long id, List<Character> paramValue) {
    ...
    Logger.info(SqlUtils.formatSQL("UPDATE char_bean SET value='"+StringUtils.checkSize(contentValues.get("value"))+"' WHERE id=%s and value=%s", (Object[])whereConditionsArray));
    int result = database().update("char_bean", contentValues, "id=? and value=?", whereConditionsArray);
    return result;
  }
  ...
  public long insert(long id, List<Character> value) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    // log
    Logger.info(SqlUtils.formatSQL("INSERT INTO char_bean (id, value) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"')"));
  ...
  /**
   * <h2>SQL delete:</h2>
   * <pre>DELETE char_bean WHERE value=${paramValue}</pre></pre>
   *
   * <h2>Where parameters:</h2>
   * <dl>
   * 	<dt>${paramValue}</dt><dd>is mapped to method's parameter <strong>paramValue</strong></dd>
  ...
  public long delete(List<Character> paramValue) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    Logger.info(SqlUtils.formatSQL("DELETE char_bean WHERE value=%s", (Object[])whereConditionsArray));
    int result = database().delete("char_bean", "value=?", whereConditionsArray);
    return result;
  }
