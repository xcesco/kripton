...
public class CharBeanBindMap extends AbstractMapper<CharBean> {
   ...
   */
  @Override
  public CharBean createInstance() {
    return new CharBean();
  }
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, CharBean object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, CharBean object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, CharBean object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public CharBean parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      CharBean instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public CharBean parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      CharBean instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public CharBean parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
