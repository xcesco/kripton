...
public class LongDaoImpl extends AbstractDao implements LongDao {
  ...
  public long updateOne(List<Long> value, long id, List<Long> paramValue) {
    ...
    // generate sql
    String _sql=String.format("UPDATE long_bean SET value=? WHERE id=? and CAST(value AS TEXT)=?");
    ...
    // log for where parameters -- END
    int result = database().update("long_bean", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
  ...
  public long delete(List<Long> paramValue) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM long_bean WHERE CAST(value AS TEXT)=?");
    ...
    // log for where parameters -- END
    int result = database().delete("long_bean", _sqlWhereStatement, _contentValues.whereArgsAsArray());
    return result;
  }
