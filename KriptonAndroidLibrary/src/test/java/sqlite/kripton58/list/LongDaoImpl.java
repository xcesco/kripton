...
public class LongDaoImpl extends AbstractDao implements LongDao {
  ...
  protected String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM long_bean WHERE CAST(value AS TEXT)=?";

  protected String SELECT_ONE_SQL3 = "SELECT id, value, value2 FROM long_bean WHERE CAST(value AS TEXT)=?";

  protected String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM long_bean WHERE CAST(value AS TEXT)=?";

  protected String SELECT_LIST_SQL5 = "SELECT id, value, value2 FROM long_bean WHERE CAST(value AS TEXT)=?";
