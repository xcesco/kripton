...
public class DoubleDaoImpl extends AbstractDao implements DoubleDao {
  protected String SELECT_ONE_SQL1 = "SELECT id, value, value2 FROM double_bean";

  protected String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM double_bean WHERE value=?";

  protected String SELECT_ONE_SQL3 = "SELECT id, value, value2 FROM double_bean WHERE value=?";

  protected String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM double_bean WHERE value=?";

  protected String SELECT_LIST_SQL5 = "SELECT id, value, value2 FROM double_bean WHERE value=?";
