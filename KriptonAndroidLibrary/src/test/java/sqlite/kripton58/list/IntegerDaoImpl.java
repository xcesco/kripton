...
public class IntegerDaoImpl extends AbstractDao implements IntegerDao {
  ...
  public long updateOne(List<Integer> value, long id, List<Integer> paramValue) {
    ...
    // generate sql
    String _sql=String.format("UPDATE integer_bean SET value=? WHERE id=? and value=?");
    ...
    // log for where parameters -- END
    int result = database().update("integer_bean", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
  ...
  public long delete(List<Integer> paramValue) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM integer_bean WHERE value=?");
    ...
    // log for where parameters -- END
    int result = database().delete("integer_bean", _sqlWhereStatement, _contentValues.whereArgsAsArray());
    return result;
  }
