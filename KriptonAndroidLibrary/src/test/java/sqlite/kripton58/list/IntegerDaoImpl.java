...
public class IntegerDaoImpl extends AbstractDao implements IntegerDao {
  ...
  public long updateOne(List<Integer> value, long id, List<Integer> paramValue) {
    ...
    // log for where parameters -- END
    int result = database().update("integer_bean", contentValues, _sqlWhereStatement, _sqlWhereParams.toArray(new String[_sqlWhereParams.size()]));
    return result;
  }
  ...
  public long insert(long id, List<Integer> value) {
    ...
    Logger.info(SqlUtils.formatSQL("INSERT INTO integer_bean (%s) VALUES (%s)", _columnNameBuffer.toString(), _columnValueBuffer.toString()));
  ...
  public long delete(List<Integer> paramValue) {
    ...
    // log for where parameters -- END
    int result = database().delete("integer_bean", _sqlWhereStatement, _sqlWhereParams.toArray(new String[_sqlWhereParams.size()]));
    return result;
  }
