...
public class StringDaoImpl extends AbstractDao implements StringDao {
  ...
  public StringBean selectOne() {
    ...
    Logger.info(StringUtils.formatSQL("SELECT id, value, value2 FROM string_bean"),(Object[])args);
    Cursor cursor = database().rawQuery("SELECT id, value, value2 FROM string_bean", args);
  ...
  public boolean updateOne(List<String> value, long id, List<String> paramValue) {
    ...
    Logger.info(StringUtils.formatSQL("UPDATE string_bean SET value='"+StringUtils.checkSize(contentValues.get("value"))+"' WHERE id=%s and value=%s"), (Object[])whereConditionsArray);
  ...
  public long insert(long id, List<String> value) {
    ...
    // log
    Logger.info(StringUtils.formatSQL("INSERT INTO string_bean (id, value) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"')"));
  ...
  public long insert(StringBean bean) {
    ...
    // log
    Logger.info(StringUtils.formatSQL("INSERT INTO string_bean (value, value2) VALUES ('"+StringUtils.checkSize(contentValues.get("value"))+"', '"+StringUtils.checkSize(contentValues.get("value2"))+"')"));
    long result = database().insert("string_bean", null, contentValues);
    bean.id=result;
  ...
  public long delete(List<String> paramValue) {
    ...
    Logger.info(StringUtils.formatSQL("DELETE string_bean WHERE value=%s"), (Object[])whereConditionsArray);
