...
public class StringDaoImpl extends AbstractDao implements StringDao {
  ...
  protected String SELECT_ONE_SQL2 = "SELECT id, value, value2 FROM string_bean WHERE value=?";

  protected String SELECT_ONE_SQL3 = "SELECT id, value, value2 FROM string_bean WHERE value=?";

  protected String SELECT_ONE_SQL4 = "SELECT id, value, value2 FROM string_bean WHERE value=?";

  protected String SELECT_LIST_SQL5 = "SELECT id, value, value2 FROM string_bean WHERE value=?";
  ...
  public List<StringBean> selectList(List<String> value) {
    ...
    try (Cursor cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      ArrayList<StringBean> resultList=new ArrayList<StringBean>(cursor.getCount());
      StringBean resultBean=null;
