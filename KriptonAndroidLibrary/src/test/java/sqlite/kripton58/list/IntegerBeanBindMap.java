...
public class IntegerBeanBindMap extends AbstractMapper<IntegerBean> {
   ...
   */
  @Override
  public IntegerBean createInstance() {
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, IntegerBean object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, IntegerBean object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, IntegerBean object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public IntegerBean parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      IntegerBean instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public IntegerBean parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      IntegerBean instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public IntegerBean parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
