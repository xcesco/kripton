...
public class ByteDaoImpl extends AbstractDao implements ByteDao {
  ...
  public long insert(long id, List<Byte> value) {
    ...
    // log
    Logger.info(StringUtils.formatSQL("INSERT INTO byte_bean (id, value) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"')"));
