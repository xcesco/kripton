...
public class ShortDaoImpl extends AbstractDao implements ShortDao {
  ...
  public long updateOne(List<Short> value, long id, List<Short> paramValue) {
    ...
    Logger.info(StringUtils.formatSQL("UPDATE short_bean SET value='"+StringUtils.checkSize(contentValues.get("value"))+"' WHERE id=%s and value=%s"), (Object[])whereConditionsArray);
  ...
  public long insert(long id, List<Short> value) {
    ...
    // log
    Logger.info(StringUtils.formatSQL("INSERT INTO short_bean (id, value) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"')"));
  ...
  public long delete(List<Short> paramValue) {
    ...
    Logger.info(StringUtils.formatSQL("DELETE short_bean WHERE value=%s"), (Object[])whereConditionsArray);
