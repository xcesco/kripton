...
public class ShortDaoImpl extends AbstractDao implements ShortDao {
  ...
  public ShortBean selectOne(List<Short> value) {
    ...
    //StringUtils, SqlUtils will be used in case of dynamic parts of SQL
    Logger.info(SqlUtils.formatSQL("SELECT id, value, value2 FROM short_bean WHERE value='%s'",(Object[])_args));
    try (Cursor cursor = database().rawQuery("SELECT id, value, value2 FROM short_bean WHERE value=?", _args)) {
      Logger.info("Rows found: %s",cursor.getCount());
  ...
  public long updateOne(List<Short> value, long id, List<Short> paramValue) {
    ...
    Logger.info(SqlUtils.formatSQL("UPDATE short_bean SET value='"+StringUtils.checkSize(contentValues.get("value"))+"' WHERE id=%s and value=%s", (Object[])whereConditionsArray));
    int result = database().update("short_bean", contentValues, "id=? and value=?", whereConditionsArray);
    return result;
  }
  ...
  public long insert(long id, List<Short> value) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    // log
    Logger.info(SqlUtils.formatSQL("INSERT INTO short_bean (id, value) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"')"));
  ...
  /**
   * <h2>SQL delete:</h2>
   * <pre>DELETE short_bean WHERE value=${paramValue}</pre></pre>
   *
   * <h2>Where parameters:</h2>
   * <dl>
   * 	<dt>${paramValue}</dt><dd>is mapped to method's parameter <strong>paramValue</strong></dd>
  ...
  public long delete(List<Short> paramValue) {
    ...
    //StringUtils and SqlUtils will be used to format SQL
    Logger.info(SqlUtils.formatSQL("DELETE short_bean WHERE value=%s", (Object[])whereConditionsArray));
    int result = database().delete("short_bean", "value=?", whereConditionsArray);
    return result;
  }
