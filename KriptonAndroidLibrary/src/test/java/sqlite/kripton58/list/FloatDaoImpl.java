...
public class FloatDaoImpl extends AbstractDao implements FloatDao {
  ...
  public long updateOne(List<Float> value, long id, List<Float> paramValue) {
    ...
    Logger.info(StringUtils.formatSQL("UPDATE float_bean SET value='"+StringUtils.checkSize(contentValues.get("value"))+"' WHERE id=%s and value=%s"), (Object[])whereConditionsArray);
  ...
  public long insert(long id, List<Float> value) {
    ...
    // log
    Logger.info(StringUtils.formatSQL("INSERT INTO float_bean (id, value) VALUES ('"+StringUtils.checkSize(contentValues.get("id"))+"', '"+StringUtils.checkSize(contentValues.get("value"))+"')"));
  ...
  public long delete(List<Float> paramValue) {
    ...
    Logger.info(StringUtils.formatSQL("DELETE float_bean WHERE value=%s"), (Object[])whereConditionsArray);
