        ...
        if (n>0) {
          ...
          for (int i=0; i<n; i++) {
            ...
            if (item==null) {
              ...
              if (bean02BindMap().serializeOnJacksonAsString(context, item, wrapper)==0) {
      ...
      if (object.getBeanList()!=null)  {
        ...
        for (int i=0; i<n; i++) {
          ...
          if (item==null) {
            ...
            bean02BindMap().serializeOnXml(context, item, wrapper, 2);
              ...
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                while (jacksonParser.nextToken() != JsonToken.END_ARRAY) {
                  ...
                  if (jacksonParser.currentToken()==JsonToken.VALUE_STRING && "null".equals(tempValue)) {
                    ...
                    item=bean02BindMap().parseOnJacksonAsString(context, wrapper);
                  }
                  collection.add(item);
                }
                instance.setBeanList(collection);
                    ...
                    // property beanList (mapped on "beanList")
                     {
                      ...
                      if (xmlParser.isEmptyElement()) {
                        ...
                        item=bean02BindMap().parseOnXml(context, wrapper, eventType);
                        collection.add(item);
                      }
