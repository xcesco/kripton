...
public class BindBean84ADataSource extends AbstractDataSource implements BindBean84ADaoFactory, Bean84ADataSource {
   ...
   */
  static BindBean84ADataSource instance;
   ...
   */
  public static synchronized BindBean84ADataSource build(DataSourceOptions options) {
    if (instance==null) {
      instance=new BindBean84ADataSource(options);
    }
    return instance;
   ...
   */
  public static synchronized BindBean84ADataSource build() {
