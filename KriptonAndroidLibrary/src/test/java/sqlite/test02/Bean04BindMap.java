...
/**
 * This class is the shared preference binder defined for Bean04
 *
 * @see Bean04
 */
@BindMap(Bean04.class)
public class Bean04BindMap extends AbstractMapper<Bean04> {
  /**
   * create new object instance
   */
  @Override
  public Bean04 createInstance() {
    return new Bean04();
  }
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, Bean04 object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, Bean04 object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, Bean04 object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
      XmlSerializer xmlSerializer = wrapper.xmlSerializer;
      if (currentEventType == 0) {
        xmlSerializer.writeStartElement("bean04");
      }
   ...
   */
  @Override
  public Bean04 parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      Bean04 instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public Bean04 parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      Bean04 instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public Bean04 parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
