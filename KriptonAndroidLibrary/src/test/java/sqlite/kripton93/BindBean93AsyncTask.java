 ...
 * @see BindBean93DataSource
 */
public abstract class BindBean93AsyncTask<I, U, R> {
  /**
   ...
   */
  public BindBean93AsyncTask(boolean readOnlyTask) {
   ...
   */
  public abstract R onExecute(BindBean93DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindBean93AsyncTask.this.onPreExecute();
      }
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindBean93AsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindBean93AsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindBean93DataSource
   */
  public abstract static class Simple<R> extends BindBean93AsyncTask<Void, Void, R> {
  }
}
