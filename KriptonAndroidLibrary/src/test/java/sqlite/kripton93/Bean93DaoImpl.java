...
/**
 * <p>
 * DAO implementation for entity <code>Bean93</code>, based on interface
 * <code>Bean93Dao</code>
 * </p>
 *
 * @see Bean93
...
public class Bean93DaoImpl extends AbstractDao implements Bean93Dao {
	 ...
	 *
	 * <pre>
	 * SELECT id, name, surname FROM bean93 WHERE name like ${name} || \'%\'
	 * </pre>
	 *
	 ...
	 *
	 * <pre>
	 * SELECT id, name, surname FROM bean93
	 * </pre>
	 *
	 * <h2>Projected columns:</h2>
	 * <dl>
	 ...
	 * 
	 * <pre>
	 * INSERT INTO bean93 (name, surname) VALUES (${bean.name}, ${bean.surname})
	 * </pre>
	 *
	 * <p>
	 ...
	 *
	 * @return <code>true</code> if record is inserted, <code>false</code>
	 *         otherwise
	 */
	@Override
	public boolean insertDefault(Bean93 bean) {
		...
		// log
		Logger.info(SqlUtils
				.formatSQL("INSERT INTO bean93 (name, surname) VALUES ('" + StringUtils.checkSize(contentValues.get("name")) + "', '" + StringUtils.checkSize(contentValues.get("surname")) + "')"));
	 ...
	 * 
	 * <pre>
	 * INSERT OR ABORT INTO bean93 (id, name, surname) VALUES (${bean.id}, ${bean.name}, ${bean.surname})
	 * </pre>
	 *
	 * <p>
	 * <code>bean.id</code> is automatically updated because it is the primary
	 ...
	 * <dl>
	 * <dt>id</dt>
	 * <dd>is mapped to <strong>${bean.id}</strong></dd>
	 * <dt>name</dt>
	 * <dd>is mapped to <strong>${bean.name}</strong></dd>
	 * <dt>surname</dt>
	 * <dd>is mapped to <strong>${bean.surname}</strong></dd>
	...
	public boolean insertAbort(Bean93 bean) {
		...
		// StringUtils and SqlUtils will be used to format SQL
		// log
		Logger.info(SqlUtils.formatSQL("INSERT OR ABORT INTO bean93 (id, name, surname) VALUES ('" + StringUtils.checkSize(contentValues.get("id")) + "', '"
				+ StringUtils.checkSize(contentValues.get("name")) + "', '" + StringUtils.checkSize(contentValues.get("surname")) + "')"));
	 ...
	 * 
	 * <pre>
	 * INSERT OR FAIL INTO bean93 (id, name, surname) VALUES (${bean.id}, ${bean.name}, ${bean.surname})
	 * </pre>
	 *
	 * <p>
	 * <code>bean.id</code> is automatically updated because it is the primary
	...
	public boolean insertFail(Bean93 bean) {
		...
		// StringUtils and SqlUtils will be used to format SQL
		// log
		Logger.info(SqlUtils.formatSQL("INSERT OR FAIL INTO bean93 (id, name, surname) VALUES ('" + StringUtils.checkSize(contentValues.get("id")) + "', '"
				+ StringUtils.checkSize(contentValues.get("name")) + "', '" + StringUtils.checkSize(contentValues.get("surname")) + "')"));
		// use SQLiteDatabase conflicts algorithm
	 ...
	 * 
	 * <pre>
	 * INSERT OR IGNORE INTO bean93 (id, name, surname) VALUES (${bean.id}, ${bean.name}, ${bean.surname})
	 * </pre>
	 *
	 * <p>
	 * <code>bean.id</code> is automatically updated because it is the primary
	...
	public boolean insertIgnore(Bean93 bean) {
		...
		// StringUtils and SqlUtils will be used to format SQL
		// log
		Logger.info(SqlUtils.formatSQL("INSERT OR IGNORE INTO bean93 (id, name, surname) VALUES ('" + StringUtils.checkSize(contentValues.get("id")) + "', '"
				+ StringUtils.checkSize(contentValues.get("name")) + "', '" + StringUtils.checkSize(contentValues.get("surname")) + "')"));
		// use SQLiteDatabase conflicts algorithm
	 ...
	 * 
	 * <pre>
	 * INSERT OR REPLACE INTO bean93 (id, name, surname) VALUES (${bean.id}, ${bean.name}, ${bean.surname})
	 * </pre>
	 *
	 * <p>
	 * <code>bean.id</code> is automatically updated because it is the primary
	...
	public boolean insertReplace(Bean93 bean) {
		...
		// StringUtils and SqlUtils will be used to format SQL
		// log
		Logger.info(SqlUtils.formatSQL("INSERT OR REPLACE INTO bean93 (id, name, surname) VALUES ('" + StringUtils.checkSize(contentValues.get("id")) + "', '"
				+ StringUtils.checkSize(contentValues.get("name")) + "', '" + StringUtils.checkSize(contentValues.get("surname")) + "')"));
		// use SQLiteDatabase conflicts algorithm
	 ...
	 * 
	 * <pre>
	 * INSERT OR ROLLBACK INTO bean93 (id, name, surname) VALUES (${bean.id}, ${bean.name}, ${bean.surname})
	 * </pre>
	 *
	 * <p>
	 * <code>bean.id</code> is automatically updated because it is the primary
	...
	public boolean insertRollback(Bean93 bean) {
		...
		// StringUtils and SqlUtils will be used to format SQL
		// log
		Logger.info(SqlUtils.formatSQL("INSERT OR ROLLBACK INTO bean93 (id, name, surname) VALUES ('" + StringUtils.checkSize(contentValues.get("id")) + "', '"
				+ StringUtils.checkSize(contentValues.get("name")) + "', '" + StringUtils.checkSize(contentValues.get("surname")) + "')"));
		// use SQLiteDatabase conflicts algorithm
