...
public class ChildBindMap extends AbstractMapper<Child> {
  ...
  @Override
  public int serializeOnJacksonAsString(Child object, JsonGenerator jacksonSerializer) throws Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(Child object, XMLSerializer xmlSerializer, int currentEventType) throws Exception {
