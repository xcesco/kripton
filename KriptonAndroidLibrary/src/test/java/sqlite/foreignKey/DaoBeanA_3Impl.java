...
public class DaoBeanA_3Impl extends AbstractDao implements DaoBeanA_3 {
  ...
  public List<BeanA_3> selectByString(String value) {
    ...
    // manage WHERE statement
    String _sqlWhereStatement=" WHERE valueString2=?";
    _sqlBuilder.append(_sqlWhereStatement);
  ...
  public int insert(BeanA_3 bean) {
    ...
    Logger.info(SqlUtils.formatSQL("INSERT INTO bean_a_3 (%s) VALUES (%s)", _columnNameBuffer.toString(), _columnValueBuffer.toString()));
  ...
  public int update(BeanA_3 bean) {
    ...
    // manage WHERE statement
    String _sqlWhereStatement=" valueString2=?";
    _sqlBuilder.append(_sqlWhereStatement);
