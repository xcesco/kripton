...
public class BeanA_1BindMap extends AbstractMapper<BeanA_1> {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(BeanA_1 object, JsonGenerator jacksonSerializer) throws Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(BeanA_1 object, XMLSerializer xmlSerializer, int currentEventType) throws Exception {
