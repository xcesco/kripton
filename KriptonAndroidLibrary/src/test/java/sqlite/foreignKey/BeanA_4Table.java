...
public class BeanA_4Table {
   ...
   * </p>
   *
   * <pre>CREATE TABLE bean_a_4 (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, bean_a2_id INTEGER NOT NULL, value_string TEXT, FOREIGN KEY(bean_a2_id) REFERENCES bean_a_3(pk));</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE bean_a_4 (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, bean_a2_id INTEGER NOT NULL, value_string TEXT, FOREIGN KEY(bean_a2_id) REFERENCES bean_a_3(pk));";
  ...
  /**
   * Entity's property <code>beanA2Id</code> is associated to table column <code>bean_a2_id</code>. This costant represents column typeName.
   *
