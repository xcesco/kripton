...
public class BeanA_5BindMap extends AbstractMapper<BeanA_5> {
   ...
   */
  @Override
  public int serializeOnJackson(BeanA_5 object, JsonGenerator jacksonSerializer) throws Exception {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(BeanA_5 object, JsonGenerator jacksonSerializer) throws Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(BeanA_5 object, XMLSerializer xmlSerializer, int currentEventType) throws Exception {
   ...
   */
  @Override
  public BeanA_5 parseOnJackson(JsonParser jacksonParser) throws Exception {
    BeanA_5 instance = new BeanA_5();
    String fieldName;
   ...
   */
  @Override
  public BeanA_5 parseOnJacksonAsString(JsonParser jacksonParser) throws Exception {
    BeanA_5 instance = new BeanA_5();
    String fieldName;
   ...
   */
  @Override
  public BeanA_5 parseOnXml(XMLParser xmlParser, int currentEventType) throws Exception {
    BeanA_5 instance = new BeanA_5();
