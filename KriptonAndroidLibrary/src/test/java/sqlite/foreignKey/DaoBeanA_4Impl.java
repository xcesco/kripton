...
public class DaoBeanA_4Impl extends AbstractDao implements DaoBeanA_4 {
   ...
   * <h2>Select SQL:</h2>
   * <p>
   * <pre>SELECT id, bean_a2_id, value_string FROM bean_a_4 WHERE 1=1</pre>
   *
  ...
  public List<BeanA_4> selectAll() {
    ...
    Logger.info(StringUtils.formatSQL("SELECT id, bean_a2_id, value_string FROM bean_a_4 WHERE 1=1"),(Object[])args);
    Cursor cursor = database().rawQuery("SELECT id, bean_a2_id, value_string FROM bean_a_4 WHERE 1=1", args);
  ...
  public int insert(BeanA_4 bean) {
    ...
    // log
    Logger.info(StringUtils.formatSQL("SQL: INSERT INTO bean_a_4 (bean_a2_id, value_string) VALUES ('"+StringUtils.checkSize(contentValues.get("bean_a2_id"))+"', '"+StringUtils.checkSize(contentValues.get("value_string"))+"')"));
  ...
  public int update(BeanA_4 bean) {
    ...
    Logger.info(StringUtils.formatSQL("UPDATE bean_a_4 SET bean_a2_id='"+StringUtils.checkSize(contentValues.get("bean_a2_id"))+"', value_string='"+StringUtils.checkSize(contentValues.get("value_string"))+"' WHERE valueString='%s'"), (Object[])whereConditions);
    int result = database().update("bean_a_4", contentValues, "value_string=?", whereConditions);
    return result;
  }
}
