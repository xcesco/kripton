...
public class DaoBeanA_2Impl extends AbstractDao implements DaoBeanA_2 {
  ...
  public int insert(BeanA_2 bean) {
    ...
    Logger.info(SqlUtils.formatSQL("INSERT INTO bean_a_2 (%s) VALUES (%s)", _columnNameBuffer.toString(), _columnValueBuffer.toString()));
  ...
  public int update(BeanA_2 bean) {
    ...
    // display log
    Logger.info("UPDATE bean_a_2 SET valueString2=:value_string2 WHERE valueString2=?");
