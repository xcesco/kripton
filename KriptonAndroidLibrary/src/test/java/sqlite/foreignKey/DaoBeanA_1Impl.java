...
public class DaoBeanA_1Impl extends AbstractDao implements DaoBeanA_1 {
  ...
  public int insert(BeanA_1 bean) {
    ...
    Logger.info(SqlUtils.formatSQL("INSERT INTO bean_a_1 (%s) VALUES (%s)", _columnNameBuffer.toString(), _columnValueBuffer.toString()));
  ...
  public int update(BeanA_1 bean) {
    ...
    // display log
    Logger.info("UPDATE bean_a_1 SET beanA2Id=:bean_a2_id, valueString=:value_string WHERE valueString=?");
