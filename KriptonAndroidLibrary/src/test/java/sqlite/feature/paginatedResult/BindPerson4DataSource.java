...
public class BindPerson4DataSource extends AbstractDataSource implements BindPerson4DaoFactory, Person4DataSource {
   ...
   */
  static BindPerson4DataSource instance;
   ...
   * instance
   */
  public static synchronized BindPerson4DataSource instance() {
    if (instance==null) {
      DataSourceOptions options=DataSourceOptions.builder()
      	.build();
      instance=new BindPerson4DataSource(options);
    }
    return instance;
  }
   ...
   */
  public static synchronized BindPerson4DataSource build(DataSourceOptions options) {
    if (instance==null) {
      instance=new BindPerson4DataSource(options);
    }
    return instance;
   ...
   */
  public static synchronized BindPerson4DataSource build() {
