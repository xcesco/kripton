...
/**
 * <p>
 * Represents implementation of datasource Person3DataSource.
...
public class BindPerson3DataSource extends AbstractDataSource implements BindPerson3DaoFactory, Person3DataSource {
   ...
   */
  static BindPerson3DataSource instance;
   ...
   * <p>dao instance</p>
   */
  protected Dao3PersonImpl dao3Person = new Dao3PersonImpl(context);
   ...
   * instance
   */
  public static synchronized BindPerson3DataSource instance() {
    if (instance==null) {
      DataSourceOptions options=DataSourceOptions.builder()
      	.build();
      instance=new BindPerson3DataSource(options);
    }
    return instance;
  }
  ...
  public static BindPerson3DataSource open() {
    BindPerson3DataSource instance=instance();
   ...
   */
  public static synchronized BindPerson3DataSource build(DataSourceOptions options) {
    if (instance==null) {
      instance=new BindPerson3DataSource(options);
    }
    return instance;
   ...
   */
  public static synchronized BindPerson3DataSource build() {
  ...
  class DataSourceSingleThread implements BindPerson3DaoFactory {
    ...
    private Dao3PersonImpl _dao3Person;

    DataSourceSingleThread() {
      _context=new SQLContextInTransactionImpl(BindPerson3DataSource.this);
    }
    ...
    public Dao3PersonImpl getDao3Person() {
      if (_dao3Person==null) {
        _dao3Person=new Dao3PersonImpl(_context);
      }
      return _dao3Person;
    }
