...
/**
 * <p>
 * Represents implementation of datasource ArtistsDataSource.
...
public class BindArtistsDataSource extends AbstractDataSource implements BindArtistsDaoFactory, ArtistsDataSource {
   ...
   */
  static BindArtistsDataSource instance;
   ...
   * instance
   */
  public static synchronized BindArtistsDataSource instance() {
    if (instance==null) {
      instance=new BindArtistsDataSource(null);
    }
    return instance;
  }
  ...
  public static BindArtistsDataSource open() {
    BindArtistsDataSource instance=instance();
   ...
   */
  public static synchronized BindArtistsDataSource build(DataSourceOptions options) {
    if (instance==null) {
      instance=new BindArtistsDataSource(options);
    }
    instance.openWritableDatabase();
    return instance;
  }
   ...
   */
  public interface Transaction extends AbstractTransaction<BindArtistsDaoFactory> {
  }
