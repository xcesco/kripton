...
public class BindKripton180BeanDataSource extends AbstractDataSource implements BindKripton180BeanDaoFactory, Kripton180BeanDataSource {
   ...
   */
  public interface Batch extends AbstractDataSource.AbstractExecutable<BindKripton180BeanDaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    void onExecute(BindKripton180BeanDaoFactory daoFactory);
  }
