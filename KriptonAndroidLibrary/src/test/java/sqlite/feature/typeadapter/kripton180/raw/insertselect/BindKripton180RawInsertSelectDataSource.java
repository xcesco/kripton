...
public class BindKripton180RawInsertSelectDataSource extends AbstractDataSource implements BindKripton180RawInsertSelectDaoFactory, Kripton180RawInsertSelectDataSource {
  ...
  public <T> Observable<T> execute(final BindKripton180RawInsertSelectDataSource.ObservableTransaction<T> transaction) {
  ...
  public <T> Single<T> execute(final BindKripton180RawInsertSelectDataSource.SingleTransaction<T> transaction) {
  ...
  public <T> Flowable<T> execute(final BindKripton180RawInsertSelectDataSource.FlowableTransaction<T> transaction) {
  ...
  public <T> Maybe<T> execute(final BindKripton180RawInsertSelectDataSource.MaybeTransaction<T> transaction) {
  ...
  public <T> Observable<T> executeBatch(final BindKripton180RawInsertSelectDataSource.ObservableBatch<T> batch,
  ...
  public <T> Single<T> executeBatch(final BindKripton180RawInsertSelectDataSource.SingleBatch<T> batch,
      final boolean writeMode) {
    SingleOnSubscribe<T> emitter=new SingleOnSubscribe<T>() {
      @Override
      public void subscribe(SingleEmitter<T> emitter) {
  ...
  public <T> Flowable<T> executeBatch(final BindKripton180RawInsertSelectDataSource.FlowableBatch<T> batch,
      final boolean writeMode) {
    FlowableOnSubscribe<T> emitter=new FlowableOnSubscribe<T>() {
      @Override
      public void subscribe(FlowableEmitter<T> emitter) {
  ...
  public <T> Maybe<T> executeBatch(final BindKripton180RawInsertSelectDataSource.MaybeBatch<T> batch,
      final boolean writeMode) {
    MaybeOnSubscribe<T> emitter=new MaybeOnSubscribe<T>() {
      @Override
      public void subscribe(MaybeEmitter<T> emitter) {
  ...
  class DataSourceSingleThread implements BindKripton180RawInsertSelectDaoFactory {
    ...
    DataSourceSingleThread() {
      _context=new SQLContextSingleThreadImpl(BindKripton180RawInsertSelectDataSource.this);
    }
