...
/**
 * This class is binder map for Err1Person
 *
 * @see Err1Person
 */
@BindMap(Err1Person.class)
public class Err1PersonBindMap extends AbstractMapper<Err1Person> {
  @Override
  public int serializeOnJackson(Err1Person object, JsonGenerator jacksonSerializer) throws
      Exception {
  ...
  @Override
  public int serializeOnJacksonAsString(Err1Person object, JsonGenerator jacksonSerializer) throws
      Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(Err1Person object, XMLSerializer xmlSerializer, int currentEventType)
      throws Exception {
    if (currentEventType == 0) {
      xmlSerializer.writeStartElement("err1Person");
    }
   ...
   */
  @Override
  public Err1Person parseOnJackson(JsonParser jacksonParser) throws Exception {
    Err1Person instance = new Err1Person();
    String fieldName;
   ...
   */
  @Override
  public Err1Person parseOnJacksonAsString(JsonParser jacksonParser) throws Exception {
    Err1Person instance = new Err1Person();
    String fieldName;
   ...
   */
  @Override
  public Err1Person parseOnXml(XMLParser xmlParser, int currentEventType) throws Exception {
    Err1Person instance = new Err1Person();
