...
public class Seminar2StudentTable {
   ...
   * </p>
   *
   * <pre> DROP INDEX idx_seminar_2_student_1;DROP TABLE IF EXISTS seminar_2_student;</pre>
   */
  public static final String DROP_TABLE_SQL = " DROP INDEX idx_seminar_2_student_1;DROP TABLE IF EXISTS seminar_2_student;";
