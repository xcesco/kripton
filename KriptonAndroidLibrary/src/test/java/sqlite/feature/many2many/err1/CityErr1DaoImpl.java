...
/**
 * <p>
 * DAO implementation for entity <code>City</code>, based on interface <code>CityErr1Dao</code>
 * </p>
 *
 *  @see City
 *  @see CityErr1Dao
 ...
 */
public class CityErr1DaoImpl extends AbstractDao implements CityErr1Dao {
  public CityErr1DaoImpl(BindPersonCirtyErr1DataSource dataSet) {
    super(dataSet);
  }
