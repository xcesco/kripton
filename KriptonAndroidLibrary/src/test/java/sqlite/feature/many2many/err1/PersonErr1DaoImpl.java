...
/**
 * <p>
 * DAO implementation for entity <code>Person</code>, based on interface <code>PersonErr1Dao</code>
 * </p>
 *
 *  @see Person
 *  @see PersonErr1Dao
 ...
 */
public class PersonErr1DaoImpl extends AbstractDao implements PersonErr1Dao {
  public PersonErr1DaoImpl(BindPersonCirtyErr1DataSource dataSet) {
    super(dataSet);
  }
  ...
  public int deleteById(long id) {
    ...
    // log for where parameters -- END
    int result = database().delete("persons", _sqlWhereStatement, _sqlWhereParams.toArray(new String[_sqlWhereParams.size()]));
    return result;
  }
}
