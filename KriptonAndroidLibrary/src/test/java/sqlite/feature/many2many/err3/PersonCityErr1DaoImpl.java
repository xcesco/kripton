...
public class PersonCityErr1DaoImpl extends AbstractDao implements GeneratedPersonCityErr1Dao {
  ...
  public int deleteById(long id) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM person_city_err3 WHERE id=?");
    ...
    // log for where parameters -- END
    int result = database().delete("person_city_err3", _sqlWhereStatement, _contentValues.whereArgsAsArray());
    return result;
  }
  ...
  public int deleteByPersonId(long personId) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM person_city_err3 WHERE person_id=?");
  ...
  public int deleteByCityId(long cityId) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM person_city_err3 WHERE city_id=?");
