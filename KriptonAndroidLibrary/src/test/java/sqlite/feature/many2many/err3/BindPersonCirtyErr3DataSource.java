...
public class BindPersonCirtyErr3DataSource extends AbstractDataSource implements BindPersonCirtyErr3DaoFactory, PersonCirtyErr3DataSource {
   ...
   */
  public interface Batch extends AbstractDataSource.AbstractExecutable<BindPersonCirtyErr3DaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    void onExecute(BindPersonCirtyErr3DaoFactory daoFactory);
  }
