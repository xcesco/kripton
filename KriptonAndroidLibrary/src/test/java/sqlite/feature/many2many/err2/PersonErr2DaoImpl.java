...
/**
 * <p>
 * DAO implementation for entity <code>Person</code>, based on interface <code>PersonErr2Dao</code>
 * </p>
 *
 *  @see Person
 *  @see PersonErr2Dao
 ...
 */
public class PersonErr2DaoImpl extends AbstractDao implements PersonErr2Dao {
  public PersonErr2DaoImpl(BindPersonCirtyErr2DataSource dataSet) {
    super(dataSet);
  }
