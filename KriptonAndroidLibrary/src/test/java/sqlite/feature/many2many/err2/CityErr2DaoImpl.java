...
/**
 * <p>
 * DAO implementation for entity <code>City</code>, based on interface <code>CityErr2Dao</code>
 * </p>
 *
 *  @see City
 *  @see CityErr2Dao
 ...
 */
public class CityErr2DaoImpl extends AbstractDao implements CityErr2Dao {
  public CityErr2DaoImpl(BindPersonCirtyErr2DataSource dataSet) {
    super(dataSet);
  }
  ...
  public long insert(City bean) {
    ...
    long result = database().insert("cities", null, contentValues);
    bean.id=result;
  ...
  public int deleteById(long id) {
    ...
    // log for where parameters -- END
    int result = database().delete("cities", _sqlWhereStatement, _sqlWhereParams.toArray(new String[_sqlWhereParams.size()]));
    return result;
  }
}
