...
/**
 * This class is binder map for PersonCityErr2
 *
 * @see PersonCityErr2
 */
@BindMap(PersonCityErr2.class)
public class PersonCityErr2BindMap extends AbstractMapper<PersonCityErr2> {
  @Override
  public int serializeOnJackson(PersonCityErr2 object, JsonGenerator jacksonSerializer) throws
      Exception {
  ...
  @Override
  public int serializeOnJacksonAsString(PersonCityErr2 object, JsonGenerator jacksonSerializer)
      throws Exception {
    jacksonSerializer.writeStartObject();
    int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(PersonCityErr2 object, XMLSerializer xmlSerializer,
      int currentEventType) throws Exception {
    if (currentEventType == 0) {
      xmlSerializer.writeStartElement("personCityErr2");
    }
   ...
   */
  @Override
  public PersonCityErr2 parseOnJackson(JsonParser jacksonParser) throws Exception {
    PersonCityErr2 instance = new PersonCityErr2();
    String fieldName;
   ...
   */
  @Override
  public PersonCityErr2 parseOnJacksonAsString(JsonParser jacksonParser) throws Exception {
    PersonCityErr2 instance = new PersonCityErr2();
    String fieldName;
   ...
   */
  @Override
  public PersonCityErr2 parseOnXml(XMLParser xmlParser, int currentEventType) throws Exception {
    PersonCityErr2 instance = new PersonCityErr2();
