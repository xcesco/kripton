...
/**
 * <p>
 * DAO implementation for entity <code>Person</code>, based on interface <code>PersonOk1Dao</code>
 * </p>
 *
 *  @see Person
 *  @see PersonOk1Dao
 ...
 */
public class PersonOk1DaoImpl extends AbstractDao implements PersonOk1Dao {
  public PersonOk1DaoImpl(BindPersonCirtyOk1DataSource dataSet) {
    super(dataSet);
  }
  ...
  public List<Person> selectAll() {
    ...
    _sqlBuilder.append("SELECT id, name FROM persons");
  ...
  public long insert(Person bean) {
    ...
    long result = database().insert("persons", null, _contentValues.values());
    bean.id=result;
  ...
  public int deleteById(long id) {
    ...
    // log for where parameters -- END
    int result = database().delete("persons", _sqlWhereStatement, _contentValues.whereArgsAsArray());
    return result;
  }
}
