...
public class BindPersonCirtyDataSource extends AbstractDataSource implements BindPersonCirtyDaoFactory, PersonCirtyDataSource {
   ...
   */
  public static synchronized BindPersonCirtyDataSource build() {
   ...
   */
  public interface Batch<T> extends AbstractDataSource.AbstractExecutable<BindPersonCirtyDaoFactory> {
    /**
