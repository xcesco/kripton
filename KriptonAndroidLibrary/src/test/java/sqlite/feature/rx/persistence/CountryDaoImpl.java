...
public class CountryDaoImpl extends AbstractDao implements CountryDao {
  ...
  protected String SELECT_BY_ID_SQL6 = "SELECT id, area, code, calling_code, region, name, translated_name FROM country WHERE id = ?";

  private SQLiteStatement deleteByIdPreparedStatement1;

  private SQLiteStatement updateByIdPreparedStatement2;

  protected String SELECT_ALL_SQL7 = "SELECT id, area, code, calling_code, region, name, translated_name FROM country ORDER BY name asc";

  protected String SELECT_ALL_SQL8 = "SELECT id, area, code, calling_code, region, name, translated_name FROM country ORDER BY name asc";

  protected String SELECT_BY_CALLING_CODE_SQL9 = "SELECT id, area, code, calling_code, region, name, translated_name FROM country WHERE calling_code = ?";

  protected String SELECT_BY_COUNTRY_SQL10 = "SELECT id, area, code, calling_code, region, name, translated_name FROM country WHERE code = ?";
