...
public class TrackDaoImpl extends AbstractDao implements TrackDao {
  ...
  public Track selectById(long id) {
    ...
    _sqlBuilder.append("SELECT id, album_id FROM track");
  ...
  public List<Track> selectAll() {
    ...
    try (Cursor cursor = database().rawQuery(_sql, _sqlArgs)) {
      ...
      LinkedList<Track> resultList=new LinkedList<Track>();
      Track resultBean=null;
  ...
  public long update(Track bean) {
    ...
    contentValues.put("album_id", bean.albumId);
    ...
    // log for where parameters -- END
    int result = database().update("track", contentValues, _sqlWhereStatement, _sqlWhereParams.toArray(new String[_sqlWhereParams.size()]));;
    return result;
  }
  ...
  public long insert(Track bean) {
    ...
    long result = database().insert("track", null, contentValues);
    bean.id=result;
  ...
  public long deleteById(long id) {
    ...
    // log for where parameters -- END
    int result = database().delete("track", _sqlWhereStatement, _sqlWhereParams.toArray(new String[_sqlWhereParams.size()]));
    return result;
  }
}
