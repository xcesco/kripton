...
public class TrackDaoImpl extends AbstractDao implements TrackDao {
  ...
  public long update(Track bean) {
    ...
    // log for where parameters -- END
    int result = database().update("track", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
  ...
  public long insert(Track bean) {
    ...
    long result = database().insert("track", null, _contentValues.values());
    bean.id=result;
  ...
  public long deleteById(long id) {
    ...
    // log for where parameters -- END
    int result = database().delete("track", _sqlWhereStatement, _contentValues.whereArgsAsArray());
    return result;
  }
}
