...
public class BindInsertRawPersonDataSource extends AbstractDataSource implements BindInsertRawPersonDaoFactory, InsertRawPersonDataSource {
  ...
  public static synchronized BindInsertRawPersonDataSource instance() {
    if (instance==null) {
      instance=new BindInsertRawPersonDataSource(null);
    }
    return instance;
  }
  ...
  class DataSourceSingleThread implements BindInsertRawPersonDaoFactory {
    ...
    private InsertRawPersonDaoImpl _insertRawPersonDao;

    DataSourceSingleThread() {
      _context=new SQLContextSingleThreadImpl(BindInsertRawPersonDataSource.this);
    }
