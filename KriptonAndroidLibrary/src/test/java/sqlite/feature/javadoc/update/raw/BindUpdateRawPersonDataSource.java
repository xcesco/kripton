...
public class BindUpdateRawPersonDataSource extends AbstractDataSource implements BindUpdateRawPersonDaoFactory, UpdateRawPersonDataSource {
   ...
   */
  public interface Batch extends AbstractDataSource.AbstractExecutable<BindUpdateRawPersonDaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    void onExecute(BindUpdateRawPersonDaoFactory daoFactory);
  }
