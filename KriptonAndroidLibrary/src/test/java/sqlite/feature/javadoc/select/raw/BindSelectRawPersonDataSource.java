...
public class BindSelectRawPersonDataSource extends AbstractDataSource implements BindSelectRawPersonDaoFactory, SelectRawPersonDataSource {
   ...
   */
  public interface Batch extends AbstractDataSource.AbstractExecutable<BindSelectRawPersonDaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    void onExecute(BindSelectRawPersonDaoFactory daoFactory);
  }
