...
public class BindSelectRawPersonDataSource extends AbstractDataSource implements BindSelectRawPersonDaoFactory, SelectRawPersonDataSource {
  ...
  public static synchronized BindSelectRawPersonDataSource instance() {
    if (instance==null) {
      instance=new BindSelectRawPersonDataSource(null);
    }
    return instance;
  }
  ...
  class DataSourceSingleThread implements BindSelectRawPersonDaoFactory {
    ...
    private SelectRawPersonDaoImpl _selectRawPersonDao;

    DataSourceSingleThread() {
      _context=new SQLContextSingleThreadImpl(BindSelectRawPersonDataSource.this);
    }
