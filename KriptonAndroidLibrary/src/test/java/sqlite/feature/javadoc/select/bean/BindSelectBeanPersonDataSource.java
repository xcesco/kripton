...
public class BindSelectBeanPersonDataSource extends AbstractDataSource implements BindSelectBeanPersonDaoFactory, SelectBeanPersonDataSource {
   ...
   */
  public interface Batch extends AbstractDataSource.AbstractExecutable<BindSelectBeanPersonDaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    void onExecute(BindSelectBeanPersonDaoFactory daoFactory);
  }
