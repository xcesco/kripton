...
public class BindSelectBeanPersonDataSource extends AbstractDataSource implements BindSelectBeanPersonDaoFactory, SelectBeanPersonDataSource {
  ...
  public static synchronized BindSelectBeanPersonDataSource instance() {
    if (instance==null) {
      instance=new BindSelectBeanPersonDataSource(null);
    }
    return instance;
  }
  ...
  class DataSourceSingleThread implements BindSelectBeanPersonDaoFactory {
    ...
    private SelectBeanPersonDaoImpl _selectBeanPersonDao;

    DataSourceSingleThread() {
      _context=new SQLContextSingleThreadImpl(BindSelectBeanPersonDataSource.this);
    }
