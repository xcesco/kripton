...
public class BindDeleteBeanPersonDataSource extends AbstractDataSource implements BindDeleteBeanPersonDaoFactory, DeleteBeanPersonDataSource {
   ...
   */
  public interface Batch extends AbstractDataSource.AbstractExecutable<BindDeleteBeanPersonDaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    void onExecute(BindDeleteBeanPersonDaoFactory daoFactory);
  }
