...
public class BindDeleteRawPersonDataSource extends AbstractDataSource implements BindDeleteRawPersonDaoFactory, DeleteRawPersonDataSource {
   ...
   * instance
   */
  public static synchronized BindDeleteRawPersonDataSource instance() {
    if (instance==null) {
      instance=new BindDeleteRawPersonDataSource(null);
    }
    return instance;
  }
   ...
   */
  public static synchronized BindDeleteRawPersonDataSource build() {
  ...
  class DataSourceSingleThread implements BindDeleteRawPersonDaoFactory {
    ...
    private DeleteRawPersonDaoImpl _deleteRawPersonDao;

    DataSourceSingleThread() {
      _context=new SQLContextSingleThreadImpl(BindDeleteRawPersonDataSource.this);
    }
