...
public class BindDeleteRawPersonDataSource extends AbstractDataSource implements BindDeleteRawPersonDaoFactory, DeleteRawPersonDataSource {
   ...
   */
  public interface Batch extends AbstractDataSource.AbstractExecutable<BindDeleteRawPersonDaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    void onExecute(BindDeleteRawPersonDaoFactory daoFactory);
  }
