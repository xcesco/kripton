...
public class DaoBeanA_2Impl extends AbstractDao implements DaoBeanA_2 {
  ...
  public int update(BeanA_2 bean) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean_a_2 SET value_string2=? WHERE value_string2=?");
    ...
    // log for where parameters -- END
    int result = database().update("bean_a_2", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
}
