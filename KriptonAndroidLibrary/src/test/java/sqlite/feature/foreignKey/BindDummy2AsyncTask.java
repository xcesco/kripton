 ...
 * @see BindDummy2DataSource
 * @see BindAsyncTaskType
 */
public abstract class BindDummy2AsyncTask<I, U, R> {
  /**
   ...
   */
  public BindDummy2AsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindDummy2DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindDummy2AsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindDummy2DataSource dataSource=BindDummy2DataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindDummy2AsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindDummy2AsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindDummy2DataSource
   */
  public abstract static class Simple<R> extends BindDummy2AsyncTask<Void, Void, R> {
    /**
