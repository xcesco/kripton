...
public class DaoBeanA_1Impl extends AbstractDao implements DaoBeanA_1 {
  ...
  public int update(BeanA_1 bean) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean_a_1 SET bean_a2_id=?, value_string=? WHERE value_string=?");
    ...
    // log for where parameters -- END
    int result = database().update("bean_a_1", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
}
