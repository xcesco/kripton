...
/**
 * <p>
 * Cursor implementation for entity <code>BeanA_4</code>
 * </p>
 *  @see BeanA_4
 */
public class BindBeanA_4Cursor {
  /**
   ...
   */
  BindBeanA_4Cursor(Cursor cursor) {
    wrap(cursor);
  }
   ...
   */
  public BindBeanA_4Cursor wrap(Cursor cursor) {
    this.cursor=cursor;
   ...
   */
  public LinkedList<BeanA_4> execute() {

    LinkedList<BeanA_4> resultList=new LinkedList<BeanA_4>();
    BeanA_4 resultBean=new BeanA_4();
   ...
   */
  public void executeListener(OnBeanA_4Listener listener) {
    BeanA_4 resultBean=new BeanA_4();
   ...
   */
  public static BindBeanA_4Cursor create(Cursor cursor) {
    return new BindBeanA_4Cursor(cursor);
  }

  /**
   * <p>Listener for row read from database.</p>
   */
  public interface OnBeanA_4Listener {
    /**
     ...
     */
    void onRow(BeanA_4 bean, int rowPosition, int rowCount);
  }
}
