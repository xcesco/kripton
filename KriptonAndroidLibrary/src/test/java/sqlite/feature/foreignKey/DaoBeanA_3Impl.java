...
public class DaoBeanA_3Impl extends AbstractDao implements DaoBeanA_3 {
  ...
  public int insert(BeanA_3 bean) {
    ...
    String _sql=String.format("INSERT INTO bean_a_3 (%s) VALUES (%s)", _contentValues.keyList(), _contentValues.keyValueList());
    // insert operation
  ...
  public int update(BeanA_3 bean) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean_a_3 SET value_string2=? WHERE value_string2=?");
    ...
    // log for where parameters -- END
    int result = database().update("bean_a_3", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
}
