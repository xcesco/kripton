...
public class DaoBeanA_3Impl extends AbstractDao implements DaoBeanA_3 {
  protected String SELECT_ALL_SQL1 = "SELECT pk, value_string2 FROM bean_a_3";

  protected String SELECT_BY_ID_SQL2 = "SELECT pk, value_string2 FROM bean_a_3 WHERE pk=?";

  protected String SELECT_BY_STRING_SQL3 = "SELECT pk FROM bean_a_3 WHERE value_string2=?";
