 ...
 * @see BindCollegeStudentsDataSource
 * @see BindAsyncTaskType
 */
public abstract class BindCollegeStudentsAsyncTask<I, U, R> {
  /**
   ...
   * </p>
   */
  public BindCollegeStudentsAsyncTask() {
   ...
   */
  public BindCollegeStudentsAsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindCollegeStudentsAsyncTask.this.onPreExecute();
      }
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindCollegeStudentsAsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindCollegeStudentsAsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindCollegeStudentsDataSource
   */
  public abstract static class Simple<R> extends BindCollegeStudentsAsyncTask<Void, Void, R> {
    /**
