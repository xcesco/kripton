 ...
 * @see BindFamilyDataSource
 * @see BindAsyncTaskType
 */
public abstract class BindFamilyAsyncTask<I, U, R> {
  /**
   ...
   */
  public BindFamilyAsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindFamilyDataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindFamilyAsyncTask.this.onPreExecute();
      }
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindFamilyAsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindFamilyAsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindFamilyDataSource
   */
  public abstract static class Simple<R> extends BindFamilyAsyncTask<Void, Void, R> {
    /**
