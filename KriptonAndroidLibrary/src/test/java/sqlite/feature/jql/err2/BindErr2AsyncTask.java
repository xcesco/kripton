 ...
 * @see BindErr2DataSource
 * @see BindAsyncTaskType
 */
public abstract class BindErr2AsyncTask<I, U, R> {
  /**
   ...
   */
  public BindErr2AsyncTask(BindAsyncTaskType mode) {
    this.mode = mode;}
   ...
   */
  public abstract R onExecute(BindErr2DataSource dataSource) throws Throwable;
  ...
  public void executeOnExecutor(Executor executor, @SuppressWarnings("unchecked") I... params) {
    asyncTask=new AsyncTask<I, U, R>() {
      @Override
      public void onPreExecute() {
        BindErr2AsyncTask.this.onPreExecute();
      }

      @Override
      public R doInBackground(@SuppressWarnings("unchecked") I... params) {
        BindErr2DataSource dataSource=BindErr2DataSource.instance();
        R result=null;
      ...
      public void onProgressUpdate(@SuppressWarnings("unchecked") U... values) {
        BindErr2AsyncTask.this.onProgressUpdate(values);
      }

      @Override
      public void onPostExecute(R result) {
        BindErr2AsyncTask.this.onFinish(result);
      }
    };
   ...
   * @see BindErr2DataSource
   */
  public abstract static class Simple<R> extends BindErr2AsyncTask<Void, Void, R> {
    /**
