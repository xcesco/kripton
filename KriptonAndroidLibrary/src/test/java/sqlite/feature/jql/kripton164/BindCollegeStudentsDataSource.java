...
public class BindCollegeStudentsDataSource extends AbstractDataSource implements BindCollegeStudentsDaoFactory, CollegeStudentsDataSource {
  ...
  public static synchronized BindCollegeStudentsDataSource instance() {
    if (instance==null) {
      instance=new BindCollegeStudentsDataSource(null);
    }
    return instance;
  }
   ...
   */
  public interface Batch extends AbstractDataSource.AbstractExecutable<BindCollegeStudentsDaoFactory> {
    /**
     ...
     * @throws Throwable
     */
    void onExecute(BindCollegeStudentsDaoFactory daoFactory);
  }
