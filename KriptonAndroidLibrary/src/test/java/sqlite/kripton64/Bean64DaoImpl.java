...
public class Bean64DaoImpl extends AbstractDao implements Bean64Dao {
  ...
  public long delete(BigDecimal valueBigDecimal) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_big_decimal=?");
    ...
    int result = database().delete("bean64", _sqlWhereStatement, _contentValues.whereArgsAsArray());
    return result;
  }
  ...
  public long delete(boolean valueBoolType) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_bool_type=?");
  ...
  public long delete(Boolean valueBool) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_bool=?");
  ...
  public long deleteArrayBeanType(Bean64[] valueBeanArray) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_bean_array=?");
  ...
  public long deleteArrayLong(Long[] valueLongArray) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_long_array=?");
  ...
  public long deleteArrayLongType(long[] valueLongTypeArray) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_long_type_array=?");
  ...
  public long deleteByte(Byte valueByte) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_byte=?");
  ...
  public long deleteByteType(boolean valueByteType) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_byte_type=?");
  ...
  public long deleteCalendar(Date valueCalendar) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_calendar=?");
  ...
  public long deleteChar(Character valueChar) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_char_type=?");
  ...
  public long deleteCurrency(Currency valueCurrency) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_currency=?");
  ...
  public long deleteDate(Date valueDate) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_date=?");
  ...
  public long deleteDouble(Double valueDouble) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_double=?");
  ...
  public long deleteDoubleType(double valueDoubleType) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_double_type=?");
  ...
  public long deleteEnumType(EnumType valueEnumType) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_enum_type=?");
  ...
  public long deleteFloat(Float valueFloat) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_float=?");
  ...
  public long deleteFloatType(float valueFloatType) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_float_type=?");
  ...
  public long deleteInt(Integer valueInt) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_int=?");
  ...
  public long deleteIntType(int valueIntType) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_int_type=?");
  ...
  public long deleteListLong(LinkedList<Long> valueLongList) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_long_list=?");
  ...
  public long deleteLocale(Date valueLocale) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_locale=?");
  ...
  public long deleteLong(Long valueLong) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_long=?");
  ...
  public long deleteLongType(long valueLongType) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_long_type=?");
  ...
  public long deleteShort(Short valueShort) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_short=?");
  ...
  public long deleteShortType(short valueShortType) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_short_type=?");
  ...
  public long deleteString(String valueString) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_string=?");
  ...
  public long deleteTime(Time valueTime) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_time=?");
  ...
  public long deleteTimeZone(TimeZone valueTimeZone) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_time_zone=?");
  ...
  public long deleteURL(URL valueUrl) {
    ...
    // generate sql
    String _sql=String.format("DELETE FROM bean64 WHERE value_url=?");
  ...
  public long updateOne(Bean64 value) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET value_bool_type=?, value_bool=?, value_byte_type=?, value_byte=?, value_short_type=?, value_short=?, value_int_type=?, value_int=?, value_string=?, value_char_type=?, value_char=?, value_float_type=?, value_float=?, value_big_integer=?, value_big_decimal=?, value_enum_type=?, value_long_type=?, value_long=?, value_double_type=?, value_double=?, value_locale=?, value_calendar=?, value_date=?, value_url=?, value_time=?, value_currency=?, value_time_zone=?, value_time_list=?, value_strin_list=?, value_long_list=?, value_byte_array=?, value_long_type_array=?, value_long_array=?, value_bean_array=?, value_string_array=?, value_char_list=?, value_char_type_array=?, value_char_array=?, value_map_string_bean=?, value_linked_map_string_bean=?, value_set_string=? WHERE id=?");
    ...
    // log for where parameters -- END
    int result = database().update("bean64", _contentValues.values(), _sqlWhereStatement, _contentValues.whereArgsAsArray());;
    return result;
  }
  ...
  public long updateOne(long id, BigDecimal valueBigDecimal) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_big_decimal=?");
  ...
  public long updateOne(long id, boolean valueBoolType) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_bool_type=?");
  ...
  public long updateOne(long id, Boolean valueBool) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_bool=?");
  ...
  public long updateOne(long id, Set<String> valueSetString) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET value_set_string=? WHERE id=?");
  ...
  public long updateOneArrayBean(long id, Bean64[] valueBeanArray) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_bean_array=?");
  ...
  public long updateOneArrayLong(long id, Long[] valueLongArray) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_long_array=?");
  ...
  public long updateOneArrayLongType(long id, long[] valueLongTypeArray) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_long_type_array=?");
  ...
  public long updateOneByte(long id, Byte valueByte) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_byte=?");
  ...
  public long updateOneByteType(long id, boolean valueByteType) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_byte_type=?");
  ...
  public long updateOneCalendar(long id, Calendar valueCalendar) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_calendar=?");
  ...
  public long updateOneChar(long id, Character valueChar) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_char_type=?");
  ...
  public long updateOneCurrency(long id, Currency valueCurrency) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_currency=?");
  ...
  public long updateOneDate(long id, Date valueDate) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_date=?");
  ...
  public long updateOneDouble(long id, Double valueDouble) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_double=?");
  ...
  public long updateOneDoubleType(long id, double valueDoubleType) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_double_type=?");
  ...
  public long updateOneEnumType(long id, EnumType valueEnumType) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_enum_type=?");
  ...
  public long updateOneFloat(long id, Float valueFloat) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_float=?");
  ...
  public long updateOneFloatType(long id, float valueFloatType) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_float_type=?");
  ...
  public long updateOneInt(long id, Integer valueInt) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_int=?");
  ...
  public long updateOneIntType(long id, int valueIntType) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_int_type=?");
  ...
  public long updateOneListLong(long id, LinkedList<Long> valueLongList) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_long_list=?");
  ...
  public long updateOneLocale(long id, Locale valueLocale) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_locale=?");
  ...
  public long updateOneLong(long id, Long valueLong) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_long=?");
  ...
  public long updateOneLongType(long id, long valueLongType) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_long_type=?");
  ...
  public long updateOneShort(long id, Short valueShort) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_short=?");
  ...
  public long updateOneShortType(long id, short valueShortType) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_short_type=?");
  ...
  public long updateOneString(long id, Double valueString) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_string=?");
  ...
  public long updateOneTime(long id, Time valueTime) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_time=?");
  ...
  public long updateOneTimeZone(long id, TimeZone valueTimeZone) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_time_zone=?");
  ...
  public long updateOneURL(long id, URL valueUrl) {
    ...
    // generate sql
    String _sql=String.format("UPDATE bean64 SET id=? WHERE value_url=?");
