...
public class Bean64BDaoImpl extends AbstractDao implements Bean64BDao {
  protected String SELECT_ALL_SQL1 = "SELECT value_map_string_bean, value_set_string, value_string, id FROM bean64_b";

  protected String SELECT_LIST_SQL2 = "SELECT value_map_string_bean, value_set_string, value_string, id FROM bean64_b WHERE id=?";
