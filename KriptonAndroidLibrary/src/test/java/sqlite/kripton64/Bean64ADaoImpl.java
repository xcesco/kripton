...
public class Bean64ADaoImpl extends AbstractDao implements Bean64ADao {
   ...
   * <h2>Select SQL:</h2>
   * <p>
   * <pre>SELECT value_map_string_bean, value_set_string, value_string, id FROM bean64_a WHERE 1=1</pre>
   *
  ...
  public List<Bean64A> selectAll() {
    ...
    Logger.info(StringUtils.formatSQL("SELECT value_map_string_bean, value_set_string, value_string, id FROM bean64_a WHERE 1=1"),(Object[])args);
    Cursor cursor = database().rawQuery("SELECT value_map_string_bean, value_set_string, value_string, id FROM bean64_a WHERE 1=1", args);
