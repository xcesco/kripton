...
public class MessageEntityBindMap extends AbstractMapper<MessageEntity> {
   ...
   */
  @Override
  public MessageEntity createInstance() {
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, MessageEntity object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, MessageEntity object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, MessageEntity object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public MessageEntity parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      MessageEntity instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public MessageEntity parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      MessageEntity instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public MessageEntity parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
