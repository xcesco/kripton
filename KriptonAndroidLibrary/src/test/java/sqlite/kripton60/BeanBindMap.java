  ...
  public int serializeOnJackson(AbstractJacksonContext context, Bean object, JacksonWrapperSerializer wrapper) {
    try {
      ...
      if (object.valueBean!=null)  {
        ...
        beanBindMap().serializeOnJackson(context, object.valueBean, wrapper);
      }
  ...
  public int serializeOnJacksonAsString(AbstractJacksonContext context, Bean object, JacksonWrapperSerializer wrapper) {
    try {
      ...
      if (object.valueBean!=null)  {
        fieldCount++;
        jacksonSerializer.writeFieldName("valueBean");
        if (beanBindMap().serializeOnJacksonAsString(context, object.valueBean, wrapper)==0) {
        ...
        if (n>0) {
          ...
          for (int i=0; i<n; i++) {
            ...
            if (item==null) {
              ...
              if (beanBindMap().serializeOnJacksonAsString(context, item, wrapper)==0) {
        ...
        if (object.valueLinkedMapStringBean.size()>0) {
          ...
          for (Map.Entry<String, Bean> item: object.valueLinkedMapStringBean.entrySet()) {
            ...
            if (item.getValue()==null) {
              ...
              jacksonSerializer.writeFieldName("value");
              if (beanBindMap().serializeOnJacksonAsString(context, item.getValue(), wrapper)==0) {
                jacksonSerializer.writeNullField("value");
              }
            }
            jacksonSerializer.writeEndObject();
  ...
  public void serializeOnXml(KriptonXmlContext context, Bean object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
      ...
      if (object.valueBean!=null)  {
        ...
        beanBindMap().serializeOnXml(context, object.valueBean, wrapper, 2);
        xmlSerializer.writeEndElement();
      }
      ...
      if (object.valueBeanArray!=null)  {
        ...
        for (int i=0; i<n; i++) {
          ...
          if (item==null) {
            ...
            beanBindMap().serializeOnXml(context, item, wrapper, 2);
            xmlSerializer.writeEndElement();
          }
        }
          ...
          xmlSerializer.writeStartElement("valueLinkedMapStringBean");
            ...
            if (item.getValue()==null) {
              ...
              if (item.getValue()!=null)  {
                ...
                beanBindMap().serializeOnXml(context, item.getValue(), wrapper, 2);
                xmlSerializer.writeEndElement();
              }
            }
          xmlSerializer.writeEndElement();
      ...
      while (jacksonParser.nextToken() != JsonToken.END_OBJECT) {
        ...
        switch (fieldName) {
            ...
            case "valueBean":
              // field valueBean (mapped with "valueBean")
              if (jacksonParser.currentToken()==JsonToken.START_OBJECT) {
                instance.valueBean=beanBindMap().parseOnJackson(context, wrapper);
              }
            break;
            case "valueBeanArray":
              // field valueBeanArray (mapped with "valueBeanArray")
        ...
        switch (fieldName) {
            ...
            case "valueBean":
              ...
              if (jacksonParser.currentToken()==JsonToken.START_OBJECT || jacksonParser.currentToken()==JsonToken.VALUE_STRING) {
                instance.valueBean=beanBindMap().parseOnJacksonAsString(context, wrapper);
              }
            break;
            case "valueBeanArray":
              // field valueBeanArray (mapped with "valueBeanArray")
              if (jacksonParser.currentToken()==JsonToken.START_ARRAY) {
                ...
                while (jacksonParser.nextToken() != JsonToken.END_ARRAY) {
                  ...
                  if (jacksonParser.currentToken()==JsonToken.VALUE_STRING && "null".equals(tempValue)) {
                    ...
                    item=beanBindMap().parseOnJacksonAsString(context, wrapper);
                  }
                  collection.add(item);
                }
                instance.valueBeanArray=CollectionUtils.asArray(collection, new Bean[collection.size()]);
                  ...
                  for (int i=0; i<2 ;i++) {
                    ...
                    case "value":
                      ...
                      if (jacksonParser.currentToken()==JsonToken.VALUE_STRING && "null".equals(tempValue)) {
                        ...
                        if (jacksonParser.currentToken()==JsonToken.START_OBJECT || jacksonParser.currentToken()==JsonToken.VALUE_STRING) {
                          value=beanBindMap().parseOnJacksonAsString(context, wrapper);
                        }
                      }
                    break;
                    }
            ...
            case XmlPullParser.START_TAG:
              ...
              switch(currentTag) {
                  ...
                  case "valueBean":
                    ...
                    instance.valueBean=beanBindMap().parseOnXml(context, wrapper, eventType);
                  break;
                  case "valueBeanArray":
                    // property valueBeanArray (mapped on "valueBeanArray")
                     {
                      ...
                      if (xmlParser.isEmptyElement()) {
                        ...
                        item=beanBindMap().parseOnXml(context, wrapper, eventType);
                        collection.add(item);
                      }
                    ...
                    // property valueLinkedMapStringBean (mapped on "valueLinkedMapStringBean")
                     {
                      ...
                      if (xmlParser.isEmptyElement()) {
                        ...
                        value=beanBindMap().parseOnXml(context, wrapper, eventType);
                      }
                      xmlParser.nextTag();
                      collection.put(key, value);
