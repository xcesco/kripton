...
public class Bean63Table {
   ...
   * </p>
   *
   * <pre>CREATE TABLE bean63 (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, value TEXT, value_map_string_byte BLOB, value_map_enum_byte BLOB);</pre>
   */
  public static final String CREATE_TABLE_SQL = "CREATE TABLE bean63 (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, value TEXT, value_map_string_byte BLOB, value_map_enum_byte BLOB);";
  ...
  /**
   * Entity's property <code>valueMapStringByte</code> is associated to table column <code>value_map_string_byte</code>. This costant represents column typeName.
   *
  ...
  /**
   * Entity's property <code>valueMapEnumByte</code> is associated to table column <code>value_map_enum_byte</code>. This costant represents column typeName.
   *
