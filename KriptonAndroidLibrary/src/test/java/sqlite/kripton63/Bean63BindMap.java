...
public class Bean63BindMap extends AbstractMapper<Bean63> {
   ...
   */
  @Override
  public int serializeOnJackson(AbstractJacksonContext context, Bean63 object, JacksonWrapperSerializer wrapper) {
    try {
   ...
   */
  @Override
  public int serializeOnJacksonAsString(AbstractJacksonContext context, Bean63 object, JacksonWrapperSerializer wrapper) {
    try {
      JsonGenerator jacksonSerializer = wrapper.jacksonGenerator;
      jacksonSerializer.writeStartObject();
      int fieldCount=0;
   ...
   */
  @Override
  public void serializeOnXml(KriptonXmlContext context, Bean63 object, XmlWrapperSerializer wrapper, int currentEventType) {
    try {
   ...
   */
  @Override
  public Bean63 parseOnJackson(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      Bean63 instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public Bean63 parseOnJacksonAsString(AbstractJacksonContext context, JacksonWrapperParser wrapper) {
    try {
      JsonParser jacksonParser = wrapper.jacksonParser;
      Bean63 instance = createInstance();
      String fieldName;
   ...
   */
  @Override
  public Bean63 parseOnXml(KriptonXmlContext context, XmlWrapperParser wrapper, int currentEventType) {
    try {
